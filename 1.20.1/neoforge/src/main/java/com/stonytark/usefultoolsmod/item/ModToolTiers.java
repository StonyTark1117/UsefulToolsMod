...
public class ModToolTiers {
    public static final Tier REMERALD = new ForgeTier(3, 1361, 6.0f, 4.5f, 22,
            ModTags.Blocks.NEEDS_JEM_TOOL, () -> Ingredient.of(Items.EMERALD));

    public static final Tier PEMERALD = new ForgeTier(3, 1561, 7.0f, 3.2f, 30,
            ModTags.Blocks.NEEDS_SEM_TOOL, () -> Ingredient.of(ModItems.SEM.get()));

    public static final Tier ROBSIDIAN = new ForgeTier(4, 1650, 9.0f, 6.0f, 15,
            ModTags.Blocks.NEEDS_JOB_TOOL, () -> Ingredient.of(ModItems.OBSHARD.get()));

    public static final Tier POBSIDIAN = new ForgeTier(4, 2031, 10.0f, 5.0f, 18,
            ModTags.Blocks.NEEDS_SOB_TOOL, () -> Ingredient.of(ModItems.OBINGOT.get()));

    public static final Tier OVERPOWER = new ForgeTier(4, 9999, 25.0f, 30.0f, 35,
            ModTags.Blocks.NEEDS_OP_TOOL, () -> Ingredient.of(ModBlocks.SOBLOCK.get()));

    public static final Tier HREDSTONE = new ForgeTier(2, 600, 8.0f, 3.0f, 20,
     ...
     */
    public static final Tier HGLOWSTONE = new ForgeTier(2, 500, 7.0f, 2f, 28,
            ModTags.Blocks.NEEDS_HGLOW_TOOL, () -> Ingredient.of(ModItems.HGLOW.get()));

    public static final Tier RGOLD = new ForgeTier(3, 1200, 8.0f, 3.5f, 16,
            ModTags.Blocks.NEEDS_RGOLD_TOOL, () -> Ingredient.of(ModItems.RGOLD.get()));

    public static final Tier RLAPIS = new ForgeTier(3, 1100, 9.0f, 3.2f, 32,
     ...
     */
    public static final Tier COAL_TOOL = new ForgeTier(0, 120, 0, 3.0f, 5,
     ...
     */
    public static final Tier RAMETHYST = new ForgeTier(1, 250, 5.0f, 1.5f, 12,
            BlockTags.NEEDS_IRON_TOOL,
     ...
     */
    public static final Tier SNOW_TOOL = new ForgeTier(0, 45, 3.0f, 0.0f, 4,
            BlockTags.NEEDS_STONE_TOOL,
     ...
     */
    public static final Tier RQUARTZ = new ForgeTier(1, 310, 5.5f, 1.5f, 10,
            BlockTags.NEEDS_IRON_TOOL,
     ...
     */
    public static final Tier RPRISM = new ForgeTier(1, 240, 4.5f, 1.5f, 8,
            BlockTags.NEEDS_IRON_TOOL,
            () -> Ingredient.of(Items.PRISMARINE_SHARD));

    // ── Stone rock variant tiers ─────────────────────────────────────────────────
    // All stone-level: NEEDS_IRON_TOOL correct, level 1.
    ...
    public static final Tier STONE_CALCITE = new ForgeTier(1, 75, 4.5f, 0.5f, 8,
    ...
    public static final Tier STONE_DEEPSLATE = new ForgeTier(1, 178, 3.5f, 2.0f, 4,
    ...
    public static final Tier STONE_DIORITE = new ForgeTier(1, 140, 3.9f, 1.5f, 6,
    ...
    public static final Tier STONE_END_STONE = new ForgeTier(1, 145, 4.1f, 1.5f, 7,
            BlockTags.NEEDS_IRON_TOOL, () -> Ingredient.of(Items.END_STONE));

    /** Granite — very hard igneous rock.  Strong and heavy. */
    public static final Tier STONE_GRANITE = new ForgeTier(1, 158, 3.7f, 2.0f, 5,
    ...
    public static final Tier STONE_NETHERRACK = new ForgeTier(1, 80, 4.8f, 0.5f, 6,
            BlockTags.NEEDS_IRON_TOOL, () -> Ingredient.of(Items.NETHERRACK));

    /** Sandstone — soft sedimentary rock.  Light and nimble but brittle. */
    public static final Tier STONE_SANDSTONE = new ForgeTier(1, 100, 4.2f, 0.5f, 5,
    ...
    public static final Tier STONE_SMOOTH_BASALT = new ForgeTier(1, 148, 3.9f, 1.8f, 5,
    ...
    public static final Tier STONE_TERRACOTTA = new ForgeTier(1, 120, 4.0f, 1.0f, 7,
            BlockTags.NEEDS_IRON_TOOL, () -> Ingredient.of(Items.TERRACOTTA));

    /** Tuff — compressed volcanic ash.  Below-average damage and durability. */
    public static final Tier STONE_TUFF = new ForgeTier(1, 110, 4.0f, 1.0f, 5,
            BlockTags.NEEDS_IRON_TOOL, () -> Ingredient.of(Items.TUFF));

    // ── Wood variant tiers ───────────────────────────────────────────────────────
    // All wood-level (0): repair = the respective planks item.
    // Stats reflect real-world wood properties.

    /** Oak — reliable, versatile Overworld baseline.  Matches vanilla WOOD exactly. */
    public static final Tier WOOD_OAK = new ForgeTier(0, 59, 2.0f, 0.0f, 15,
            BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.of(Items.OAK_PLANKS));

    /** Spruce — sturdy boreal conifer.  Slightly more durable than oak. */
    public static final Tier WOOD_SPRUCE = new ForgeTier(0, 65, 2.0f, 0.0f, 14,
            BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.of(Items.SPRUCE_PLANKS));

    /** Birch — light, pale hardwood.  Fast and enchantable but fragile. */
    public static final Tier WOOD_BIRCH = new ForgeTier(0, 48, 2.3f, 0.0f, 18,
            BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.of(Items.BIRCH_PLANKS));

    /** Jungle — dense tropical timber.  Slightly tougher and sharper than oak. */
    public static final Tier WOOD_JUNGLE = new ForgeTier(0, 62, 2.1f, 0.5f, 14,
            BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.of(Items.JUNGLE_PLANKS));

    /** Acacia — hard African savanna wood.  Durable with a keen edge but slow. */
    public static final Tier WOOD_ACACIA = new ForgeTier(0, 68, 1.9f, 1.0f, 12,
            BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.of(Items.ACACIA_PLANKS));

    /** Dark Oak — dense, heavy old-growth wood.  Most durable overworld wood, slowest. */
    public static final Tier WOOD_DARK_OAK = new ForgeTier(0, 75, 1.8f, 1.0f, 12,
            BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.of(Items.DARK_OAK_PLANKS));

    /** Mangrove — tough, water-resistant tropical wood.  Good durability. */
    public static final Tier WOOD_MANGROVE = new ForgeTier(0, 70, 1.9f, 0.5f, 13,
            BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.of(Items.MANGROVE_PLANKS));

    /** Cherry — ornamental flowering wood.  Beautiful but delicate; highly enchantable. */
    public static final Tier WOOD_CHERRY = new ForgeTier(0, 42, 2.4f, 0.0f, 20,
            BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.of(Items.CHERRY_PLANKS));

    /** Bamboo — lightweight grass stem.  Fastest swing but shatters quickly. */
    public static final Tier WOOD_BAMBOO = new ForgeTier(0, 35, 2.5f, 0.0f, 16,
            BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.of(Items.BAMBOO_PLANKS));

    /** Crimson — tough Nether fungus stem.  The strongest wood; heavy and slow. */
    public static final Tier WOOD_CRIMSON = new ForgeTier(0, 80, 1.8f, 1.5f, 10,
            BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.of(Items.CRIMSON_PLANKS));

    /** Warped — resilient Nether fungus stem.  Balanced with high enchantability. */
    public static final Tier WOOD_WARPED = new ForgeTier(0, 72, 2.1f, 0.5f, 17,
            BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.of(Items.WARPED_PLANKS));
     ...
     */
    public static final Tier RFLINT = new ForgeTier(1, 200, 4.5f, 0.5f, 5,
            BlockTags.NEEDS_IRON_TOOL,
     ...
     */
    public static final Tier FNI_TOOLS = new ForgeTier(2, 220, 5.5f, 2.0f, 9,
            BlockTags.NEEDS_DIAMOND_TOOL,
            () -> Ingredient.of(Items.FLINT));
     ...
     */
    public static final Tier CAMETHYST = new ForgeTier(2, 580, 6.5f, 2.5f, 14,
            BlockTags.NEEDS_DIAMOND_TOOL,
     ...
     */
    public static final Tier ICE_TOOL = new ForgeTier(1, 180, 4.0f, 1.0f, 6,
            BlockTags.NEEDS_IRON_TOOL,
     ...
     */
    public static final Tier PQUARTZ = new ForgeTier(2, 640, 7.0f, 2.5f, 10,
            BlockTags.NEEDS_DIAMOND_TOOL,
     ...
     */
    public static final Tier PPRISM = new ForgeTier(2, 560, 6.5f, 2.0f, 12,
            BlockTags.NEEDS_DIAMOND_TOOL,
     ...
     */
    public static final Tier LEATHER = new ForgeTier(0, 15, 1.5f, 0.0f, 12,
            BlockTags.NEEDS_STONE_TOOL,
     ...
     */
    public static final Tier CAKE = new ForgeTier(0, 30, 1.5f, 0.0f, 1,
            BlockTags.NEEDS_STONE_TOOL,
            () -> Ingredient.of(Items.CAKE));

    // ── Food tiers (edible novelty sets) ──────────────────────────────────────

    public static final Tier BREAD = new ForgeTier(0, 25, 1.5f, 0.0f, 2,
            BlockTags.NEEDS_STONE_TOOL,
            () -> Ingredient.of(Items.BREAD));

    public static final Tier DRIED_KELP = new ForgeTier(0, 15, 1.0f, 0.5f, 1,
            BlockTags.NEEDS_STONE_TOOL,
            () -> Ingredient.of(Items.DRIED_KELP));

    public static final Tier ROTTEN_FLESH = new ForgeTier(0, 30, 0.5f, 0.0f, 3,
            BlockTags.NEEDS_STONE_TOOL,
            () -> Ingredient.of(Items.ROTTEN_FLESH));

    public static final Tier MELON = new ForgeTier(0, 50, 2.5f, 0.5f, 4,
            BlockTags.NEEDS_STONE_TOOL,
            () -> Ingredient.of(Items.MELON_SLICE));

    public static final Tier SWEET_BERRIES = new ForgeTier(0, 45, 2.0f, 1.0f, 5,
            BlockTags.NEEDS_STONE_TOOL,
            () -> Ingredient.of(Items.SWEET_BERRIES));

    public static final Tier PUMPKIN_PIE = new ForgeTier(0, 55, 2.0f, 0.5f, 7,
            BlockTags.NEEDS_STONE_TOOL,
            () -> Ingredient.of(Items.PUMPKIN_PIE));

    public static final Tier MUSHROOM = new ForgeTier(1, 100, 4.0f, 1.0f, 10,
            BlockTags.NEEDS_STONE_TOOL,
            () -> Ingredient.of(Items.RED_MUSHROOM));

    public static final Tier PUFFERFISH = new ForgeTier(1, 80, 3.5f, 1.5f, 8,
            BlockTags.NEEDS_STONE_TOOL,
            () -> Ingredient.of(Items.PUFFERFISH));

    public static final Tier HONEY = new ForgeTier(1, 120, 4.0f, 1.0f, 10,
            BlockTags.NEEDS_STONE_TOOL,
            () -> Ingredient.of(Items.HONEY_BOTTLE));

    public static final Tier CHORUS_FRUIT = new ForgeTier(2, 250, 6.0f, 2.0f, 15,
            BlockTags.NEEDS_IRON_TOOL,
            () -> Ingredient.of(Items.CHORUS_FRUIT));

    public static final Tier GOLDEN_APPLE = new ForgeTier(2, 300, 7.0f, 2.5f, 22,
            BlockTags.NEEDS_IRON_TOOL,
    ...
    public static final Tier PAPER = new ForgeTier(0, 8, 1.0f, 0.0f, 8,
            BlockTags.NEEDS_STONE_TOOL,
            () -> Ingredient.of(Items.PAPER));

    /** Feather — ultra-weak novelty. Light and enchantable but useless in combat. */
    public static final Tier FEATHER = new ForgeTier(0, 10, 1.5f, 0.0f, 15,
            BlockTags.NEEDS_STONE_TOOL,
            () -> Ingredient.of(Items.FEATHER));

    /** Glass — extremely fragile but sharp and fast. Shatters spectacularly. */
    public static final Tier GLASS = new ForgeTier(0, 5, 5.0f, 1.0f, 1,
            BlockTags.NEEDS_STONE_TOOL,
            () -> Ingredient.of(Items.GLASS_PANE));

    /** Cactus — prickly wood-tier. Deals thorn damage on hit. */
    public static final Tier CACTUS = new ForgeTier(0, 70, 2.5f, 1.5f, 5,
            BlockTags.NEEDS_STONE_TOOL,
            () -> Ingredient.of(Items.CACTUS));

    /** Sponge — absorbent but terrible as a weapon. Can soak up water. */
    public static final Tier SPONGE = new ForgeTier(0, 40, 1.5f, 0.0f, 3,
            BlockTags.NEEDS_STONE_TOOL,
            () -> Ingredient.of(Items.SPONGE));

    /** Bone — low-mid tier, effective against undead. */
    public static final Tier BONE = new ForgeTier(1, 150, 3.5f, 1.0f, 6,
            BlockTags.NEEDS_IRON_TOOL,
            () -> Ingredient.of(Items.BONE));

    /** Clay — low-mid tier, malleable and enchantable. */
    public static final Tier CLAY = new ForgeTier(1, 90, 2.5f, 0.5f, 8,
            BlockTags.NEEDS_IRON_TOOL,
            () -> Ingredient.of(Items.CLAY_BALL));

    /** Nether Wart — low-mid tier, inflicts wither on hit. */
    public static final Tier NETHER_WART = new ForgeTier(1, 100, 3.0f, 0.5f, 10,
            BlockTags.NEEDS_IRON_TOOL,
            () -> Ingredient.of(Items.NETHER_WART));

    /** Brick — mid stone-tier, durable and reliable. */
    public static final Tier BRICK = new ForgeTier(1, 200, 4.0f, 1.5f, 5,
            BlockTags.NEEDS_IRON_TOOL,
            () -> Ingredient.of(Items.BRICK));

    /** Nether Brick — mid stone-tier, inflicts fire on hit. */
    public static final Tier NETHER_BRICK = new ForgeTier(1, 220, 4.0f, 1.5f, 5,
            BlockTags.NEEDS_IRON_TOOL,
            () -> Ingredient.of(Items.NETHER_BRICK));

    /** Pointed Dripstone — mid stone-tier, pierces armor. */
    public static final Tier POINTED_DRIPSTONE = new ForgeTier(1, 160, 4.5f, 2.0f, 4,
            BlockTags.NEEDS_IRON_TOOL,
            () -> Ingredient.of(Items.POINTED_DRIPSTONE));

    /** Copper — mid stone-tier, oxidizes over time. */
    public static final Tier COPPER = new ForgeTier(1, 200, 5.0f, 1.5f, 8,
            BlockTags.NEEDS_IRON_TOOL,
            () -> Ingredient.of(Items.COPPER_INGOT));

    /** Phantom Membrane — upper-mid tier, grants slow falling. */
    public static final Tier PHANTOM_MEMBRANE = new ForgeTier(2, 250, 5.0f, 1.5f, 12,
            BlockTags.NEEDS_DIAMOND_TOOL,
            () -> Ingredient.of(Items.PHANTOM_MEMBRANE));

    /** Magma Cream — upper-mid tier, sets targets on fire. */
    public static final Tier MAGMA_CREAM = new ForgeTier(2, 200, 4.5f, 2.0f, 8,
            BlockTags.NEEDS_DIAMOND_TOOL,
            () -> Ingredient.of(Items.MAGMA_CREAM));

    /** Slime — upper-mid tier, bouncy knockback. */
    public static final Tier SLIME = new ForgeTier(2, 180, 3.5f, 0.5f, 10,
            BlockTags.NEEDS_DIAMOND_TOOL,
            () -> Ingredient.of(Items.SLIME_BALL));

    /** Blaze Rod — iron-level, auto-smelts and ignites. */
    public static final Tier BLAZE_ROD = new ForgeTier(2, 300, 6.0f, 2.0f, 10,
            BlockTags.NEEDS_DIAMOND_TOOL,
            () -> Ingredient.of(Items.BLAZE_ROD));

    /** Nautilus Shell — iron-level, conduit affinity. */
    public static final Tier NAUTILUS_SHELL = new ForgeTier(2, 280, 5.5f, 2.0f, 14,
            BlockTags.NEEDS_DIAMOND_TOOL,
            () -> Ingredient.of(Items.NAUTILUS_SHELL));

    /** Purpur — iron-level, ender resilience. */
    public static final Tier PURPUR = new ForgeTier(2, 320, 6.0f, 2.0f, 12,
            BlockTags.NEEDS_DIAMOND_TOOL,
            () -> Ingredient.of(Items.POPPED_CHORUS_FRUIT));

    /** Ghast Tear — above-iron, regeneration. */
    public static final Tier GHAST_TEAR = new ForgeTier(2, 400, 6.5f, 2.5f, 18,
            BlockTags.NEEDS_DIAMOND_TOOL,
            () -> Ingredient.of(Items.GHAST_TEAR));

    /** Eye of Ender — above-iron, ender sight. */
    public static final Tier EYE_OF_ENDER = new ForgeTier(2, 450, 7.0f, 2.5f, 20,
            BlockTags.NEEDS_DIAMOND_TOOL,
            () -> Ingredient.of(Items.ENDER_EYE));

    /** Shulker Shell — above-iron, levitation shield. */
    public static final Tier SHULKER_SHELL = new ForgeTier(2, 500, 6.0f, 2.0f, 16,
            BlockTags.NEEDS_DIAMOND_TOOL,
            () -> Ingredient.of(Items.SHULKER_SHELL));

    /** Echo Shard — diamond-adjacent, sculk resonance. */
    public static final Tier ECHO_SHARD = new ForgeTier(3, 600, 7.5f, 3.0f, 18,
            BlockTags.NEEDS_DIAMOND_TOOL,
            () -> Ingredient.of(Items.ECHO_SHARD));

    /** Dragon's Breath — diamond-adjacent endgame, draconic aura. */
    public static final Tier DRAGON_BREATH = new ForgeTier(3, 700, 8.0f, 3.5f, 20,
            BlockTags.NEEDS_DIAMOND_TOOL,
     ...
     */
    public static final Tier RECTO = new ForgeTier(1, 150, 4.5f, 1.5f, 10,
     ...
     */
    public static final Tier ECTOPLASM = new ForgeTier(2, 300, 6.5f, 2.5f, 16,
            ModTags.Blocks.NEEDS_ECTO_TOOL,
