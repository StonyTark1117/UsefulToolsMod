...
// In 1.20.2 NeoForge: ForgeBiomeModifiers → NeoForgeBiomeModifiers, ForgeRegistries.Keys.BIOME_MODIFIERS → ForgeRegistries.Keys.BIOME_MODIFIERS
public class ModBiomeModifiers {
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        context.register(SPAWN_GHOST, new ForgeBiomeModifiers.AddSpawnsBiomeModifier(
    ...
    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, new ResourceLocation(UsefultoolsMod.MOD_ID, name));
    }
}
