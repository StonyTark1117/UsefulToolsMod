...
public class GhostEntity extends Animal {
    ...
    public static boolean checkGhostSpawnRules(EntityType<? extends Animal> type, LevelAccessor level,
        ...
        // Night-time propensity: 3x more likely at night (light level 0-3) vs daytime.
    ...
    private BlockPos nearestActiveLantern() {
        BlockPos origin = blockPosition(); BlockPos best = null; double bestDistance = Double.MAX_VALUE;
