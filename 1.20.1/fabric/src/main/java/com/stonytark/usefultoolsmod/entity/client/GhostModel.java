...
public class GhostModel<T extends GhostEntity> extends SinglePartEntityModel<T> {
    public static final EntityModelLayer LAYER_LOCATION =
            new EntityModelLayer(new Identifier(UsefultoolsMod.MOD_ID, "ghost"), "main");
    ...
    public static TexturedModelData createBodyLayer() {
        ...
        ModelPartData root = partdefinition.addChild("root",
        ...
        body.addChild("baby_face",
                ModelPartBuilder.create().uv(50, 12).cuboid(-3.0F, -20.0F, -5.6F, 6.0F, 3.0F, 1.0F),
                ModelTransform.NONE);
