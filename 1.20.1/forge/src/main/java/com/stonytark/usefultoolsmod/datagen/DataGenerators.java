...
// In 1.20.2:
// - LootTableProvider(PackOutput, Set<ResourceLocation>, List<SubProviderEntry>) - no lookupProvider
// - RecipeProvider(PackOutput) - no lookupProvider
// - BlockLootSubProvider() - no pRegistries constructor param
...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        // In 1.20.2, LootTableProvider does NOT take a lookupProvider
