...
/** Forge 47 has no Forge-specific replacement for the vanilla provider it marks deprecated. */
...
public class ModAdvancementProvider extends AdvancementProvider {
    ...
    static class UsefulToolsAdvancements implements AdvancementSubProvider {
        ...
        private static final ResourceLocation BACKGROUND =
                ResourceLocation.parse("textures/block/netherrack.png");
        ...
        public void generate(HolderLookup.Provider registries,
            ...
            Advancement root = Advancement.Builder.advancement()
                    ...
                    .addCriterion("has_rgold", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.RGOLD.get()))
                    .save(saver, id("root"));

            // ==================================================================
            // RGOLD ingot (smelt raw ore -> ingot) — bridges root to tools/armor
            // ==================================================================
            Advancement rgold = Advancement.Builder.advancement()
                    .parent(root)
            ...
            // ==================================================================
            Advancement oreFound = Advancement.Builder.advancement()
                    .parent(root)
            ...
            // ==================================================================
            Advancement rgoldSword = Advancement.Builder.advancement()
                    .parent(rgold)
            ...
            // ==================================================================
            Advancement obshard = Advancement.Builder.advancement()
                    .parent(root)
            ...
            Advancement obingot = Advancement.Builder.advancement()
                    .parent(obshard)
            ...
            // ==================================================================
            Advancement sem = Advancement.Builder.advancement()
                    .parent(root)
            ...
            // ==================================================================
            Advancement hred = Advancement.Builder.advancement()
                    .parent(root)
            ...
            // ==================================================================
            Advancement hglow = Advancement.Builder.advancement()
                    .parent(root)
            ...
            // ==================================================================
            Advancement rlapis = Advancement.Builder.advancement()
                    .parent(root)
            ...
            // ==================================================================
            Advancement coalDust = Advancement.Builder.advancement()
                    .parent(root)
            ...
            Advancement hardenedCoal = Advancement.Builder.advancement()
                    .parent(coalDust)
            ...
            Advancement coalTools = Advancement.Builder.advancement()
                    .parent(hardenedCoal)
            ...
            Advancement.Builder.advancement()
                    ...
                    .addCriterion("coal_tool_ignited",
                            new CoalToolIgnitedTrigger.TriggerInstance(ContextAwarePredicate.ANY))
                    .save(saver, id("coal_trial_by_fire"));

            Advancement coalArmor = Advancement.Builder.advancement()
                    .parent(hardenedCoal)
            ...
            // ==================================================================
            Advancement grenade = Advancement.Builder.advancement()
                    .parent(root)
            ...
            // ==================================================================
            Advancement ghostEncounter = Advancement.Builder.advancement()
                    .parent(root)
                    .display(ModItems.GHOST_SPAWN_EGG.get(), title("ghost_encounter"), desc("ghost_encounter"),
                            null, FrameType.TASK, true, true, false)
                    .addCriterion("ghost_nearby",
                            new GhostNearbyTrigger.TriggerInstance(ContextAwarePredicate.ANY))
                    .save(saver, id("ghost_encounter"));

            Advancement ghostCompanion = Advancement.Builder.advancement()
            ...
            //                                             -> Spectral Infuser
            // ------------------------------------------------------------------
            Advancement ectoplasmAdv = Advancement.Builder.advancement()
            ...
            Advancement refinedEctoplasm = Advancement.Builder.advancement()
                    .parent(ectoplasmAdv)
            ...
            Advancement ectoTools = Advancement.Builder.advancement()
            ...
            Advancement rrawGold = Advancement.Builder.advancement()
                    .parent(root)
            ...
            Advancement rrawCopper = Advancement.Builder.advancement()
                    .parent(root)
            ...
            Advancement rrawIron = Advancement.Builder.advancement()
                    .parent(root)
            ...
            Advancement rrawRgold = Advancement.Builder.advancement()
                    .parent(root)
            ...
            Advancement rscrap = Advancement.Builder.advancement()
                    .parent(root)
            ...
            // Rough Amethyst
            Advancement ramethyst = Advancement.Builder.advancement()
                    .parent(root)
            ...
            // Snow tools
            Advancement snowTools = Advancement.Builder.advancement()
                    .parent(root)
            ...
            // Rough Quartz
            Advancement rquartz = Advancement.Builder.advancement()
                    .parent(root)
            ...
            // Rough Prismarine
            Advancement rprism = Advancement.Builder.advancement()
                    .parent(root)
            ...
            Advancement calciteAmethyst = Advancement.Builder.advancement()
                    .parent(root)
            ...
            Advancement camethystTools = Advancement.Builder.advancement()
            ...
            Advancement glacialShard = Advancement.Builder.advancement()
                    .parent(root)
            ...
            Advancement iceTools = Advancement.Builder.advancement()
                    .parent(glacialShard)
            ...
            Advancement polishedQuartz = Advancement.Builder.advancement()
                    .parent(root)
            ...
            Advancement pquartzTools = Advancement.Builder.advancement()
            ...
            Advancement polishedPrismarine = Advancement.Builder.advancement()
                    .parent(root)
            ...
            Advancement pprismTools = Advancement.Builder.advancement()
            ...
            // ==================================================================
            Advancement overpowerSword = Advancement.Builder.advancement()
                    .parent(root)
            ...
            // ==================================================================
            Advancement rflintSword = Advancement.Builder.advancement()
                    .parent(root)
            ...
            Advancement fniSword = Advancement.Builder.advancement()
                    .parent(rflintSword)
            ...
            Advancement rabbitHideCraft = Advancement.Builder.advancement()
                    .parent(root)
            ...
            Advancement turtleScuteCraft = Advancement.Builder.advancement()
                    .parent(root)
            ...
            // ---------------------------------------------------------------
            Advancement leatherCraft = Advancement.Builder.advancement()
                    .parent(root)
            ...
            Advancement cakeAdv = Advancement.Builder.advancement()
                    .parent(root)
        ...
        private static void buildFoodAdv(Consumer<Advancement> saver, Advancement parent,
            ...
            Advancement craftAdv = craft.requirements(RequirementsStrategy.OR)
            ...
            Advancement eatAdv = eat.requirements(RequirementsStrategy.OR)
        ...
        private static void buildVanillaToolAdv(Consumer<Advancement> saver, Advancement parent,
            ...
            set.requirements(RequirementsStrategy.AND)
                    .save(saver, id(setKey));
        }

        /** Tools+Armor set: craft (OR any of 9 items) + full set (AND all 9 items). */
        private static void buildVanillaSetAdv(Consumer<Advancement> saver, Advancement parent,
                                                String craftKey, String setKey,
                                                net.minecraft.world.item.Item displayItem,
                                                net.minecraft.world.item.Item sword, net.minecraft.world.item.Item pickaxe,
                                                net.minecraft.world.item.Item axe, net.minecraft.world.item.Item shovel,
