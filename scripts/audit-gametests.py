...
TARGETS = {
    ...
    "1.21.1-forge": Target("1.21.1/forge-standalone", "/usr/lib/jvm/java-21-openjdk", "runGameTestServer"),
    "1.21.1-fabric": Target("1.21.1", "/usr/lib/jvm/java-21-openjdk", ":fabric:runGameTestServer"),
    "1.21.1-neoforge": Target("1.21.1", "/usr/lib/jvm/java-21-openjdk", ":neoforge:runGameTestServer"),
