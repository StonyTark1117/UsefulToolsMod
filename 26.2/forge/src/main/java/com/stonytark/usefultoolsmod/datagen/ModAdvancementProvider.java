...
/**
 * Forge 65 deprecates the vanilla provider in its patched API but does not ship
 * a Forge-side replacement (the suggested helper exists only in NeoForge).
 * Keep the vanilla provider here so the Forge artifact remains loader-native.
 */
...
public class ModAdvancementProvider extends AdvancementProvider {
    ...
    static class UsefulToolsAdvancements implements AdvancementSubProvider {
         ...
         */
        private static net.minecraft.advancements.triggers.Criterion<ConsumeItemTrigger.TriggerInstance> usedItem(
