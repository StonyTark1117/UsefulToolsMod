...
public class Config {
    ...
    private static final ForgeConfigSpec.BooleanValue ECTOPLASM_LANTERN_ENABLED;
    private static final ForgeConfigSpec.BooleanValue LEGACY_SOUL_LANTERN_ENABLED;
