...
public class WraithEntity extends Monster {
    ...
    @Override protected void dropCustomDeathLoot(ServerLevel level, DamageSource source, boolean recentlyHit) {
        ...
        spawnAtLocation(level, new ItemStack(ModItems.CONDENSED_ECTOPLASM.get(), condensed));
        spawnAtLocation(level, new ItemStack(ModItems.ECTOPLASM.get(), 1 + random.nextInt(3)));
    }
