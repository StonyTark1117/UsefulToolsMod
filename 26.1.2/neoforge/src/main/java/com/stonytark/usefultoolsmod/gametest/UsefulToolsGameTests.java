...
public class UsefulToolsGameTests {
    ...
    public static void register(RegisterGameTestsEvent event) {
        ...
        register(event, environment, "spectral_blocks_and_charge_contracts", 100,
                UsefulToolsGameTests::spectralBlocksAndChargeContracts);
    ...
    public static void ghostAndDamageContracts(GameTestHelper helper) {
        ...
        try {
            ...
            wraithSpawnAllowed = com.stonytark.usefultoolsmod.entity.custom.WraithEntity.checkSpawnRules(
                    ModEntities.WRAITH.get(), helper.getLevel(), EntitySpawnReason.NATURAL,
