...
public class ModEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<WraithEntity>> WRAITH=ENTITY_TYPES.register(GeneratedRegistrationIds.Entities.WRAITH,
            ()->EntityType.Builder.<WraithEntity>of(WraithEntity::new,MobCategory.MONSTER).sized(1.2F,2.25F).clientTrackingRange(8).build(key(GeneratedRegistrationIds.Entities.WRAITH)));
    public static final DeferredHolder<EntityType<?>, EntityType<StickyDynamiteEntity>> STICKY_DYNAMITE=ENTITY_TYPES.register(GeneratedRegistrationIds.Entities.STICKY_DYNAMITE,
