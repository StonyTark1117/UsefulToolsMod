...
public class ModItems {
    ...
    public static final RegistrySupplier<Item> RGOLD = ITEMS.register("rgold",
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistrySupplier<Item> RAW_RGOLD = ITEMS.register("raw_rgold",
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistrySupplier<Item> OBSHARD = ITEMS.register("obshard",
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistrySupplier<Item> SEM = ITEMS.register("sem",
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistrySupplier<Item> OBINGOT = ITEMS.register("obingot",
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistrySupplier<Item> GRENADE = ITEMS.register("grenade",
            () -> new Grenade(new Item.Properties().stacksTo(16)));

    public static final RegistrySupplier<Item> HRED = ITEMS.register("hred",
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistrySupplier<Item> HGLOW = ITEMS.register("hglow",
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistrySupplier<Item> RLAPIS = ITEMS.register("rlapis",
            () -> new Item(new Item.Properties().stacksTo(64)));
    ...
    public static final RegistrySupplier<Item> REMERALD_SWORD = ITEMS.register("remerald_sword",
    ...
    public static final RegistrySupplier<Item> REMERALD_PICKAXE = ITEMS.register("remerald_pickaxe",
    ...
    public static final RegistrySupplier<Item> REMERALD_SHOVEL = ITEMS.register("remerald_shovel",
    ...
    public static final RegistrySupplier<Item> REMERALD_AXE = ITEMS.register("remerald_axe",
            () -> new AxeItem(ModToolTiers.REMERALD, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.REMERALD, 6, -3.2f))));
    public static final RegistrySupplier<Item> REMERALD_HOE = ITEMS.register("remerald_hoe",
            () -> new HoeItem(ModToolTiers.REMERALD, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.REMERALD, 0, -3f))));

    public static final RegistrySupplier<Item> PEMERALD_SWORD = ITEMS.register("pemerald_sword",
    ...
    public static final RegistrySupplier<Item> PEMERALD_PICKAXE = ITEMS.register("pemerald_pickaxe",
    ...
    public static final RegistrySupplier<Item> PEMERALD_SHOVEL = ITEMS.register("pemerald_shovel",
    ...
    public static final RegistrySupplier<Item> PEMERALD_AXE = ITEMS.register("pemerald_axe",
            () -> new AxeItem(ModToolTiers.PEMERALD, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.PEMERALD, 6, -3.2f))));
    public static final RegistrySupplier<Item> PEMERALD_HOE = ITEMS.register("pemerald_hoe",
            () -> new HoeItem(ModToolTiers.PEMERALD, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.PEMERALD, 0, -3f))));

    public static final RegistrySupplier<Item> ROBSIDIAN_SWORD = ITEMS.register("robsidian_sword",
    ...
    public static final RegistrySupplier<Item> ROBSIDIAN_PICKAXE = ITEMS.register("robsidian_pickaxe",
    ...
    public static final RegistrySupplier<Item> ROBSIDIAN_SHOVEL = ITEMS.register("robsidian_shovel",
    ...
    public static final RegistrySupplier<Item> ROBSIDIAN_AXE = ITEMS.register("robsidian_axe",
            () -> new AxeItem(ModToolTiers.ROBSIDIAN, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.ROBSIDIAN, 6, -3.2f))));
    public static final RegistrySupplier<Item> ROBSIDIAN_HOE = ITEMS.register("robsidian_hoe",
            () -> new HoeItem(ModToolTiers.ROBSIDIAN, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.ROBSIDIAN, 0, -3f))));

    public static final RegistrySupplier<Item> POBSIDIAN_SWORD = ITEMS.register("pobsidian_sword",
    ...
    public static final RegistrySupplier<Item> POBSIDIAN_PICKAXE = ITEMS.register("pobsidian_pickaxe",
    ...
    public static final RegistrySupplier<Item> POBSIDIAN_SHOVEL = ITEMS.register("pobsidian_shovel",
    ...
    public static final RegistrySupplier<Item> POBSIDIAN_AXE = ITEMS.register("pobsidian_axe",
            () -> new AxeItem(ModToolTiers.POBSIDIAN, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.POBSIDIAN, 6, -3.2f))));
    public static final RegistrySupplier<Item> POBSIDIAN_HOE = ITEMS.register("pobsidian_hoe",
            () -> new HoeItem(ModToolTiers.POBSIDIAN, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.POBSIDIAN, 0, -3f))));

    public static final RegistrySupplier<Item> OVERPOWER_SWORD = ITEMS.register("overpower_sword",
    ...
    public static final RegistrySupplier<Item> OVERPOWER_PICKAXE = ITEMS.register("overpower_pickaxe",
    ...
    public static final RegistrySupplier<Item> OVERPOWER_SHOVEL = ITEMS.register("overpower_shovel",
    ...
    public static final RegistrySupplier<Item> OVERPOWER_AXE = ITEMS.register("overpower_axe",
            () -> new AxeItem(ModToolTiers.OVERPOWER, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.OVERPOWER, 6, -3.2f))));


    public static final RegistrySupplier<Item> HREDSTONE_SWORD = ITEMS.register("hredstone_sword",
    ...
    public static final RegistrySupplier<Item> HREDSTONE_PICKAXE = ITEMS.register("hredstone_pickaxe",
    ...
    public static final RegistrySupplier<Item> HREDSTONE_SHOVEL = ITEMS.register("hredstone_shovel",
    ...
    public static final RegistrySupplier<Item> HREDSTONE_AXE = ITEMS.register("hredstone_axe",
            () -> new AxeItem(ModToolTiers.HREDSTONE, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.HREDSTONE, 6, -3.2f))));
    public static final RegistrySupplier<Item> HREDSTONE_HOE = ITEMS.register("hredstone_hoe",
            () -> new HoeItem(ModToolTiers.HREDSTONE, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.HREDSTONE, 0, -3f))));

    public static final RegistrySupplier<Item> HGLOWSTONE_SWORD = ITEMS.register("hglowstone_sword",
    ...
    public static final RegistrySupplier<Item> HGLOWSTONE_PICKAXE = ITEMS.register("hglowstone_pickaxe",
    ...
    public static final RegistrySupplier<Item> HGLOWSTONE_SHOVEL = ITEMS.register("hglowstone_shovel",
    ...
    public static final RegistrySupplier<Item> HGLOWSTONE_AXE = ITEMS.register("hglowstone_axe",
    ...
    public static final RegistrySupplier<Item> EMERALD_CHESTPLATE = ITEMS.register("emerald_chestplate",
    ...
    public static final RegistrySupplier<Item> EMERALD_LEGGINGS = ITEMS.register("emerald_leggings",
    ...
    public static final RegistrySupplier<Item> EMERALD_BOOTS = ITEMS.register("emerald_boots",
    ...
    public static final RegistrySupplier<Item> HRED_HELMET = ITEMS.register("hred_helmet",
    ...
    public static final RegistrySupplier<Item> HRED_CHESTPLATE = ITEMS.register("hred_chestplate",
    ...
    public static final RegistrySupplier<Item> HRED_LEGGINGS = ITEMS.register("hred_leggings",
    ...
    public static final RegistrySupplier<Item> HRED_BOOTS = ITEMS.register("hred_boots",
    ...
    public static final RegistrySupplier<Item> HGLOW_HELMET = ITEMS.register("hglow_helmet",
            () -> new ArmorItem(ModArmorMaterials.HGLOW_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(18))));
    public static final RegistrySupplier<Item> HGLOW_CHESTPLATE = ITEMS.register("hglow_chestplate",
            () -> new ArmorItem(ModArmorMaterials.HGLOW_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(18))));
    public static final RegistrySupplier<Item> HGLOW_LEGGINGS = ITEMS.register("hglow_leggings",
            () -> new ArmorItem(ModArmorMaterials.HGLOW_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(18))));
    public static final RegistrySupplier<Item> HGLOW_BOOTS = ITEMS.register("hglow_boots",
            () -> new ArmorItem(ModArmorMaterials.HGLOW_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(18))));

    public static final RegistrySupplier<Item> OBSIDIAN_HELMET = ITEMS.register("obsidian_helmet",
    ...
    public static final RegistrySupplier<Item> OBSIDIAN_CHESTPLATE = ITEMS.register("obsidian_chestplate",
    ...
    public static final RegistrySupplier<Item> OBSIDIAN_LEGGINGS = ITEMS.register("obsidian_leggings",
    ...
    public static final RegistrySupplier<Item> OBSIDIAN_BOOTS = ITEMS.register("obsidian_boots",
    ...
    public static final RegistrySupplier<Item> RGOLD_HELMET = ITEMS.register("rgold_helmet",
            () -> new ArmorItem(ModArmorMaterials.RGOLD_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(18))));
    public static final RegistrySupplier<Item> RGOLD_CHESTPLATE = ITEMS.register("rgold_chestplate",
            () -> new ArmorItem(ModArmorMaterials.RGOLD_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(18))));
    public static final RegistrySupplier<Item> RGOLD_LEGGINGS = ITEMS.register("rgold_leggings",
            () -> new ArmorItem(ModArmorMaterials.RGOLD_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(18))));
    public static final RegistrySupplier<Item> RGOLD_BOOTS = ITEMS.register("rgold_boots",
            () -> new ArmorItem(ModArmorMaterials.RGOLD_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(18))));

    public static final RegistrySupplier<Item> RLAPIS_HELMET = ITEMS.register("rlapis_helmet",
    ...
    public static final RegistrySupplier<Item> RLAPIS_CHESTPLATE = ITEMS.register("rlapis_chestplate",
    ...
    public static final RegistrySupplier<Item> RLAPIS_LEGGINGS = ITEMS.register("rlapis_leggings",
    ...
    public static final RegistrySupplier<Item> RLAPIS_BOOTS = ITEMS.register("rlapis_boots",
    ...
    public static final RegistrySupplier<Item> OVERPOWER_HELMET = ITEMS.register("overpower_helmet",
    ...
    public static final RegistrySupplier<Item> OVERPOWER_CHESTPLATE = ITEMS.register("overpower_chestplate",
    ...
    public static final RegistrySupplier<Item> OVERPOWER_LEGGINGS = ITEMS.register("overpower_leggings",
    ...
    public static final RegistrySupplier<Item> OVERPOWER_BOOTS = ITEMS.register("overpower_boots",
    ...
    public static final RegistrySupplier<Item> GHOST_SPAWN_EGG = ITEMS.register("ghost_spawn_egg",
            () -> new SpawnEggItem(ModEntities.GHOST.get(), 0xFFFFFF, 0x999999, new Item.Properties()));

    public static final RegistrySupplier<Item> ECTOPLASM = ITEMS.register("ectoplasm",
            () -> new Item(new Item.Properties().stacksTo(64)));

    // -------------------------------------------------------------------------
    // Rough Ectoplasm tools (raw ectoplasm, stone-tier equivalent)
    // -------------------------------------------------------------------------
    public static final RegistrySupplier<Item> RECTO_SWORD = ITEMS.register("recto_sword",
            () -> new EctoSwordItem(ModToolTiers.RECTO, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.RECTO, 3, -2.4f))));

    public static final RegistrySupplier<Item> RECTO_PICKAXE = ITEMS.register("recto_pickaxe",
    ...
    public static final RegistrySupplier<Item> RECTO_SHOVEL = ITEMS.register("recto_shovel",
    ...
    public static final RegistrySupplier<Item> RECTO_AXE = ITEMS.register("recto_axe",
            () -> new EctoAxeItem(ModToolTiers.RECTO, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.RECTO, 6, -3.2f))));

    public static final RegistrySupplier<Item> RECTO_HOE = ITEMS.register("recto_hoe",
    ...
    // -------------------------------------------------------------------------
    public static final RegistrySupplier<Item> REFINED_ECTOPLASM = ITEMS.register("refined_ectoplasm",
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistrySupplier<Item> ECTO_SWORD = ITEMS.register("ecto_sword",
    ...
    public static final RegistrySupplier<Item> ECTO_PICKAXE = ITEMS.register("ecto_pickaxe",
    ...
    public static final RegistrySupplier<Item> ECTO_SHOVEL = ITEMS.register("ecto_shovel",
    ...
    public static final RegistrySupplier<Item> ECTO_AXE = ITEMS.register("ecto_axe",
    ...
    public static final RegistrySupplier<Item> ECTO_HOE = ITEMS.register("ecto_hoe",
    ...
    public static final RegistrySupplier<Item> ECTO_HELMET = ITEMS.register("ecto_helmet",
    ...
    public static final RegistrySupplier<Item> ECTO_CHESTPLATE = ITEMS.register("ecto_chestplate",
    ...
    public static final RegistrySupplier<Item> ECTO_LEGGINGS = ITEMS.register("ecto_leggings",
    ...
    public static final RegistrySupplier<Item> ECTO_BOOTS = ITEMS.register("ecto_boots",
    ...
    public static final RegistrySupplier<Item> HARDENED_COAL = ITEMS.register("hardened_coal",
            () -> new Item(new Item.Properties().stacksTo(64)));

    // -------------------------------------------------------------------------
    // Coal tools  (wood mining level, durability ~120, flammable)
    // -------------------------------------------------------------------------
    public static final RegistrySupplier<Item> COAL_SWORD = ITEMS.register("coal_sword",
    ...
    public static final RegistrySupplier<Item> COAL_PICKAXE = ITEMS.register("coal_pickaxe",
    ...
    public static final RegistrySupplier<Item> COAL_SHOVEL = ITEMS.register("coal_shovel",
    ...
    public static final RegistrySupplier<Item> COAL_AXE = ITEMS.register("coal_axe",
    ...
    public static final RegistrySupplier<Item> COAL_HOE = ITEMS.register("coal_hoe",
    ...
    // -------------------------------------------------------------------------
    public static final RegistrySupplier<Item> COAL_HELMET = ITEMS.register("coal_helmet",
    ...
    public static final RegistrySupplier<Item> COAL_CHESTPLATE = ITEMS.register("coal_chestplate",
    ...
    public static final RegistrySupplier<Item> COAL_LEGGINGS = ITEMS.register("coal_leggings",
    ...
    public static final RegistrySupplier<Item> COAL_BOOTS = ITEMS.register("coal_boots",
    ...
    public static final RegistrySupplier<Item> RRAW_GOLD_SWORD = ITEMS.register("rraw_gold_sword",
    ...
    public static final RegistrySupplier<Item> RRAW_GOLD_PICKAXE = ITEMS.register("rraw_gold_pickaxe",
    ...
    public static final RegistrySupplier<Item> RRAW_GOLD_SHOVEL = ITEMS.register("rraw_gold_shovel",
    ...
    public static final RegistrySupplier<Item> RRAW_GOLD_AXE = ITEMS.register("rraw_gold_axe",
            () -> new AxeItem(ModToolTiers.RRAW_GOLD, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.RRAW_GOLD, 6, -3.2f))));
    public static final RegistrySupplier<Item> RRAW_GOLD_HOE = ITEMS.register("rraw_gold_hoe",
    ...
    public static final RegistrySupplier<Item> RRAW_COPPER_SWORD = ITEMS.register("rraw_copper_sword",
    ...
    public static final RegistrySupplier<Item> RRAW_COPPER_PICKAXE = ITEMS.register("rraw_copper_pickaxe",
    ...
    public static final RegistrySupplier<Item> RRAW_COPPER_SHOVEL = ITEMS.register("rraw_copper_shovel",
    ...
    public static final RegistrySupplier<Item> RRAW_COPPER_AXE = ITEMS.register("rraw_copper_axe",
    ...
    public static final RegistrySupplier<Item> RRAW_COPPER_HOE = ITEMS.register("rraw_copper_hoe",
    ...
    public static final RegistrySupplier<Item> RRAW_IRON_SWORD = ITEMS.register("rraw_iron_sword",
    ...
    public static final RegistrySupplier<Item> RRAW_IRON_PICKAXE = ITEMS.register("rraw_iron_pickaxe",
    ...
    public static final RegistrySupplier<Item> RRAW_IRON_SHOVEL = ITEMS.register("rraw_iron_shovel",
    ...
    public static final RegistrySupplier<Item> RRAW_IRON_AXE = ITEMS.register("rraw_iron_axe",
            () -> new AxeItem(ModToolTiers.RRAW_IRON, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.RRAW_IRON, 6, -3.2f))));
    public static final RegistrySupplier<Item> RRAW_IRON_HOE = ITEMS.register("rraw_iron_hoe",
    ...
    public static final RegistrySupplier<Item> RRAW_RGOLD_SWORD = ITEMS.register("rraw_rgold_sword",
    ...
    public static final RegistrySupplier<Item> RRAW_RGOLD_PICKAXE = ITEMS.register("rraw_rgold_pickaxe",
    ...
    public static final RegistrySupplier<Item> RRAW_RGOLD_SHOVEL = ITEMS.register("rraw_rgold_shovel",
    ...
    public static final RegistrySupplier<Item> RRAW_RGOLD_AXE = ITEMS.register("rraw_rgold_axe",
    ...
    public static final RegistrySupplier<Item> RRAW_RGOLD_HOE = ITEMS.register("rraw_rgold_hoe",
    ...
    public static final RegistrySupplier<Item> RSCRAP_SWORD = ITEMS.register("rscrap_sword",
            () -> new SwordItem(ModToolTiers.RSCRAP, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.RSCRAP, 3, -2.4f))));
    public static final RegistrySupplier<Item> RSCRAP_PICKAXE = ITEMS.register("rscrap_pickaxe",
    ...
    public static final RegistrySupplier<Item> RSCRAP_SHOVEL = ITEMS.register("rscrap_shovel",
            () -> new ShovelItem(ModToolTiers.RSCRAP, new Item.Properties()
                    .attributes(ShovelItem.createAttributes(ModToolTiers.RSCRAP, 1.5f, -3f))));
    public static final RegistrySupplier<Item> RSCRAP_AXE = ITEMS.register("rscrap_axe",
            () -> new AxeItem(ModToolTiers.RSCRAP, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.RSCRAP, 6, -3.2f))));
    public static final RegistrySupplier<Item> RSCRAP_HOE = ITEMS.register("rscrap_hoe",
    ...
    public static final RegistrySupplier<Item> CALCIFIED_AMETHYST = ITEMS.register("calcified_amethyst",
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistrySupplier<Item> GLACIAL_SHARD = ITEMS.register("glacial_shard",
            () -> new Item(new Item.Properties().stacksTo(64)));
    ...
    // -------------------------------------------------------------------------
    public static final RegistrySupplier<Item> RAMETHYST_SWORD = ITEMS.register("ramethyst_sword",
    ...
    public static final RegistrySupplier<Item> RAMETHYST_PICKAXE = ITEMS.register("ramethyst_pickaxe",
    ...
    public static final RegistrySupplier<Item> RAMETHYST_SHOVEL = ITEMS.register("ramethyst_shovel",
    ...
    public static final RegistrySupplier<Item> RAMETHYST_AXE = ITEMS.register("ramethyst_axe",
            () -> new AxeItem(ModToolTiers.RAMETHYST, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.RAMETHYST, 6, -3.2f))));
    public static final RegistrySupplier<Item> RAMETHYST_HOE = ITEMS.register("ramethyst_hoe",
    ...
    // -------------------------------------------------------------------------
    public static final RegistrySupplier<Item> SNOW_SWORD = ITEMS.register("snow_sword",
    ...
    public static final RegistrySupplier<Item> SNOW_PICKAXE = ITEMS.register("snow_pickaxe",
    ...
    public static final RegistrySupplier<Item> SNOW_SHOVEL = ITEMS.register("snow_shovel",
    ...
    public static final RegistrySupplier<Item> SNOW_AXE = ITEMS.register("snow_axe",
            () -> new AxeItem(ModToolTiers.SNOW_TOOL, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.SNOW_TOOL, 6, -3.2f))));
    public static final RegistrySupplier<Item> SNOW_HOE = ITEMS.register("snow_hoe",
    ...
    // -------------------------------------------------------------------------
    public static final RegistrySupplier<Item> RQUARTZ_SWORD = ITEMS.register("rquartz_sword",
            () -> new SwordItem(ModToolTiers.RQUARTZ, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.RQUARTZ, 3, -2.4f))));
    public static final RegistrySupplier<Item> RQUARTZ_PICKAXE = ITEMS.register("rquartz_pickaxe",
    ...
    public static final RegistrySupplier<Item> RQUARTZ_SHOVEL = ITEMS.register("rquartz_shovel",
    ...
    public static final RegistrySupplier<Item> RQUARTZ_AXE = ITEMS.register("rquartz_axe",
            () -> new AxeItem(ModToolTiers.RQUARTZ, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.RQUARTZ, 6, -3.2f))));
    public static final RegistrySupplier<Item> RQUARTZ_HOE = ITEMS.register("rquartz_hoe",
    ...
    // -------------------------------------------------------------------------
    public static final RegistrySupplier<Item> RPRISM_SWORD = ITEMS.register("rprism_sword",
            () -> new SwordItem(ModToolTiers.RPRISM, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.RPRISM, 3, -2.4f))));
    public static final RegistrySupplier<Item> RPRISM_PICKAXE = ITEMS.register("rprism_pickaxe",
    ...
    public static final RegistrySupplier<Item> RPRISM_SHOVEL = ITEMS.register("rprism_shovel",
            () -> new ShovelItem(ModToolTiers.RPRISM, new Item.Properties()
                    .attributes(ShovelItem.createAttributes(ModToolTiers.RPRISM, 1.5f, -3f))));
    public static final RegistrySupplier<Item> RPRISM_AXE = ITEMS.register("rprism_axe",
            () -> new AxeItem(ModToolTiers.RPRISM, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.RPRISM, 6, -3.2f))));
    public static final RegistrySupplier<Item> RPRISM_HOE = ITEMS.register("rprism_hoe",
    ...
    // -------------------------------------------------------------------------
    public static final RegistrySupplier<Item> CAMETHYST_SWORD = ITEMS.register("camethyst_sword",
    ...
    public static final RegistrySupplier<Item> CAMETHYST_PICKAXE = ITEMS.register("camethyst_pickaxe",
    ...
    public static final RegistrySupplier<Item> CAMETHYST_SHOVEL = ITEMS.register("camethyst_shovel",
    ...
    public static final RegistrySupplier<Item> CAMETHYST_AXE = ITEMS.register("camethyst_axe",
            () -> new AxeItem(ModToolTiers.CAMETHYST, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.CAMETHYST, 6, -3.2f))));
    public static final RegistrySupplier<Item> CAMETHYST_HOE = ITEMS.register("camethyst_hoe",
            () -> new HoeItem(ModToolTiers.CAMETHYST, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.CAMETHYST, 0, -3f))));
    public static final RegistrySupplier<Item> CAMETHYST_HELMET = ITEMS.register("camethyst_helmet",
            () -> new ArmorItem(ModArmorMaterials.CAMETHYST_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(15))));
    public static final RegistrySupplier<Item> CAMETHYST_CHESTPLATE = ITEMS.register("camethyst_chestplate",
            () -> new ArmorItem(ModArmorMaterials.CAMETHYST_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(15))));
    public static final RegistrySupplier<Item> CAMETHYST_LEGGINGS = ITEMS.register("camethyst_leggings",
            () -> new ArmorItem(ModArmorMaterials.CAMETHYST_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(15))));
    public static final RegistrySupplier<Item> CAMETHYST_BOOTS = ITEMS.register("camethyst_boots",
    ...
    public static final RegistrySupplier<Item> ICE_PICKAXE = ITEMS.register("ice_pickaxe",
    ...
    public static final RegistrySupplier<Item> ICE_SHOVEL = ITEMS.register("ice_shovel",
    ...
    public static final RegistrySupplier<Item> ICE_CHESTPLATE = ITEMS.register("ice_chestplate",
    ...
    public static final RegistrySupplier<Item> ICE_LEGGINGS = ITEMS.register("ice_leggings",
    ...
    public static final RegistrySupplier<Item> ICE_BOOTS = ITEMS.register("ice_boots",
    ...
    // -------------------------------------------------------------------------
    public static final RegistrySupplier<Item> PQUARTZ_SWORD = ITEMS.register("pquartz_sword",
            () -> new SwordItem(ModToolTiers.PQUARTZ, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.PQUARTZ, 3, -2.4f))));
    public static final RegistrySupplier<Item> PQUARTZ_PICKAXE = ITEMS.register("pquartz_pickaxe",
    ...
    public static final RegistrySupplier<Item> PQUARTZ_SHOVEL = ITEMS.register("pquartz_shovel",
    ...
    public static final RegistrySupplier<Item> PQUARTZ_AXE = ITEMS.register("pquartz_axe",
            () -> new AxeItem(ModToolTiers.PQUARTZ, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.PQUARTZ, 6, -3.2f))));
    public static final RegistrySupplier<Item> PQUARTZ_HOE = ITEMS.register("pquartz_hoe",
            () -> new HoeItem(ModToolTiers.PQUARTZ, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.PQUARTZ, 0, -3f))));
    public static final RegistrySupplier<Item> PQUARTZ_HELMET = ITEMS.register("pquartz_helmet",
            () -> new ArmorItem(ModArmorMaterials.PQUARTZ_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(16))));
    public static final RegistrySupplier<Item> PQUARTZ_CHESTPLATE = ITEMS.register("pquartz_chestplate",
            () -> new ArmorItem(ModArmorMaterials.PQUARTZ_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(16))));
    public static final RegistrySupplier<Item> PQUARTZ_LEGGINGS = ITEMS.register("pquartz_leggings",
            () -> new ArmorItem(ModArmorMaterials.PQUARTZ_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(16))));
    public static final RegistrySupplier<Item> PQUARTZ_BOOTS = ITEMS.register("pquartz_boots",
    ...
    // -------------------------------------------------------------------------
    public static final RegistrySupplier<Item> PPRISM_SWORD = ITEMS.register("pprism_sword",
            () -> new SwordItem(ModToolTiers.PPRISM, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.PPRISM, 3, -2.4f))));
    public static final RegistrySupplier<Item> PPRISM_PICKAXE = ITEMS.register("pprism_pickaxe",
    ...
    public static final RegistrySupplier<Item> PPRISM_CHESTPLATE = ITEMS.register("pprism_chestplate",
    ...
    public static final RegistrySupplier<Item> PPRISM_LEGGINGS = ITEMS.register("pprism_leggings",
    ...
    public static final RegistrySupplier<Item> PPRISM_BOOTS = ITEMS.register("pprism_boots",
    ...
    // -------------------------------------------------------------------------
    public static final RegistrySupplier<Item> RFLINT_SWORD = ITEMS.register("rflint_sword",
            () -> new SwordItem(ModToolTiers.RFLINT, new Item.Properties().attributes(SwordItem.createAttributes(ModToolTiers.RFLINT, 3, -2.4f))));
    public static final RegistrySupplier<Item> RFLINT_PICKAXE = ITEMS.register("rflint_pickaxe",
    ...
    public static final RegistrySupplier<Item> RFLINT_SHOVEL = ITEMS.register("rflint_shovel",
    ...
    public static final RegistrySupplier<Item> RFLINT_AXE = ITEMS.register("rflint_axe",
            () -> new AxeItem(ModToolTiers.RFLINT, new Item.Properties().attributes(AxeItem.createAttributes(ModToolTiers.RFLINT, 6, -3.2f))));
    public static final RegistrySupplier<Item> RFLINT_HOE = ITEMS.register("rflint_hoe",
    ...
    // -------------------------------------------------------------------------
    public static final RegistrySupplier<Item> FNI_SWORD = ITEMS.register("fni_sword",
    ...
    public static final RegistrySupplier<Item> FNI_PICKAXE = ITEMS.register("fni_pickaxe",
    ...
    public static final RegistrySupplier<Item> FNI_SHOVEL = ITEMS.register("fni_shovel",
    ...
    public static final RegistrySupplier<Item> FNI_CHESTPLATE = ITEMS.register("fni_chestplate",
    ...
    public static final RegistrySupplier<Item> FNI_LEGGINGS = ITEMS.register("fni_leggings",
    ...
    public static final RegistrySupplier<Item> FNI_BOOTS = ITEMS.register("fni_boots",
    ...
    public static final RegistrySupplier<Item> ANDESITE_SWORD = ITEMS.register("andesite_sword",
    ...
    public static final RegistrySupplier<Item> ANDESITE_PICKAXE = ITEMS.register("andesite_pickaxe",
    ...
    public static final RegistrySupplier<Item> ANDESITE_SHOVEL = ITEMS.register("andesite_shovel",
    ...
    public static final RegistrySupplier<Item> ANDESITE_AXE = ITEMS.register("andesite_axe",
    ...
    public static final RegistrySupplier<Item> ANDESITE_HOE = ITEMS.register("andesite_hoe",
    ...
    public static final RegistrySupplier<Item> BASALT_SWORD = ITEMS.register("basalt_sword",
    ...
    public static final RegistrySupplier<Item> BASALT_PICKAXE = ITEMS.register("basalt_pickaxe",
    ...
    public static final RegistrySupplier<Item> BASALT_SHOVEL = ITEMS.register("basalt_shovel",
    ...
    public static final RegistrySupplier<Item> BASALT_AXE = ITEMS.register("basalt_axe",
    ...
    public static final RegistrySupplier<Item> BASALT_HOE = ITEMS.register("basalt_hoe",
    ...
    public static final RegistrySupplier<Item> BLACKSTONE_SWORD = ITEMS.register("blackstone_sword",
    ...
    public static final RegistrySupplier<Item> BLACKSTONE_PICKAXE = ITEMS.register("blackstone_pickaxe",
    ...
    public static final RegistrySupplier<Item> BLACKSTONE_SHOVEL = ITEMS.register("blackstone_shovel",
    ...
    public static final RegistrySupplier<Item> BLACKSTONE_AXE = ITEMS.register("blackstone_axe",
    ...
    public static final RegistrySupplier<Item> BLACKSTONE_HOE = ITEMS.register("blackstone_hoe",
    ...
    public static final RegistrySupplier<Item> CALCITE_SWORD = ITEMS.register("calcite_sword",
    ...
    public static final RegistrySupplier<Item> CALCITE_PICKAXE = ITEMS.register("calcite_pickaxe",
    ...
    public static final RegistrySupplier<Item> CALCITE_SHOVEL = ITEMS.register("calcite_shovel",
    ...
    public static final RegistrySupplier<Item> CALCITE_AXE = ITEMS.register("calcite_axe",
    ...
    public static final RegistrySupplier<Item> CALCITE_HOE = ITEMS.register("calcite_hoe",
    ...
    public static final RegistrySupplier<Item> DEEPSLATE_SWORD = ITEMS.register("deepslate_sword",
    ...
    public static final RegistrySupplier<Item> DEEPSLATE_PICKAXE = ITEMS.register("deepslate_pickaxe",
    ...
    public static final RegistrySupplier<Item> DEEPSLATE_SHOVEL = ITEMS.register("deepslate_shovel",
    ...
    public static final RegistrySupplier<Item> DEEPSLATE_AXE = ITEMS.register("deepslate_axe",
    ...
    public static final RegistrySupplier<Item> DEEPSLATE_HOE = ITEMS.register("deepslate_hoe",
    ...
    public static final RegistrySupplier<Item> DIORITE_SWORD = ITEMS.register("diorite_sword",
    ...
    public static final RegistrySupplier<Item> DIORITE_PICKAXE = ITEMS.register("diorite_pickaxe",
    ...
    public static final RegistrySupplier<Item> DIORITE_SHOVEL = ITEMS.register("diorite_shovel",
    ...
    public static final RegistrySupplier<Item> DIORITE_AXE = ITEMS.register("diorite_axe",
    ...
    public static final RegistrySupplier<Item> DIORITE_HOE = ITEMS.register("diorite_hoe",
    ...
    public static final RegistrySupplier<Item> END_STONE_SWORD = ITEMS.register("end_stone_sword",
    ...
    public static final RegistrySupplier<Item> END_STONE_PICKAXE = ITEMS.register("end_stone_pickaxe",
    ...
    public static final RegistrySupplier<Item> END_STONE_SHOVEL = ITEMS.register("end_stone_shovel",
    ...
    public static final RegistrySupplier<Item> END_STONE_AXE = ITEMS.register("end_stone_axe",
    ...
    public static final RegistrySupplier<Item> END_STONE_HOE = ITEMS.register("end_stone_hoe",
    ...
    public static final RegistrySupplier<Item> GRANITE_SWORD = ITEMS.register("granite_sword",
    ...
    public static final RegistrySupplier<Item> GRANITE_PICKAXE = ITEMS.register("granite_pickaxe",
    ...
    public static final RegistrySupplier<Item> GRANITE_SHOVEL = ITEMS.register("granite_shovel",
    ...
    public static final RegistrySupplier<Item> GRANITE_AXE = ITEMS.register("granite_axe",
    ...
    public static final RegistrySupplier<Item> GRANITE_HOE = ITEMS.register("granite_hoe",
    ...
    public static final RegistrySupplier<Item> NETHERRACK_SWORD = ITEMS.register("netherrack_sword",
    ...
    public static final RegistrySupplier<Item> NETHERRACK_PICKAXE = ITEMS.register("netherrack_pickaxe",
    ...
    public static final RegistrySupplier<Item> NETHERRACK_SHOVEL = ITEMS.register("netherrack_shovel",
    ...
    public static final RegistrySupplier<Item> NETHERRACK_AXE = ITEMS.register("netherrack_axe",
    ...
    public static final RegistrySupplier<Item> NETHERRACK_HOE = ITEMS.register("netherrack_hoe",
    ...
    public static final RegistrySupplier<Item> SANDSTONE_SWORD = ITEMS.register("sandstone_sword",
    ...
    public static final RegistrySupplier<Item> SANDSTONE_PICKAXE = ITEMS.register("sandstone_pickaxe",
    ...
    public static final RegistrySupplier<Item> SANDSTONE_SHOVEL = ITEMS.register("sandstone_shovel",
    ...
    public static final RegistrySupplier<Item> SANDSTONE_AXE = ITEMS.register("sandstone_axe",
    ...
    public static final RegistrySupplier<Item> SANDSTONE_HOE = ITEMS.register("sandstone_hoe",
    ...
    public static final RegistrySupplier<Item> SMOOTH_BASALT_SWORD = ITEMS.register("smooth_basalt_sword",
    ...
    public static final RegistrySupplier<Item> SMOOTH_BASALT_PICKAXE = ITEMS.register("smooth_basalt_pickaxe",
    ...
    public static final RegistrySupplier<Item> SMOOTH_BASALT_SHOVEL = ITEMS.register("smooth_basalt_shovel",
    ...
    public static final RegistrySupplier<Item> SMOOTH_BASALT_AXE = ITEMS.register("smooth_basalt_axe",
    ...
    public static final RegistrySupplier<Item> SMOOTH_BASALT_HOE = ITEMS.register("smooth_basalt_hoe",
    ...
    public static final RegistrySupplier<Item> TERRACOTTA_SWORD = ITEMS.register("terracotta_sword",
    ...
    public static final RegistrySupplier<Item> TERRACOTTA_PICKAXE = ITEMS.register("terracotta_pickaxe",
    ...
    public static final RegistrySupplier<Item> TERRACOTTA_SHOVEL = ITEMS.register("terracotta_shovel",
    ...
    public static final RegistrySupplier<Item> TERRACOTTA_AXE = ITEMS.register("terracotta_axe",
    ...
    public static final RegistrySupplier<Item> TERRACOTTA_HOE = ITEMS.register("terracotta_hoe",
    ...
    public static final RegistrySupplier<Item> TUFF_SWORD = ITEMS.register("tuff_sword",
    ...
    public static final RegistrySupplier<Item> TUFF_PICKAXE = ITEMS.register("tuff_pickaxe",
    ...
    public static final RegistrySupplier<Item> TUFF_SHOVEL = ITEMS.register("tuff_shovel",
    ...
    public static final RegistrySupplier<Item> TUFF_AXE = ITEMS.register("tuff_axe",
    ...
    public static final RegistrySupplier<Item> TUFF_HOE = ITEMS.register("tuff_hoe",
    ...
    public static final RegistrySupplier<Item> OAK_SWORD = ITEMS.register("oak_sword",
    ...
    public static final RegistrySupplier<Item> OAK_PICKAXE = ITEMS.register("oak_pickaxe",
    ...
    public static final RegistrySupplier<Item> OAK_SHOVEL = ITEMS.register("oak_shovel",
    ...
    public static final RegistrySupplier<Item> OAK_AXE = ITEMS.register("oak_axe",
            () -> new AxeItem(ModToolTiers.WOOD_OAK, new Item.Properties().attributes(AxeItem.createAttributes(ModToolTiers.WOOD_OAK, 6, -3.2f))));
    public static final RegistrySupplier<Item> OAK_HOE = ITEMS.register("oak_hoe",
    ...
    public static final RegistrySupplier<Item> SPRUCE_SWORD = ITEMS.register("spruce_sword",
    ...
    public static final RegistrySupplier<Item> SPRUCE_PICKAXE = ITEMS.register("spruce_pickaxe",
    ...
    public static final RegistrySupplier<Item> SPRUCE_SHOVEL = ITEMS.register("spruce_shovel",
    ...
    public static final RegistrySupplier<Item> SPRUCE_AXE = ITEMS.register("spruce_axe",
    ...
    public static final RegistrySupplier<Item> SPRUCE_HOE = ITEMS.register("spruce_hoe",
    ...
    public static final RegistrySupplier<Item> BIRCH_SWORD = ITEMS.register("birch_sword",
    ...
    public static final RegistrySupplier<Item> BIRCH_PICKAXE = ITEMS.register("birch_pickaxe",
    ...
    public static final RegistrySupplier<Item> BIRCH_SHOVEL = ITEMS.register("birch_shovel",
    ...
    public static final RegistrySupplier<Item> BIRCH_AXE = ITEMS.register("birch_axe",
    ...
    public static final RegistrySupplier<Item> BIRCH_HOE = ITEMS.register("birch_hoe",
    ...
    public static final RegistrySupplier<Item> JUNGLE_SWORD = ITEMS.register("jungle_sword",
    ...
    public static final RegistrySupplier<Item> JUNGLE_PICKAXE = ITEMS.register("jungle_pickaxe",
    ...
    public static final RegistrySupplier<Item> JUNGLE_SHOVEL = ITEMS.register("jungle_shovel",
    ...
    public static final RegistrySupplier<Item> JUNGLE_AXE = ITEMS.register("jungle_axe",
    ...
    public static final RegistrySupplier<Item> JUNGLE_HOE = ITEMS.register("jungle_hoe",
    ...
    public static final RegistrySupplier<Item> ACACIA_SWORD = ITEMS.register("acacia_sword",
    ...
    public static final RegistrySupplier<Item> ACACIA_PICKAXE = ITEMS.register("acacia_pickaxe",
    ...
    public static final RegistrySupplier<Item> ACACIA_SHOVEL = ITEMS.register("acacia_shovel",
    ...
    public static final RegistrySupplier<Item> ACACIA_AXE = ITEMS.register("acacia_axe",
    ...
    public static final RegistrySupplier<Item> ACACIA_HOE = ITEMS.register("acacia_hoe",
    ...
    public static final RegistrySupplier<Item> DARK_OAK_SWORD = ITEMS.register("dark_oak_sword",
    ...
    public static final RegistrySupplier<Item> DARK_OAK_PICKAXE = ITEMS.register("dark_oak_pickaxe",
    ...
    public static final RegistrySupplier<Item> DARK_OAK_SHOVEL = ITEMS.register("dark_oak_shovel",
    ...
    public static final RegistrySupplier<Item> DARK_OAK_AXE = ITEMS.register("dark_oak_axe",
    ...
    public static final RegistrySupplier<Item> DARK_OAK_HOE = ITEMS.register("dark_oak_hoe",
    ...
    public static final RegistrySupplier<Item> MANGROVE_SWORD = ITEMS.register("mangrove_sword",
    ...
    public static final RegistrySupplier<Item> MANGROVE_PICKAXE = ITEMS.register("mangrove_pickaxe",
    ...
    public static final RegistrySupplier<Item> MANGROVE_SHOVEL = ITEMS.register("mangrove_shovel",
    ...
    public static final RegistrySupplier<Item> MANGROVE_AXE = ITEMS.register("mangrove_axe",
    ...
    public static final RegistrySupplier<Item> MANGROVE_HOE = ITEMS.register("mangrove_hoe",
    ...
    public static final RegistrySupplier<Item> CHERRY_SWORD = ITEMS.register("cherry_sword",
    ...
    public static final RegistrySupplier<Item> CHERRY_PICKAXE = ITEMS.register("cherry_pickaxe",
    ...
    public static final RegistrySupplier<Item> CHERRY_SHOVEL = ITEMS.register("cherry_shovel",
    ...
    public static final RegistrySupplier<Item> CHERRY_AXE = ITEMS.register("cherry_axe",
    ...
    public static final RegistrySupplier<Item> CHERRY_HOE = ITEMS.register("cherry_hoe",
    ...
    public static final RegistrySupplier<Item> BAMBOO_SWORD = ITEMS.register("bamboo_sword",
    ...
    public static final RegistrySupplier<Item> BAMBOO_PICKAXE = ITEMS.register("bamboo_pickaxe",
    ...
    public static final RegistrySupplier<Item> BAMBOO_SHOVEL = ITEMS.register("bamboo_shovel",
    ...
    public static final RegistrySupplier<Item> BAMBOO_AXE = ITEMS.register("bamboo_axe",
    ...
    public static final RegistrySupplier<Item> BAMBOO_HOE = ITEMS.register("bamboo_hoe",
    ...
    public static final RegistrySupplier<Item> CRIMSON_SWORD = ITEMS.register("crimson_sword",
    ...
    public static final RegistrySupplier<Item> CRIMSON_PICKAXE = ITEMS.register("crimson_pickaxe",
    ...
    public static final RegistrySupplier<Item> CRIMSON_SHOVEL = ITEMS.register("crimson_shovel",
    ...
    public static final RegistrySupplier<Item> CRIMSON_AXE = ITEMS.register("crimson_axe",
    ...
    public static final RegistrySupplier<Item> CRIMSON_HOE = ITEMS.register("crimson_hoe",
    ...
    public static final RegistrySupplier<Item> WARPED_SWORD = ITEMS.register("warped_sword",
    ...
    public static final RegistrySupplier<Item> WARPED_PICKAXE = ITEMS.register("warped_pickaxe",
    ...
    public static final RegistrySupplier<Item> WARPED_SHOVEL = ITEMS.register("warped_shovel",
    ...
    public static final RegistrySupplier<Item> WARPED_AXE = ITEMS.register("warped_axe",
    ...
    public static final RegistrySupplier<Item> WARPED_HOE = ITEMS.register("warped_hoe",
    ...
    // -------------------------------------------------------------------------
    public static final RegistrySupplier<Item> LEATHER_SWORD = ITEMS.register("leather_sword",
            () -> new SwordItem(ModToolTiers.LEATHER, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.LEATHER, 3, -2.4f))));
    public static final RegistrySupplier<Item> LEATHER_PICKAXE = ITEMS.register("leather_pickaxe",
    ...
    public static final RegistrySupplier<Item> LEATHER_SHOVEL = ITEMS.register("leather_shovel",
    ...
    public static final RegistrySupplier<Item> LEATHER_AXE = ITEMS.register("leather_axe",
            () -> new AxeItem(ModToolTiers.LEATHER, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.LEATHER, 6, -3.2f))));
    public static final RegistrySupplier<Item> LEATHER_HOE = ITEMS.register("leather_hoe",
    ...
    public static final RegistrySupplier<Item> FEATHER_SWORD = ITEMS.register("feather_sword",
            () -> new SwordItem(ModToolTiers.FEATHER, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.FEATHER, 3, -2.4f))));
    public static final RegistrySupplier<Item> FEATHER_PICKAXE = ITEMS.register("feather_pickaxe",
    ...
    public static final RegistrySupplier<Item> FEATHER_SHOVEL = ITEMS.register("feather_shovel",
    ...
    public static final RegistrySupplier<Item> FEATHER_AXE = ITEMS.register("feather_axe",
            () -> new AxeItem(ModToolTiers.FEATHER, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.FEATHER, 6, -3.2f))));
    public static final RegistrySupplier<Item> FEATHER_HOE = ITEMS.register("feather_hoe",
    ...
    public static final RegistrySupplier<Item> RABBIT_HIDE_HELMET = ITEMS.register("rabbit_hide_helmet",
    ...
    public static final RegistrySupplier<Item> RABBIT_HIDE_CHESTPLATE = ITEMS.register("rabbit_hide_chestplate",
    ...
    public static final RegistrySupplier<Item> RABBIT_HIDE_LEGGINGS = ITEMS.register("rabbit_hide_leggings",
    ...
    public static final RegistrySupplier<Item> RABBIT_HIDE_BOOTS = ITEMS.register("rabbit_hide_boots",
    ...
    public static final RegistrySupplier<Item> CACTUS_PICKAXE = ITEMS.register("cactus_pickaxe",
    ...
    public static final RegistrySupplier<Item> CACTUS_CHESTPLATE = ITEMS.register("cactus_chestplate",
    ...
    public static final RegistrySupplier<Item> CACTUS_LEGGINGS = ITEMS.register("cactus_leggings",
    ...
    public static final RegistrySupplier<Item> CACTUS_BOOTS = ITEMS.register("cactus_boots",
    ...
    // ── Sponge (tools only) ─────────────────────────────────────────────────
    public static final RegistrySupplier<Item> SPONGE_SWORD = ITEMS.register("sponge_sword",
            () -> new SwordItem(ModToolTiers.SPONGE, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.SPONGE, 3, -2.4f))));
    public static final RegistrySupplier<Item> SPONGE_PICKAXE = ITEMS.register("sponge_pickaxe",
    ...
    public static final RegistrySupplier<Item> BONE_SHOVEL = ITEMS.register("bone_shovel",
    ...
    public static final RegistrySupplier<Item> BONE_HOE = ITEMS.register("bone_hoe",
    ...
    public static final RegistrySupplier<Item> NETHER_WART_PICKAXE = ITEMS.register("nether_wart_pickaxe",
    ...
    public static final RegistrySupplier<Item> NETHER_WART_SHOVEL = ITEMS.register("nether_wart_shovel",
    ...
    public static final RegistrySupplier<Item> NETHER_WART_AXE = ITEMS.register("nether_wart_axe",
    ...
    public static final RegistrySupplier<Item> NETHER_WART_HOE = ITEMS.register("nether_wart_hoe",
    ...
    public static final RegistrySupplier<Item> BRICK_CHESTPLATE = ITEMS.register("brick_chestplate",
    ...
    public static final RegistrySupplier<Item> BRICK_LEGGINGS = ITEMS.register("brick_leggings",
    ...
    public static final RegistrySupplier<Item> BRICK_BOOTS = ITEMS.register("brick_boots",
    ...
    public static final RegistrySupplier<Item> NETHER_BRICK_SWORD = ITEMS.register("nether_brick_sword",
    ...
    public static final RegistrySupplier<Item> NETHER_BRICK_PICKAXE = ITEMS.register("nether_brick_pickaxe",
    ...
    public static final RegistrySupplier<Item> NETHER_BRICK_SHOVEL = ITEMS.register("nether_brick_shovel",
    ...
    public static final RegistrySupplier<Item> NETHER_BRICK_AXE = ITEMS.register("nether_brick_axe",
    ...
    public static final RegistrySupplier<Item> NETHER_BRICK_HOE = ITEMS.register("nether_brick_hoe",
    ...
    public static final RegistrySupplier<Item> NETHER_BRICK_HELMET = ITEMS.register("nether_brick_helmet",
            () -> new ArmorItem(ModArmorMaterials.NETHER_BRICK_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(12))));
    public static final RegistrySupplier<Item> NETHER_BRICK_CHESTPLATE = ITEMS.register("nether_brick_chestplate",
            () -> new ArmorItem(ModArmorMaterials.NETHER_BRICK_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(12))));
    public static final RegistrySupplier<Item> NETHER_BRICK_LEGGINGS = ITEMS.register("nether_brick_leggings",
            () -> new ArmorItem(ModArmorMaterials.NETHER_BRICK_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(12))));
    public static final RegistrySupplier<Item> NETHER_BRICK_BOOTS = ITEMS.register("nether_brick_boots",
            () -> new ArmorItem(ModArmorMaterials.NETHER_BRICK_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(12))));

    // ── Pointed Dripstone (tools only) ──────────────────────────────────────
    public static final RegistrySupplier<Item> POINTED_DRIPSTONE_SWORD = ITEMS.register("pointed_dripstone_sword",
    ...
    public static final RegistrySupplier<Item> POINTED_DRIPSTONE_PICKAXE = ITEMS.register("pointed_dripstone_pickaxe",
    ...
    public static final RegistrySupplier<Item> POINTED_DRIPSTONE_SHOVEL = ITEMS.register("pointed_dripstone_shovel",
    ...
    public static final RegistrySupplier<Item> POINTED_DRIPSTONE_AXE = ITEMS.register("pointed_dripstone_axe",
    ...
    public static final RegistrySupplier<Item> POINTED_DRIPSTONE_HOE = ITEMS.register("pointed_dripstone_hoe",
    ...
    public static final RegistrySupplier<Item> COPPER_PICKAXE = ITEMS.register("copper_pickaxe",
    ...
    public static final RegistrySupplier<Item> COPPER_HOE = ITEMS.register("copper_hoe",
            () -> new HoeItem(ModToolTiers.COPPER, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.COPPER, 0, -3f))));
    public static final RegistrySupplier<Item> COPPER_HELMET = ITEMS.register("copper_helmet",
            () -> new ArmorItem(ModArmorMaterials.COPPER_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(12))));
    public static final RegistrySupplier<Item> COPPER_CHESTPLATE = ITEMS.register("copper_chestplate",
            () -> new ArmorItem(ModArmorMaterials.COPPER_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(12))));
    public static final RegistrySupplier<Item> COPPER_LEGGINGS = ITEMS.register("copper_leggings",
            () -> new ArmorItem(ModArmorMaterials.COPPER_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(12))));
    public static final RegistrySupplier<Item> COPPER_BOOTS = ITEMS.register("copper_boots",
            () -> new ArmorItem(ModArmorMaterials.COPPER_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(12))));

    // ── Phantom Membrane (tools + armor) ────────────────────────────────────
    public static final RegistrySupplier<Item> PHANTOM_SWORD = ITEMS.register("phantom_sword",
    ...
    public static final RegistrySupplier<Item> PHANTOM_PICKAXE = ITEMS.register("phantom_pickaxe",
    ...
    public static final RegistrySupplier<Item> PHANTOM_SHOVEL = ITEMS.register("phantom_shovel",
    ...
    public static final RegistrySupplier<Item> PHANTOM_AXE = ITEMS.register("phantom_axe",
    ...
    public static final RegistrySupplier<Item> PHANTOM_HOE = ITEMS.register("phantom_hoe",
    ...
    public static final RegistrySupplier<Item> PHANTOM_HELMET = ITEMS.register("phantom_helmet",
            () -> new ArmorItem(ModArmorMaterials.PHANTOM_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(10))));
    public static final RegistrySupplier<Item> PHANTOM_CHESTPLATE = ITEMS.register("phantom_chestplate",
            () -> new ArmorItem(ModArmorMaterials.PHANTOM_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(10))));
    public static final RegistrySupplier<Item> PHANTOM_LEGGINGS = ITEMS.register("phantom_leggings",
            () -> new ArmorItem(ModArmorMaterials.PHANTOM_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(10))));
    public static final RegistrySupplier<Item> PHANTOM_BOOTS = ITEMS.register("phantom_boots",
            () -> new ArmorItem(ModArmorMaterials.PHANTOM_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(10))));

    // ── Magma Cream (tools + armor) ─────────────────────────────────────────
    public static final RegistrySupplier<Item> MAGMA_CREAM_SWORD = ITEMS.register("magma_cream_sword",
    ...
    public static final RegistrySupplier<Item> MAGMA_CREAM_PICKAXE = ITEMS.register("magma_cream_pickaxe",
    ...
    public static final RegistrySupplier<Item> MAGMA_CREAM_SHOVEL = ITEMS.register("magma_cream_shovel",
    ...
    public static final RegistrySupplier<Item> MAGMA_CREAM_AXE = ITEMS.register("magma_cream_axe",
    ...
    public static final RegistrySupplier<Item> MAGMA_CREAM_HOE = ITEMS.register("magma_cream_hoe",
    ...
    public static final RegistrySupplier<Item> BLAZE_PICKAXE = ITEMS.register("blaze_pickaxe",
    ...
    public static final RegistrySupplier<Item> BLAZE_SHOVEL = ITEMS.register("blaze_shovel",
    ...
    public static final RegistrySupplier<Item> BLAZE_AXE = ITEMS.register("blaze_axe",
            () -> new AxeItem(ModToolTiers.BLAZE_ROD, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.BLAZE_ROD, 6, -3.2f))));
    public static final RegistrySupplier<Item> BLAZE_HOE = ITEMS.register("blaze_hoe",
            () -> new HoeItem(ModToolTiers.BLAZE_ROD, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.BLAZE_ROD, 0, -3f))));
    public static final RegistrySupplier<Item> BLAZE_HELMET = ITEMS.register("blaze_helmet",
            () -> new ArmorItem(ModArmorMaterials.BLAZE_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(14))));
    public static final RegistrySupplier<Item> BLAZE_CHESTPLATE = ITEMS.register("blaze_chestplate",
            () -> new ArmorItem(ModArmorMaterials.BLAZE_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(14))));
    public static final RegistrySupplier<Item> BLAZE_LEGGINGS = ITEMS.register("blaze_leggings",
            () -> new ArmorItem(ModArmorMaterials.BLAZE_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(14))));
    public static final RegistrySupplier<Item> BLAZE_BOOTS = ITEMS.register("blaze_boots",
            () -> new ArmorItem(ModArmorMaterials.BLAZE_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(14))));

    // ── Nautilus Shell (tools + armor) ──────────────────────────────────────
    public static final RegistrySupplier<Item> NAUTILUS_SWORD = ITEMS.register("nautilus_sword",
    ...
    public static final RegistrySupplier<Item> NAUTILUS_PICKAXE = ITEMS.register("nautilus_pickaxe",
    ...
    public static final RegistrySupplier<Item> NAUTILUS_SHOVEL = ITEMS.register("nautilus_shovel",
    ...
    public static final RegistrySupplier<Item> NAUTILUS_AXE = ITEMS.register("nautilus_axe",
    ...
    public static final RegistrySupplier<Item> NAUTILUS_HOE = ITEMS.register("nautilus_hoe",
    ...
    public static final RegistrySupplier<Item> NAUTILUS_HELMET = ITEMS.register("nautilus_helmet",
            () -> new ArmorItem(ModArmorMaterials.NAUTILUS_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(14))));
    public static final RegistrySupplier<Item> NAUTILUS_CHESTPLATE = ITEMS.register("nautilus_chestplate",
            () -> new ArmorItem(ModArmorMaterials.NAUTILUS_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(14))));
    public static final RegistrySupplier<Item> NAUTILUS_LEGGINGS = ITEMS.register("nautilus_leggings",
            () -> new ArmorItem(ModArmorMaterials.NAUTILUS_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(14))));
    public static final RegistrySupplier<Item> NAUTILUS_BOOTS = ITEMS.register("nautilus_boots",
            () -> new ArmorItem(ModArmorMaterials.NAUTILUS_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(14))));

    // ── Purpur (tools + armor) ──────────────────────────────────────────────
    public static final RegistrySupplier<Item> PURPUR_SWORD = ITEMS.register("purpur_sword",
            () -> new SwordItem(ModToolTiers.PURPUR, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.PURPUR, 3, -2.4f))));
    public static final RegistrySupplier<Item> PURPUR_PICKAXE = ITEMS.register("purpur_pickaxe",
    ...
    public static final RegistrySupplier<Item> PURPUR_SHOVEL = ITEMS.register("purpur_shovel",
            () -> new ShovelItem(ModToolTiers.PURPUR, new Item.Properties()
                    .attributes(ShovelItem.createAttributes(ModToolTiers.PURPUR, 1.5f, -3f))));
    public static final RegistrySupplier<Item> PURPUR_AXE = ITEMS.register("purpur_axe",
            () -> new AxeItem(ModToolTiers.PURPUR, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.PURPUR, 6, -3.2f))));
    public static final RegistrySupplier<Item> PURPUR_HOE = ITEMS.register("purpur_hoe",
            () -> new HoeItem(ModToolTiers.PURPUR, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.PURPUR, 0, -3f))));
    public static final RegistrySupplier<Item> PURPUR_HELMET = ITEMS.register("purpur_helmet",
            () -> new ArmorItem(ModArmorMaterials.PURPUR_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(14))));
    public static final RegistrySupplier<Item> PURPUR_CHESTPLATE = ITEMS.register("purpur_chestplate",
            () -> new ArmorItem(ModArmorMaterials.PURPUR_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(14))));
    public static final RegistrySupplier<Item> PURPUR_LEGGINGS = ITEMS.register("purpur_leggings",
            () -> new ArmorItem(ModArmorMaterials.PURPUR_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(14))));
    public static final RegistrySupplier<Item> PURPUR_BOOTS = ITEMS.register("purpur_boots",
            () -> new ArmorItem(ModArmorMaterials.PURPUR_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(14))));

    // ── Ghast Tear (tools + armor) ──────────────────────────────────────────
    public static final RegistrySupplier<Item> GHAST_TEAR_SWORD = ITEMS.register("ghast_tear_sword",
    ...
    public static final RegistrySupplier<Item> GHAST_TEAR_PICKAXE = ITEMS.register("ghast_tear_pickaxe",
    ...
    public static final RegistrySupplier<Item> GHAST_TEAR_SHOVEL = ITEMS.register("ghast_tear_shovel",
    ...
    public static final RegistrySupplier<Item> GHAST_TEAR_AXE = ITEMS.register("ghast_tear_axe",
    ...
    public static final RegistrySupplier<Item> GHAST_TEAR_HOE = ITEMS.register("ghast_tear_hoe",
            () -> new HoeItem(ModToolTiers.GHAST_TEAR, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.GHAST_TEAR, 0, -3f))));
    public static final RegistrySupplier<Item> GHAST_TEAR_HELMET = ITEMS.register("ghast_tear_helmet",
            () -> new ArmorItem(ModArmorMaterials.GHAST_TEAR_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(16))));
    public static final RegistrySupplier<Item> GHAST_TEAR_CHESTPLATE = ITEMS.register("ghast_tear_chestplate",
            () -> new ArmorItem(ModArmorMaterials.GHAST_TEAR_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(16))));
    public static final RegistrySupplier<Item> GHAST_TEAR_LEGGINGS = ITEMS.register("ghast_tear_leggings",
            () -> new ArmorItem(ModArmorMaterials.GHAST_TEAR_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(16))));
    public static final RegistrySupplier<Item> GHAST_TEAR_BOOTS = ITEMS.register("ghast_tear_boots",
            () -> new ArmorItem(ModArmorMaterials.GHAST_TEAR_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(16))));

    // ── Eye of Ender (tools + armor) ────────────────────────────────────────
    public static final RegistrySupplier<Item> EYE_OF_ENDER_SWORD = ITEMS.register("eye_of_ender_sword",
    ...
    public static final RegistrySupplier<Item> EYE_OF_ENDER_PICKAXE = ITEMS.register("eye_of_ender_pickaxe",
    ...
    public static final RegistrySupplier<Item> EYE_OF_ENDER_SHOVEL = ITEMS.register("eye_of_ender_shovel",
    ...
    public static final RegistrySupplier<Item> EYE_OF_ENDER_AXE = ITEMS.register("eye_of_ender_axe",
    ...
    public static final RegistrySupplier<Item> EYE_OF_ENDER_HOE = ITEMS.register("eye_of_ender_hoe",
    ...
    public static final RegistrySupplier<Item> EYE_OF_ENDER_HELMET = ITEMS.register("eye_of_ender_helmet",
            () -> new ArmorItem(ModArmorMaterials.EYE_OF_ENDER_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(16))));
    public static final RegistrySupplier<Item> EYE_OF_ENDER_CHESTPLATE = ITEMS.register("eye_of_ender_chestplate",
            () -> new ArmorItem(ModArmorMaterials.EYE_OF_ENDER_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(16))));
    public static final RegistrySupplier<Item> EYE_OF_ENDER_LEGGINGS = ITEMS.register("eye_of_ender_leggings",
            () -> new ArmorItem(ModArmorMaterials.EYE_OF_ENDER_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(16))));
    public static final RegistrySupplier<Item> EYE_OF_ENDER_BOOTS = ITEMS.register("eye_of_ender_boots",
            () -> new ArmorItem(ModArmorMaterials.EYE_OF_ENDER_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(16))));

    // ── Shulker Shell (tools + armor) ───────────────────────────────────────
    public static final RegistrySupplier<Item> SHULKER_SWORD = ITEMS.register("shulker_sword",
    ...
    public static final RegistrySupplier<Item> SHULKER_PICKAXE = ITEMS.register("shulker_pickaxe",
    ...
    public static final RegistrySupplier<Item> SHULKER_SHOVEL = ITEMS.register("shulker_shovel",
    ...
    public static final RegistrySupplier<Item> SHULKER_AXE = ITEMS.register("shulker_axe",
    ...
    public static final RegistrySupplier<Item> SHULKER_HOE = ITEMS.register("shulker_hoe",
    ...
    public static final RegistrySupplier<Item> SHULKER_HELMET = ITEMS.register("shulker_helmet",
            () -> new ArmorItem(ModArmorMaterials.SHULKER_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(18))));
    public static final RegistrySupplier<Item> SHULKER_CHESTPLATE = ITEMS.register("shulker_chestplate",
            () -> new ArmorItem(ModArmorMaterials.SHULKER_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(18))));
    public static final RegistrySupplier<Item> SHULKER_LEGGINGS = ITEMS.register("shulker_leggings",
            () -> new ArmorItem(ModArmorMaterials.SHULKER_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(18))));
    public static final RegistrySupplier<Item> SHULKER_BOOTS = ITEMS.register("shulker_boots",
            () -> new ArmorItem(ModArmorMaterials.SHULKER_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(18))));

    // ── Turtle Scute (armor only) ───────────────────────────────────────────
    public static final RegistrySupplier<Item> TURTLE_SCUTE_HELMET = ITEMS.register("turtle_scute_helmet",
            () -> new ArmorItem(ModArmorMaterials.TURTLE_SCUTE_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(20))));
    public static final RegistrySupplier<Item> TURTLE_SCUTE_CHESTPLATE = ITEMS.register("turtle_scute_chestplate",
            () -> new ArmorItem(ModArmorMaterials.TURTLE_SCUTE_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(20))));
    public static final RegistrySupplier<Item> TURTLE_SCUTE_LEGGINGS = ITEMS.register("turtle_scute_leggings",
            () -> new ArmorItem(ModArmorMaterials.TURTLE_SCUTE_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(20))));
    public static final RegistrySupplier<Item> TURTLE_SCUTE_BOOTS = ITEMS.register("turtle_scute_boots",
            () -> new ArmorItem(ModArmorMaterials.TURTLE_SCUTE_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(20))));

    // ── Echo Shard (tools + armor) ──────────────────────────────────────────
    public static final RegistrySupplier<Item> ECHO_SHARD_SWORD = ITEMS.register("echo_shard_sword",
    ...
    public static final RegistrySupplier<Item> ECHO_SHARD_PICKAXE = ITEMS.register("echo_shard_pickaxe",
    ...
    public static final RegistrySupplier<Item> ECHO_SHARD_SHOVEL = ITEMS.register("echo_shard_shovel",
    ...
    public static final RegistrySupplier<Item> ECHO_SHARD_AXE = ITEMS.register("echo_shard_axe",
    ...
    public static final RegistrySupplier<Item> ECHO_SHARD_HOE = ITEMS.register("echo_shard_hoe",
            () -> new HoeItem(ModToolTiers.ECHO_SHARD, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.ECHO_SHARD, 0, -3f))));
    public static final RegistrySupplier<Item> ECHO_SHARD_HELMET = ITEMS.register("echo_shard_helmet",
    ...
    public static final RegistrySupplier<Item> ECHO_SHARD_CHESTPLATE = ITEMS.register("echo_shard_chestplate",
    ...
    public static final RegistrySupplier<Item> ECHO_SHARD_LEGGINGS = ITEMS.register("echo_shard_leggings",
    ...
    public static final RegistrySupplier<Item> ECHO_SHARD_BOOTS = ITEMS.register("echo_shard_boots",
    ...
    public static final RegistrySupplier<Item> DRAGON_BREATH_SWORD = ITEMS.register("dragon_breath_sword",
    ...
    public static final RegistrySupplier<Item> DRAGON_BREATH_PICKAXE = ITEMS.register("dragon_breath_pickaxe",
    ...
    public static final RegistrySupplier<Item> DRAGON_BREATH_SHOVEL = ITEMS.register("dragon_breath_shovel",
    ...
    public static final RegistrySupplier<Item> DRAGON_BREATH_AXE = ITEMS.register("dragon_breath_axe",
    ...
    public static final RegistrySupplier<Item> DRAGON_BREATH_HOE = ITEMS.register("dragon_breath_hoe",
    ...
    public static final RegistrySupplier<Item> DRAGON_BREATH_HELMET = ITEMS.register("dragon_breath_helmet",
    ...
    public static final RegistrySupplier<Item> DRAGON_BREATH_CHESTPLATE = ITEMS.register("dragon_breath_chestplate",
    ...
    public static final RegistrySupplier<Item> DRAGON_BREATH_LEGGINGS = ITEMS.register("dragon_breath_leggings",
    ...
    public static final RegistrySupplier<Item> DRAGON_BREATH_BOOTS = ITEMS.register("dragon_breath_boots",
    ...
    // -------------------------------------------------------------------------
    public static final RegistrySupplier<Item> CAKE_SWORD = ITEMS.register("cake_sword",
    ...
    public static final RegistrySupplier<Item> CAKE_PICKAXE = ITEMS.register("cake_pickaxe",
    ...
    public static final RegistrySupplier<Item> CAKE_SHOVEL = ITEMS.register("cake_shovel",
    ...
    public static final RegistrySupplier<Item> CAKE_AXE = ITEMS.register("cake_axe",
            () -> new EdibleAxeItem(ModToolTiers.CAKE, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.CAKE, 6, -3.2f))
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));

    public static final RegistrySupplier<Item> CAKE_HOE = ITEMS.register("cake_hoe",
    ...
    // -------------------------------------------------------------------------
    public static final RegistrySupplier<Item> CAKE_HELMET = ITEMS.register("cake_helmet",
    ...
    public static final RegistrySupplier<Item> CAKE_CHESTPLATE = ITEMS.register("cake_chestplate",
    ...
    public static final RegistrySupplier<Item> CAKE_LEGGINGS = ITEMS.register("cake_leggings",
    ...
    public static final RegistrySupplier<Item> CAKE_BOOTS = ITEMS.register("cake_boots",
    ...
    // =========================================================================
    public static final RegistrySupplier<Item> BREAD_SWORD = ITEMS.register("bread_sword",
            () -> new EdibleSwordItem(ModToolTiers.BREAD, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> BREAD_PICKAXE = ITEMS.register("bread_pickaxe",
            () -> new EdiblePickaxeItem(ModToolTiers.BREAD, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> BREAD_SHOVEL = ITEMS.register("bread_shovel",
            () -> new EdibleShovelItem(ModToolTiers.BREAD, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> BREAD_AXE = ITEMS.register("bread_axe",
            () -> new EdibleAxeItem(ModToolTiers.BREAD, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.BREAD, 6, -3.2f))
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> BREAD_HOE = ITEMS.register("bread_hoe",
            () -> new EdibleHoeItem(ModToolTiers.BREAD, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.BREAD, 0, -3f))
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> BREAD_HELMET = ITEMS.register("bread_helmet",
            () -> new EdibleArmorItem(ModArmorMaterials.BREAD_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(3))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> BREAD_CHESTPLATE = ITEMS.register("bread_chestplate",
            () -> new EdibleArmorItem(ModArmorMaterials.BREAD_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(3))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> BREAD_LEGGINGS = ITEMS.register("bread_leggings",
            () -> new EdibleArmorItem(ModArmorMaterials.BREAD_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(3))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> BREAD_BOOTS = ITEMS.register("bread_boots",
    ...
    // =========================================================================
    public static final RegistrySupplier<Item> DRIED_KELP_SWORD = ITEMS.register("dried_kelp_sword",
            () -> new EdibleSwordItem(ModToolTiers.DRIED_KELP, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> DRIED_KELP_PICKAXE = ITEMS.register("dried_kelp_pickaxe",
            () -> new EdiblePickaxeItem(ModToolTiers.DRIED_KELP, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> DRIED_KELP_SHOVEL = ITEMS.register("dried_kelp_shovel",
            () -> new EdibleShovelItem(ModToolTiers.DRIED_KELP, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> DRIED_KELP_AXE = ITEMS.register("dried_kelp_axe",
            () -> new EdibleAxeItem(ModToolTiers.DRIED_KELP, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> DRIED_KELP_HOE = ITEMS.register("dried_kelp_hoe",
            () -> new EdibleHoeItem(ModToolTiers.DRIED_KELP, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> DRIED_KELP_HELMET = ITEMS.register("dried_kelp_helmet",
            () -> new EdibleArmorItem(ModArmorMaterials.DRIED_KELP_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(2))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> DRIED_KELP_CHESTPLATE = ITEMS.register("dried_kelp_chestplate",
            () -> new EdibleArmorItem(ModArmorMaterials.DRIED_KELP_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(2))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> DRIED_KELP_LEGGINGS = ITEMS.register("dried_kelp_leggings",
            () -> new EdibleArmorItem(ModArmorMaterials.DRIED_KELP_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(2))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> DRIED_KELP_BOOTS = ITEMS.register("dried_kelp_boots",
    ...
    // =========================================================================
    public static final RegistrySupplier<Item> ROTTEN_FLESH_SWORD = ITEMS.register("rotten_flesh_sword",
            () -> new EdibleSwordItem(ModToolTiers.ROTTEN_FLESH, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> ROTTEN_FLESH_PICKAXE = ITEMS.register("rotten_flesh_pickaxe",
            () -> new EdiblePickaxeItem(ModToolTiers.ROTTEN_FLESH, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> ROTTEN_FLESH_SHOVEL = ITEMS.register("rotten_flesh_shovel",
            () -> new EdibleShovelItem(ModToolTiers.ROTTEN_FLESH, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> ROTTEN_FLESH_AXE = ITEMS.register("rotten_flesh_axe",
            () -> new EdibleAxeItem(ModToolTiers.ROTTEN_FLESH, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> ROTTEN_FLESH_HOE = ITEMS.register("rotten_flesh_hoe",
            () -> new EdibleHoeItem(ModToolTiers.ROTTEN_FLESH, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> ROTTEN_FLESH_HELMET = ITEMS.register("rotten_flesh_helmet",
            () -> new EdibleArmorItem(ModArmorMaterials.ROTTEN_FLESH_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(2))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> ROTTEN_FLESH_CHESTPLATE = ITEMS.register("rotten_flesh_chestplate",
            () -> new EdibleArmorItem(ModArmorMaterials.ROTTEN_FLESH_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(2))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> ROTTEN_FLESH_LEGGINGS = ITEMS.register("rotten_flesh_leggings",
            () -> new EdibleArmorItem(ModArmorMaterials.ROTTEN_FLESH_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(2))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> ROTTEN_FLESH_BOOTS = ITEMS.register("rotten_flesh_boots",
    ...
    // =========================================================================
    public static final RegistrySupplier<Item> MELON_SWORD = ITEMS.register("melon_sword",
            () -> new EdibleSwordItem(ModToolTiers.MELON, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> MELON_PICKAXE = ITEMS.register("melon_pickaxe",
            () -> new EdiblePickaxeItem(ModToolTiers.MELON, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> MELON_SHOVEL = ITEMS.register("melon_shovel",
            () -> new EdibleShovelItem(ModToolTiers.MELON, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> MELON_AXE = ITEMS.register("melon_axe",
            () -> new EdibleAxeItem(ModToolTiers.MELON, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.MELON, 6, -3.2f))
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> MELON_HOE = ITEMS.register("melon_hoe",
            () -> new EdibleHoeItem(ModToolTiers.MELON, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.MELON, 0, -3f))
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> MELON_HELMET = ITEMS.register("melon_helmet",
            () -> new EdibleArmorItem(ModArmorMaterials.MELON_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(5))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> MELON_CHESTPLATE = ITEMS.register("melon_chestplate",
            () -> new EdibleArmorItem(ModArmorMaterials.MELON_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(5))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> MELON_LEGGINGS = ITEMS.register("melon_leggings",
            () -> new EdibleArmorItem(ModArmorMaterials.MELON_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(5))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> MELON_BOOTS = ITEMS.register("melon_boots",
    ...
    // =========================================================================
    public static final RegistrySupplier<Item> SWEET_BERRY_SWORD = ITEMS.register("sweet_berry_sword",
            () -> new EdibleSwordItem(ModToolTiers.SWEET_BERRIES, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> SWEET_BERRY_PICKAXE = ITEMS.register("sweet_berry_pickaxe",
            () -> new EdiblePickaxeItem(ModToolTiers.SWEET_BERRIES, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> SWEET_BERRY_SHOVEL = ITEMS.register("sweet_berry_shovel",
            () -> new EdibleShovelItem(ModToolTiers.SWEET_BERRIES, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> SWEET_BERRY_AXE = ITEMS.register("sweet_berry_axe",
            () -> new EdibleAxeItem(ModToolTiers.SWEET_BERRIES, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> SWEET_BERRY_HOE = ITEMS.register("sweet_berry_hoe",
            () -> new EdibleHoeItem(ModToolTiers.SWEET_BERRIES, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> SWEET_BERRY_HELMET = ITEMS.register("sweet_berry_helmet",
            () -> new EdibleArmorItem(ModArmorMaterials.SWEET_BERRY_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(4))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> SWEET_BERRY_CHESTPLATE = ITEMS.register("sweet_berry_chestplate",
            () -> new EdibleArmorItem(ModArmorMaterials.SWEET_BERRY_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(4))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> SWEET_BERRY_LEGGINGS = ITEMS.register("sweet_berry_leggings",
            () -> new EdibleArmorItem(ModArmorMaterials.SWEET_BERRY_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(4))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> SWEET_BERRY_BOOTS = ITEMS.register("sweet_berry_boots",
    ...
    // =========================================================================
    public static final RegistrySupplier<Item> PUMPKIN_PIE_SWORD = ITEMS.register("pumpkin_pie_sword",
            () -> new EdibleSwordItem(ModToolTiers.PUMPKIN_PIE, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> PUMPKIN_PIE_PICKAXE = ITEMS.register("pumpkin_pie_pickaxe",
            () -> new EdiblePickaxeItem(ModToolTiers.PUMPKIN_PIE, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> PUMPKIN_PIE_SHOVEL = ITEMS.register("pumpkin_pie_shovel",
            () -> new EdibleShovelItem(ModToolTiers.PUMPKIN_PIE, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> PUMPKIN_PIE_AXE = ITEMS.register("pumpkin_pie_axe",
            () -> new EdibleAxeItem(ModToolTiers.PUMPKIN_PIE, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> PUMPKIN_PIE_HOE = ITEMS.register("pumpkin_pie_hoe",
            () -> new EdibleHoeItem(ModToolTiers.PUMPKIN_PIE, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> PUMPKIN_PIE_HELMET = ITEMS.register("pumpkin_pie_helmet",
            () -> new EdibleArmorItem(ModArmorMaterials.PUMPKIN_PIE_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(4))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> PUMPKIN_PIE_CHESTPLATE = ITEMS.register("pumpkin_pie_chestplate",
            () -> new EdibleArmorItem(ModArmorMaterials.PUMPKIN_PIE_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(4))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> PUMPKIN_PIE_LEGGINGS = ITEMS.register("pumpkin_pie_leggings",
            () -> new EdibleArmorItem(ModArmorMaterials.PUMPKIN_PIE_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(4))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> PUMPKIN_PIE_BOOTS = ITEMS.register("pumpkin_pie_boots",
    ...
    // =========================================================================
    public static final RegistrySupplier<Item> MUSHROOM_SWORD = ITEMS.register("mushroom_sword",
            () -> new EdibleSwordItem(ModToolTiers.MUSHROOM, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> MUSHROOM_PICKAXE = ITEMS.register("mushroom_pickaxe",
            () -> new EdiblePickaxeItem(ModToolTiers.MUSHROOM, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> MUSHROOM_SHOVEL = ITEMS.register("mushroom_shovel",
            () -> new EdibleShovelItem(ModToolTiers.MUSHROOM, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> MUSHROOM_AXE = ITEMS.register("mushroom_axe",
            () -> new EdibleAxeItem(ModToolTiers.MUSHROOM, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> MUSHROOM_HOE = ITEMS.register("mushroom_hoe",
            () -> new EdibleHoeItem(ModToolTiers.MUSHROOM, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> MUSHROOM_HELMET = ITEMS.register("mushroom_helmet",
            () -> new EdibleArmorItem(ModArmorMaterials.MUSHROOM_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(8))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> MUSHROOM_CHESTPLATE = ITEMS.register("mushroom_chestplate",
            () -> new EdibleArmorItem(ModArmorMaterials.MUSHROOM_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(8))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> MUSHROOM_LEGGINGS = ITEMS.register("mushroom_leggings",
            () -> new EdibleArmorItem(ModArmorMaterials.MUSHROOM_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(8))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> MUSHROOM_BOOTS = ITEMS.register("mushroom_boots",
    ...
    // =========================================================================
    public static final RegistrySupplier<Item> PUFFERFISH_SWORD = ITEMS.register("pufferfish_sword",
            () -> new EdibleSwordItem(ModToolTiers.PUFFERFISH, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> PUFFERFISH_PICKAXE = ITEMS.register("pufferfish_pickaxe",
            () -> new EdiblePickaxeItem(ModToolTiers.PUFFERFISH, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> PUFFERFISH_SHOVEL = ITEMS.register("pufferfish_shovel",
            () -> new EdibleShovelItem(ModToolTiers.PUFFERFISH, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> PUFFERFISH_AXE = ITEMS.register("pufferfish_axe",
            () -> new EdibleAxeItem(ModToolTiers.PUFFERFISH, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> PUFFERFISH_HOE = ITEMS.register("pufferfish_hoe",
            () -> new EdibleHoeItem(ModToolTiers.PUFFERFISH, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> PUFFERFISH_HELMET = ITEMS.register("pufferfish_helmet",
            () -> new EdibleArmorItem(ModArmorMaterials.PUFFERFISH_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(6))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> PUFFERFISH_CHESTPLATE = ITEMS.register("pufferfish_chestplate",
            () -> new EdibleArmorItem(ModArmorMaterials.PUFFERFISH_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(6))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> PUFFERFISH_LEGGINGS = ITEMS.register("pufferfish_leggings",
            () -> new EdibleArmorItem(ModArmorMaterials.PUFFERFISH_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(6))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> PUFFERFISH_BOOTS = ITEMS.register("pufferfish_boots",
    ...
    // =========================================================================
    public static final RegistrySupplier<Item> HONEY_SWORD = ITEMS.register("honey_sword",
            () -> new EdibleSwordItem(ModToolTiers.HONEY, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> HONEY_PICKAXE = ITEMS.register("honey_pickaxe",
            () -> new EdiblePickaxeItem(ModToolTiers.HONEY, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> HONEY_SHOVEL = ITEMS.register("honey_shovel",
            () -> new EdibleShovelItem(ModToolTiers.HONEY, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> HONEY_AXE = ITEMS.register("honey_axe",
            () -> new EdibleAxeItem(ModToolTiers.HONEY, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.HONEY, 6, -3.2f))
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> HONEY_HOE = ITEMS.register("honey_hoe",
            () -> new EdibleHoeItem(ModToolTiers.HONEY, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.HONEY, 0, -3f))
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> HONEY_HELMET = ITEMS.register("honey_helmet",
            () -> new EdibleArmorItem(ModArmorMaterials.HONEY_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(10))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> HONEY_CHESTPLATE = ITEMS.register("honey_chestplate",
            () -> new EdibleArmorItem(ModArmorMaterials.HONEY_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(10))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> HONEY_LEGGINGS = ITEMS.register("honey_leggings",
            () -> new EdibleArmorItem(ModArmorMaterials.HONEY_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(10))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> HONEY_BOOTS = ITEMS.register("honey_boots",
    ...
    // =========================================================================
    public static final RegistrySupplier<Item> CHORUS_FRUIT_SWORD = ITEMS.register("chorus_fruit_sword",
            () -> new EdibleSwordItem(ModToolTiers.CHORUS_FRUIT, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> CHORUS_FRUIT_PICKAXE = ITEMS.register("chorus_fruit_pickaxe",
            () -> new EdiblePickaxeItem(ModToolTiers.CHORUS_FRUIT, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> CHORUS_FRUIT_SHOVEL = ITEMS.register("chorus_fruit_shovel",
            () -> new EdibleShovelItem(ModToolTiers.CHORUS_FRUIT, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> CHORUS_FRUIT_AXE = ITEMS.register("chorus_fruit_axe",
            () -> new EdibleAxeItem(ModToolTiers.CHORUS_FRUIT, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> CHORUS_FRUIT_HOE = ITEMS.register("chorus_fruit_hoe",
            () -> new EdibleHoeItem(ModToolTiers.CHORUS_FRUIT, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> CHORUS_FRUIT_HELMET = ITEMS.register("chorus_fruit_helmet",
            () -> new EdibleArmorItem(ModArmorMaterials.CHORUS_FRUIT_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(15))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> CHORUS_FRUIT_CHESTPLATE = ITEMS.register("chorus_fruit_chestplate",
            () -> new EdibleArmorItem(ModArmorMaterials.CHORUS_FRUIT_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(15))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> CHORUS_FRUIT_LEGGINGS = ITEMS.register("chorus_fruit_leggings",
            () -> new EdibleArmorItem(ModArmorMaterials.CHORUS_FRUIT_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(15))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> CHORUS_FRUIT_BOOTS = ITEMS.register("chorus_fruit_boots",
    ...
    // =========================================================================
    public static final RegistrySupplier<Item> GOLDEN_APPLE_SWORD = ITEMS.register("golden_apple_sword",
            () -> new EdibleSwordItem(ModToolTiers.GOLDEN_APPLE, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> GOLDEN_APPLE_PICKAXE = ITEMS.register("golden_apple_pickaxe",
            () -> new EdiblePickaxeItem(ModToolTiers.GOLDEN_APPLE, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> GOLDEN_APPLE_SHOVEL = ITEMS.register("golden_apple_shovel",
            () -> new EdibleShovelItem(ModToolTiers.GOLDEN_APPLE, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> GOLDEN_APPLE_AXE = ITEMS.register("golden_apple_axe",
            () -> new EdibleAxeItem(ModToolTiers.GOLDEN_APPLE, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> GOLDEN_APPLE_HOE = ITEMS.register("golden_apple_hoe",
            () -> new EdibleHoeItem(ModToolTiers.GOLDEN_APPLE, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> GOLDEN_APPLE_HELMET = ITEMS.register("golden_apple_helmet",
            () -> new EdibleArmorItem(ModArmorMaterials.GOLDEN_APPLE_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(18))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> GOLDEN_APPLE_CHESTPLATE = ITEMS.register("golden_apple_chestplate",
            () -> new EdibleArmorItem(ModArmorMaterials.GOLDEN_APPLE_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(18))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> GOLDEN_APPLE_LEGGINGS = ITEMS.register("golden_apple_leggings",
            () -> new EdibleArmorItem(ModArmorMaterials.GOLDEN_APPLE_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(18))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistrySupplier<Item> GOLDEN_APPLE_BOOTS = ITEMS.register("golden_apple_boots",
