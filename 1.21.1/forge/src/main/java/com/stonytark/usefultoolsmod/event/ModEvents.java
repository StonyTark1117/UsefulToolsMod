...
public class ModEvents {
    ...
    private static void spawnArmorAuraIfOp(Player player) {
        for (ItemStack armorStack : player.getArmorSlots()) {
            if (armorStack.getItem() instanceof ArmorItem armor) {
                if (ModArmorMaterials.OVERPOWER_ARMOR_MATERIAL.equals(armor.getMaterial())
    ...
    private static boolean isIceArmor(ItemStack stack) {
        ...
        return ModArmorMaterials.ICE_ARMOR_MATERIAL.equals(armor.getMaterial());
    }
    ...
    private static boolean isPprismArmor(ItemStack stack) {
        if (stack.isEmpty() || !(stack.getItem() instanceof ArmorItem armor)) return false;
        return ModArmorMaterials.PPRISM_ARMOR_MATERIAL.equals(armor.getMaterial());
    }
    ...
    private static boolean isOpArmor(ItemStack stack) {
        if (stack.isEmpty() || !(stack.getItem() instanceof ArmorItem armor)) return false;
        return ModArmorMaterials.OVERPOWER_ARMOR_MATERIAL.equals(armor.getMaterial());
    }

    private static boolean isFniArmor(ItemStack stack) {
        if (stack.isEmpty() || !(stack.getItem() instanceof ArmorItem armor)) return false;
        return ModArmorMaterials.FNI_ARMOR_MATERIAL.equals(armor.getMaterial());
    }

    private static boolean isEctoArmor(ItemStack stack) {
        if (stack.isEmpty() || !(stack.getItem() instanceof ArmorItem armor)) return false;
        return ModArmorMaterials.ECTO_ARMOR_MATERIAL.equals(armor.getMaterial());
    }
    ...
    private static boolean isFoodArmor(ItemStack stack) {
        ...
        for (Holder<ArmorMaterial> mat : getFoodArmorMaterials()) {
            if (mat.equals(armor.getMaterial())) return true;
        }
        return false;
    }
    ...
    private static boolean isCakeArmor(ItemStack stack) {
        if (stack.isEmpty() || !(stack.getItem() instanceof ArmorItem armor)) return false;
        return ModArmorMaterials.CAKE_ARMOR_MATERIAL.equals(armor.getMaterial());
    }
    ...
    private static boolean isBreadArmor(ItemStack s) {
        return !s.isEmpty() && s.getItem() instanceof ArmorItem a && ModArmorMaterials.BREAD_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isDriedKelpArmor(ItemStack s) {
        return !s.isEmpty() && s.getItem() instanceof ArmorItem a && ModArmorMaterials.DRIED_KELP_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isRottenFleshArmor(ItemStack s) {
        return !s.isEmpty() && s.getItem() instanceof ArmorItem a && ModArmorMaterials.ROTTEN_FLESH_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isMelonArmor(ItemStack s) {
        return !s.isEmpty() && s.getItem() instanceof ArmorItem a && ModArmorMaterials.MELON_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isSweetBerryArmor(ItemStack s) {
        return !s.isEmpty() && s.getItem() instanceof ArmorItem a && ModArmorMaterials.SWEET_BERRY_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isPumpkinPieArmor(ItemStack s) {
        return !s.isEmpty() && s.getItem() instanceof ArmorItem a && ModArmorMaterials.PUMPKIN_PIE_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isMushroomArmor(ItemStack s) {
        return !s.isEmpty() && s.getItem() instanceof ArmorItem a && ModArmorMaterials.MUSHROOM_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isPufferfishArmor(ItemStack s) {
        return !s.isEmpty() && s.getItem() instanceof ArmorItem a && ModArmorMaterials.PUFFERFISH_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isHoneyArmor(ItemStack s) {
        return !s.isEmpty() && s.getItem() instanceof ArmorItem a && ModArmorMaterials.HONEY_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isChorusFruitArmor(ItemStack s) {
        return !s.isEmpty() && s.getItem() instanceof ArmorItem a && ModArmorMaterials.CHORUS_FRUIT_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isGoldenAppleArmor(ItemStack s) {
        return !s.isEmpty() && s.getItem() instanceof ArmorItem a && ModArmorMaterials.GOLDEN_APPLE_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isCactusArmor(ItemStack s) {
        ...
        return ModArmorMaterials.CACTUS_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isBoneArmor(ItemStack s) {
        if (s.isEmpty() || !(s.getItem() instanceof ArmorItem a)) return false;
        return ModArmorMaterials.BONE_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    private static boolean isClayArmor(ItemStack s) {
        if (s.isEmpty() || !(s.getItem() instanceof ArmorItem a)) return false;
        return ModArmorMaterials.CLAY_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isNetherBrickArmor(ItemStack s) {
        if (s.isEmpty() || !(s.getItem() instanceof ArmorItem a)) return false;
        return ModArmorMaterials.NETHER_BRICK_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    private static boolean isCopperArmor(ItemStack s) {
        if (s.isEmpty() || !(s.getItem() instanceof ArmorItem a)) return false;
        return ModArmorMaterials.COPPER_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isPhantomArmor(ItemStack s) {
        if (s.isEmpty() || !(s.getItem() instanceof ArmorItem a)) return false;
        return ModArmorMaterials.PHANTOM_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isMagmaCreamArmor(ItemStack s) {
        if (s.isEmpty() || !(s.getItem() instanceof ArmorItem a)) return false;
        return ModArmorMaterials.MAGMA_CREAM_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isSlimeArmor(ItemStack s) {
        if (s.isEmpty() || !(s.getItem() instanceof ArmorItem a)) return false;
        return ModArmorMaterials.SLIME_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isBlazeArmor(ItemStack s) {
        if (s.isEmpty() || !(s.getItem() instanceof ArmorItem a)) return false;
        return ModArmorMaterials.BLAZE_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isNautilusArmor(ItemStack s) {
        if (s.isEmpty() || !(s.getItem() instanceof ArmorItem a)) return false;
        return ModArmorMaterials.NAUTILUS_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isPurpurArmor(ItemStack s) {
        if (s.isEmpty() || !(s.getItem() instanceof ArmorItem a)) return false;
        return ModArmorMaterials.PURPUR_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isGhastTearArmor(ItemStack s) {
        if (s.isEmpty() || !(s.getItem() instanceof ArmorItem a)) return false;
        return ModArmorMaterials.GHAST_TEAR_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isEyeOfEnderArmor(ItemStack s) {
        if (s.isEmpty() || !(s.getItem() instanceof ArmorItem a)) return false;
        return ModArmorMaterials.EYE_OF_ENDER_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isShulkerArmor(ItemStack s) {
        if (s.isEmpty() || !(s.getItem() instanceof ArmorItem a)) return false;
        return ModArmorMaterials.SHULKER_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    private static boolean isTurtleScuteArmor(ItemStack s) {
        if (s.isEmpty() || !(s.getItem() instanceof ArmorItem a)) return false;
        return ModArmorMaterials.TURTLE_SCUTE_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isEchoShardArmor(ItemStack s) {
        if (s.isEmpty() || !(s.getItem() instanceof ArmorItem a)) return false;
        return ModArmorMaterials.ECHO_SHARD_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    ...
    private static boolean isDragonBreathArmor(ItemStack s) {
        if (s.isEmpty() || !(s.getItem() instanceof ArmorItem a)) return false;
        return ModArmorMaterials.DRAGON_BREATH_ARMOR_MATERIAL.equals(a.getMaterial());
    }
    private static boolean isRabbitHideArmor(ItemStack s) {
        if (s.isEmpty() || !(s.getItem() instanceof ArmorItem a)) return false;
        return ModArmorMaterials.RABBIT_HIDE_ARMOR_MATERIAL.equals(a.getMaterial());
    }
