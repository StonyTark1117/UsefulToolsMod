...
public class ModItems {
    ...
    public static final RegistryObject<Item> RGOLD = ITEMS.register(GeneratedRegistrationIds.Items.RGOLD,
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistryObject<Item> RAW_RGOLD = ITEMS.register(GeneratedRegistrationIds.Items.RAW_RGOLD,
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistryObject<Item> OBSHARD = ITEMS.register(GeneratedRegistrationIds.Items.OBSHARD,
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistryObject<Item> SEM = ITEMS.register(GeneratedRegistrationIds.Items.SEM,
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistryObject<Item> OBINGOT = ITEMS.register(GeneratedRegistrationIds.Items.OBINGOT,
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistryObject<Item> GRENADE = ITEMS.register(GeneratedRegistrationIds.Items.GRENADE,
            () -> new Grenade(new Item.Properties().stacksTo(16)));

    public static final RegistryObject<Item> HRED = ITEMS.register(GeneratedRegistrationIds.Items.HRED,
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistryObject<Item> HGLOW = ITEMS.register(GeneratedRegistrationIds.Items.HGLOW,
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistryObject<Item> RLAPIS = ITEMS.register(GeneratedRegistrationIds.Items.RLAPIS,
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistryObject<Item> DYNAMITE = ITEMS.register(GeneratedRegistrationIds.Items.DYNAMITE,
    ...
    public static final RegistryObject<Item> WRAITH_SPAWN_EGG = ITEMS.register(GeneratedRegistrationIds.Items.WRAITH_SPAWN_EGG,
            () -> new ForgeSpawnEggItem(ModEntities.WRAITH, 0x172132, 0x59d7cf, new Item.Properties()));
    ...
    public static final RegistryObject<Item> REMERALD_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.REMERALD_SWORD,
    ...
    public static final RegistryObject<Item> REMERALD_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.REMERALD_PICKAXE,
    ...
    public static final RegistryObject<Item> REMERALD_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.REMERALD_SHOVEL,
    ...
    public static final RegistryObject<Item> REMERALD_AXE = ITEMS.register(GeneratedRegistrationIds.Items.REMERALD_AXE,
            () -> new AxeItem(ModToolTiers.REMERALD, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.REMERALD, 6, -3.2f))));
    public static final RegistryObject<Item> REMERALD_HOE = ITEMS.register(GeneratedRegistrationIds.Items.REMERALD_HOE,
            () -> new HoeItem(ModToolTiers.REMERALD, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.REMERALD, 0, -3f))));

    public static final RegistryObject<Item> PEMERALD_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.PEMERALD_SWORD,
    ...
    public static final RegistryObject<Item> PEMERALD_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.PEMERALD_PICKAXE,
    ...
    public static final RegistryObject<Item> PEMERALD_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.PEMERALD_SHOVEL,
    ...
    public static final RegistryObject<Item> PEMERALD_AXE = ITEMS.register(GeneratedRegistrationIds.Items.PEMERALD_AXE,
            () -> new AxeItem(ModToolTiers.PEMERALD, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.PEMERALD, 6, -3.2f))));
    public static final RegistryObject<Item> PEMERALD_HOE = ITEMS.register(GeneratedRegistrationIds.Items.PEMERALD_HOE,
            () -> new HoeItem(ModToolTiers.PEMERALD, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.PEMERALD, 0, -3f))));

    public static final RegistryObject<Item> ROBSIDIAN_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.ROBSIDIAN_SWORD,
    ...
    public static final RegistryObject<Item> ROBSIDIAN_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.ROBSIDIAN_PICKAXE,
    ...
    public static final RegistryObject<Item> ROBSIDIAN_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.ROBSIDIAN_SHOVEL,
    ...
    public static final RegistryObject<Item> ROBSIDIAN_AXE = ITEMS.register(GeneratedRegistrationIds.Items.ROBSIDIAN_AXE,
            () -> new AxeItem(ModToolTiers.ROBSIDIAN, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.ROBSIDIAN, 6, -3.2f))));
    public static final RegistryObject<Item> ROBSIDIAN_HOE = ITEMS.register(GeneratedRegistrationIds.Items.ROBSIDIAN_HOE,
            () -> new HoeItem(ModToolTiers.ROBSIDIAN, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.ROBSIDIAN, 0, -3f))));

    public static final RegistryObject<Item> POBSIDIAN_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.POBSIDIAN_SWORD,
    ...
    public static final RegistryObject<Item> POBSIDIAN_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.POBSIDIAN_PICKAXE,
    ...
    public static final RegistryObject<Item> POBSIDIAN_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.POBSIDIAN_SHOVEL,
    ...
    public static final RegistryObject<Item> POBSIDIAN_AXE = ITEMS.register(GeneratedRegistrationIds.Items.POBSIDIAN_AXE,
            () -> new AxeItem(ModToolTiers.POBSIDIAN, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.POBSIDIAN, 6, -3.2f))));
    public static final RegistryObject<Item> POBSIDIAN_HOE = ITEMS.register(GeneratedRegistrationIds.Items.POBSIDIAN_HOE,
            () -> new HoeItem(ModToolTiers.POBSIDIAN, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.POBSIDIAN, 0, -3f))));

    public static final RegistryObject<Item> OVERPOWER_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.OVERPOWER_SWORD,
    ...
    public static final RegistryObject<Item> OVERPOWER_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.OVERPOWER_PICKAXE,
    ...
    public static final RegistryObject<Item> OVERPOWER_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.OVERPOWER_SHOVEL,
    ...
    public static final RegistryObject<Item> OVERPOWER_AXE = ITEMS.register(GeneratedRegistrationIds.Items.OVERPOWER_AXE,
            () -> new AxeItem(ModToolTiers.OVERPOWER, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.OVERPOWER, 6, -3.2f))));


    public static final RegistryObject<Item> HREDSTONE_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.HREDSTONE_SWORD,
    ...
    public static final RegistryObject<Item> HREDSTONE_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.HREDSTONE_PICKAXE,
    ...
    public static final RegistryObject<Item> HREDSTONE_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.HREDSTONE_SHOVEL,
    ...
    public static final RegistryObject<Item> HREDSTONE_AXE = ITEMS.register(GeneratedRegistrationIds.Items.HREDSTONE_AXE,
            () -> new AxeItem(ModToolTiers.HREDSTONE, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.HREDSTONE, 6, -3.2f))));
    public static final RegistryObject<Item> HREDSTONE_HOE = ITEMS.register(GeneratedRegistrationIds.Items.HREDSTONE_HOE,
            () -> new HoeItem(ModToolTiers.HREDSTONE, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.HREDSTONE, 0, -3f))));

    public static final RegistryObject<Item> HGLOWSTONE_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.HGLOWSTONE_SWORD,
    ...
    public static final RegistryObject<Item> HGLOWSTONE_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.HGLOWSTONE_PICKAXE,
    ...
    public static final RegistryObject<Item> HGLOWSTONE_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.HGLOWSTONE_SHOVEL,
    ...
    public static final RegistryObject<Item> HGLOWSTONE_AXE = ITEMS.register(GeneratedRegistrationIds.Items.HGLOWSTONE_AXE,
    ...
    public static final RegistryObject<Item> HGLOWSTONE_HOE = ITEMS.register(GeneratedRegistrationIds.Items.HGLOWSTONE_HOE,
            () -> new HoeItem(ModToolTiers.HGLOWSTONE, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.HGLOWSTONE, 0, -3f))));

    public static final RegistryObject<Item> RGOLD_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.RGOLD_SWORD,
            () -> new SwordItem(ModToolTiers.RGOLD, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.RGOLD, 3, -2.4f))));
    public static final RegistryObject<Item> RGOLD_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.RGOLD_PICKAXE,
            () -> new PickaxeItem(ModToolTiers.RGOLD, new Item.Properties()
                    .attributes(PickaxeItem.createAttributes(ModToolTiers.RGOLD, 1, -2.8f))));
    public static final RegistryObject<Item> RGOLD_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.RGOLD_SHOVEL,
            () -> new ShovelItem(ModToolTiers.RGOLD, new Item.Properties()
                    .attributes(ShovelItem.createAttributes(ModToolTiers.RGOLD, 1.5f, -3f))));
    public static final RegistryObject<Item> RGOLD_AXE = ITEMS.register(GeneratedRegistrationIds.Items.RGOLD_AXE,
            () -> new AxeItem(ModToolTiers.RGOLD, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.RGOLD, 6, -3.2f))));
    public static final RegistryObject<Item> RGOLD_HOE = ITEMS.register(GeneratedRegistrationIds.Items.RGOLD_HOE,
            () -> new HoeItem(ModToolTiers.RGOLD, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.RGOLD, 0, -3f))));

    public static final RegistryObject<Item> RLAPIS_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.RLAPIS_SWORD,
            () -> new SwordItem(ModToolTiers.RLAPIS, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.RLAPIS, 3, -2.4f))));
    public static final RegistryObject<Item> RLAPIS_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.RLAPIS_PICKAXE,
    ...
    public static final RegistryObject<Item> RLAPIS_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.RLAPIS_SHOVEL,
            () -> new ShovelItem(ModToolTiers.RLAPIS, new Item.Properties()
                    .attributes(ShovelItem.createAttributes(ModToolTiers.RLAPIS, 1.5f, -3f))));
    public static final RegistryObject<Item> RLAPIS_AXE = ITEMS.register(GeneratedRegistrationIds.Items.RLAPIS_AXE,
            () -> new AxeItem(ModToolTiers.RLAPIS, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.RLAPIS, 6, -3.2f))));
    public static final RegistryObject<Item> RLAPIS_HOE = ITEMS.register(GeneratedRegistrationIds.Items.RLAPIS_HOE,
            () -> new HoeItem(ModToolTiers.RLAPIS, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.RLAPIS, 0, -3f))));

    public static final RegistryObject<Item> EMERALD_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.EMERALD_HELMET,
    ...
    public static final RegistryObject<Item> EMERALD_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.EMERALD_CHESTPLATE,
    ...
    public static final RegistryObject<Item> EMERALD_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.EMERALD_LEGGINGS,
    ...
    public static final RegistryObject<Item> EMERALD_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.EMERALD_BOOTS,
    ...
    public static final RegistryObject<Item> HRED_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.HRED_HELMET,
    ...
    public static final RegistryObject<Item> HRED_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.HRED_CHESTPLATE,
    ...
    public static final RegistryObject<Item> HRED_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.HRED_LEGGINGS,
    ...
    public static final RegistryObject<Item> HRED_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.HRED_BOOTS,
    ...
    public static final RegistryObject<Item> HGLOW_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.HGLOW_HELMET,
            () -> new ArmorItem(ModArmorMaterials.HGLOW_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(18))));
    public static final RegistryObject<Item> HGLOW_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.HGLOW_CHESTPLATE,
            () -> new ArmorItem(ModArmorMaterials.HGLOW_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(18))));
    public static final RegistryObject<Item> HGLOW_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.HGLOW_LEGGINGS,
            () -> new ArmorItem(ModArmorMaterials.HGLOW_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(18))));
    public static final RegistryObject<Item> HGLOW_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.HGLOW_BOOTS,
            () -> new ArmorItem(ModArmorMaterials.HGLOW_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(18))));

    public static final RegistryObject<Item> OBSIDIAN_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.OBSIDIAN_HELMET,
    ...
    public static final RegistryObject<Item> OBSIDIAN_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.OBSIDIAN_CHESTPLATE,
    ...
    public static final RegistryObject<Item> OBSIDIAN_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.OBSIDIAN_LEGGINGS,
    ...
    public static final RegistryObject<Item> OBSIDIAN_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.OBSIDIAN_BOOTS,
    ...
    public static final RegistryObject<Item> RGOLD_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.RGOLD_HELMET,
            () -> new ArmorItem(ModArmorMaterials.RGOLD_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(18))));
    public static final RegistryObject<Item> RGOLD_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.RGOLD_CHESTPLATE,
            () -> new ArmorItem(ModArmorMaterials.RGOLD_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(18))));
    public static final RegistryObject<Item> RGOLD_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.RGOLD_LEGGINGS,
            () -> new ArmorItem(ModArmorMaterials.RGOLD_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(18))));
    public static final RegistryObject<Item> RGOLD_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.RGOLD_BOOTS,
            () -> new ArmorItem(ModArmorMaterials.RGOLD_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(18))));

    public static final RegistryObject<Item> RLAPIS_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.RLAPIS_HELMET,
    ...
    public static final RegistryObject<Item> RLAPIS_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.RLAPIS_CHESTPLATE,
    ...
    public static final RegistryObject<Item> RLAPIS_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.RLAPIS_LEGGINGS,
    ...
    public static final RegistryObject<Item> RLAPIS_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.RLAPIS_BOOTS,
    ...
    public static final RegistryObject<Item> OVERPOWER_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.OVERPOWER_HELMET,
    ...
    public static final RegistryObject<Item> OVERPOWER_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.OVERPOWER_CHESTPLATE,
    ...
    public static final RegistryObject<Item> OVERPOWER_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.OVERPOWER_LEGGINGS,
    ...
    public static final RegistryObject<Item> OVERPOWER_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.OVERPOWER_BOOTS,
    ...
    public static final RegistryObject<Item> GHOST_SPAWN_EGG = ITEMS.register(GeneratedRegistrationIds.Items.GHOST_SPAWN_EGG,
    ...
    // -------------------------------------------------------------------------
    public static final RegistryObject<Item> RECTO_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.RECTO_SWORD,
            () -> new EctoSwordItem(ModToolTiers.RECTO, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.RECTO, 3, -2.4f))));

    public static final RegistryObject<Item> RECTO_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.RECTO_PICKAXE,
    ...
    public static final RegistryObject<Item> RECTO_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.RECTO_SHOVEL,
    ...
    public static final RegistryObject<Item> RECTO_AXE = ITEMS.register(GeneratedRegistrationIds.Items.RECTO_AXE,
            () -> new EctoAxeItem(ModToolTiers.RECTO, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.RECTO, 6, -3.2f))));

    public static final RegistryObject<Item> RECTO_HOE = ITEMS.register(GeneratedRegistrationIds.Items.RECTO_HOE,
    ...
    // -------------------------------------------------------------------------
    public static final RegistryObject<Item> REFINED_ECTOPLASM = ITEMS.register(GeneratedRegistrationIds.Items.REFINED_ECTOPLASM,
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistryObject<Item> ECTO_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.ECTO_SWORD,
    ...
    public static final RegistryObject<Item> ECTO_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.ECTO_PICKAXE,
    ...
    public static final RegistryObject<Item> ECTO_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.ECTO_SHOVEL,
    ...
    public static final RegistryObject<Item> ECTO_AXE = ITEMS.register(GeneratedRegistrationIds.Items.ECTO_AXE,
    ...
    public static final RegistryObject<Item> ECTO_HOE = ITEMS.register(GeneratedRegistrationIds.Items.ECTO_HOE,
    ...
    public static final RegistryObject<Item> ECTO_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.ECTO_HELMET,
    ...
    public static final RegistryObject<Item> ECTO_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.ECTO_CHESTPLATE,
    ...
    public static final RegistryObject<Item> ECTO_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.ECTO_LEGGINGS,
    ...
    public static final RegistryObject<Item> ECTO_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.ECTO_BOOTS,
    ...
    // Coal material items
    // -------------------------------------------------------------------------
    public static final RegistryObject<Item> COAL_DUST = ITEMS.register(GeneratedRegistrationIds.Items.COAL_DUST,
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistryObject<Item> HARDENED_COAL = ITEMS.register(GeneratedRegistrationIds.Items.HARDENED_COAL,
            () -> new Item(new Item.Properties().stacksTo(64)));

    // -------------------------------------------------------------------------
    // Coal tools  (wood mining level, durability ~120, flammable)
    // -------------------------------------------------------------------------
    public static final RegistryObject<Item> COAL_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.COAL_SWORD,
    ...
    public static final RegistryObject<Item> COAL_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.COAL_PICKAXE,
    ...
    public static final RegistryObject<Item> COAL_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.COAL_SHOVEL,
    ...
    public static final RegistryObject<Item> COAL_AXE = ITEMS.register(GeneratedRegistrationIds.Items.COAL_AXE,
    ...
    public static final RegistryObject<Item> COAL_HOE = ITEMS.register(GeneratedRegistrationIds.Items.COAL_HOE,
    ...
    // -------------------------------------------------------------------------
    public static final RegistryObject<Item> COAL_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.COAL_HELMET,
    ...
    public static final RegistryObject<Item> COAL_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.COAL_CHESTPLATE,
    ...
    public static final RegistryObject<Item> COAL_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.COAL_LEGGINGS,
    ...
    public static final RegistryObject<Item> COAL_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.COAL_BOOTS,
    ...
    public static final RegistryObject<Item> RRAW_GOLD_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.RRAW_GOLD_SWORD,
    ...
    public static final RegistryObject<Item> RRAW_GOLD_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.RRAW_GOLD_PICKAXE,
    ...
    public static final RegistryObject<Item> RRAW_GOLD_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.RRAW_GOLD_SHOVEL,
    ...
    public static final RegistryObject<Item> RRAW_GOLD_AXE = ITEMS.register(GeneratedRegistrationIds.Items.RRAW_GOLD_AXE,
            () -> new AxeItem(ModToolTiers.RRAW_GOLD, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.RRAW_GOLD, 6, -3.2f))));
    public static final RegistryObject<Item> RRAW_GOLD_HOE = ITEMS.register(GeneratedRegistrationIds.Items.RRAW_GOLD_HOE,
    ...
    public static final RegistryObject<Item> RRAW_COPPER_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.RRAW_COPPER_SWORD,
    ...
    public static final RegistryObject<Item> RRAW_COPPER_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.RRAW_COPPER_PICKAXE,
    ...
    public static final RegistryObject<Item> RRAW_COPPER_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.RRAW_COPPER_SHOVEL,
    ...
    public static final RegistryObject<Item> RRAW_COPPER_AXE = ITEMS.register(GeneratedRegistrationIds.Items.RRAW_COPPER_AXE,
    ...
    public static final RegistryObject<Item> RRAW_COPPER_HOE = ITEMS.register(GeneratedRegistrationIds.Items.RRAW_COPPER_HOE,
    ...
    public static final RegistryObject<Item> RRAW_IRON_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.RRAW_IRON_SWORD,
    ...
    public static final RegistryObject<Item> RRAW_IRON_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.RRAW_IRON_PICKAXE,
    ...
    public static final RegistryObject<Item> RRAW_IRON_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.RRAW_IRON_SHOVEL,
    ...
    public static final RegistryObject<Item> RRAW_IRON_AXE = ITEMS.register(GeneratedRegistrationIds.Items.RRAW_IRON_AXE,
            () -> new AxeItem(ModToolTiers.RRAW_IRON, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.RRAW_IRON, 6, -3.2f))));
    public static final RegistryObject<Item> RRAW_IRON_HOE = ITEMS.register(GeneratedRegistrationIds.Items.RRAW_IRON_HOE,
    ...
    public static final RegistryObject<Item> RRAW_RGOLD_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.RRAW_RGOLD_SWORD,
    ...
    public static final RegistryObject<Item> RRAW_RGOLD_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.RRAW_RGOLD_PICKAXE,
    ...
    public static final RegistryObject<Item> RRAW_RGOLD_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.RRAW_RGOLD_SHOVEL,
    ...
    public static final RegistryObject<Item> RRAW_RGOLD_AXE = ITEMS.register(GeneratedRegistrationIds.Items.RRAW_RGOLD_AXE,
    ...
    public static final RegistryObject<Item> RRAW_RGOLD_HOE = ITEMS.register(GeneratedRegistrationIds.Items.RRAW_RGOLD_HOE,
    ...
    public static final RegistryObject<Item> RSCRAP_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.RSCRAP_SWORD,
            () -> new SwordItem(ModToolTiers.RSCRAP, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.RSCRAP, 3, -2.4f))));
    public static final RegistryObject<Item> RSCRAP_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.RSCRAP_PICKAXE,
    ...
    public static final RegistryObject<Item> RSCRAP_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.RSCRAP_SHOVEL,
            () -> new ShovelItem(ModToolTiers.RSCRAP, new Item.Properties()
                    .attributes(ShovelItem.createAttributes(ModToolTiers.RSCRAP, 1.5f, -3f))));
    public static final RegistryObject<Item> RSCRAP_AXE = ITEMS.register(GeneratedRegistrationIds.Items.RSCRAP_AXE,
            () -> new AxeItem(ModToolTiers.RSCRAP, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.RSCRAP, 6, -3.2f))));
    public static final RegistryObject<Item> RSCRAP_HOE = ITEMS.register(GeneratedRegistrationIds.Items.RSCRAP_HOE,
    ...
    public static final RegistryObject<Item> CALCIFIED_AMETHYST = ITEMS.register(GeneratedRegistrationIds.Items.CALCIFIED_AMETHYST,
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistryObject<Item> GLACIAL_SHARD = ITEMS.register(GeneratedRegistrationIds.Items.GLACIAL_SHARD,
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistryObject<Item> POLISHED_QUARTZ = ITEMS.register(GeneratedRegistrationIds.Items.POLISHED_QUARTZ,
            () -> new Item(new Item.Properties().stacksTo(64)));

    public static final RegistryObject<Item> POLISHED_PRISMARINE = ITEMS.register(GeneratedRegistrationIds.Items.POLISHED_PRISMARINE,
            () -> new Item(new Item.Properties().stacksTo(64)));

    // -------------------------------------------------------------------------
    // Rough Amethyst tools (iron mining level)
    // -------------------------------------------------------------------------
    public static final RegistryObject<Item> RAMETHYST_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.RAMETHYST_SWORD,
    ...
    public static final RegistryObject<Item> RAMETHYST_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.RAMETHYST_PICKAXE,
    ...
    public static final RegistryObject<Item> RAMETHYST_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.RAMETHYST_SHOVEL,
    ...
    public static final RegistryObject<Item> RAMETHYST_AXE = ITEMS.register(GeneratedRegistrationIds.Items.RAMETHYST_AXE,
            () -> new AxeItem(ModToolTiers.RAMETHYST, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.RAMETHYST, 6, -3.2f))));
    public static final RegistryObject<Item> RAMETHYST_HOE = ITEMS.register(GeneratedRegistrationIds.Items.RAMETHYST_HOE,
    ...
    // -------------------------------------------------------------------------
    public static final RegistryObject<Item> SNOW_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.SNOW_SWORD,
    ...
    public static final RegistryObject<Item> SNOW_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.SNOW_PICKAXE,
    ...
    public static final RegistryObject<Item> SNOW_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.SNOW_SHOVEL,
    ...
    public static final RegistryObject<Item> SNOW_AXE = ITEMS.register(GeneratedRegistrationIds.Items.SNOW_AXE,
            () -> new AxeItem(ModToolTiers.SNOW_TOOL, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.SNOW_TOOL, 6, -3.2f))));
    public static final RegistryObject<Item> SNOW_HOE = ITEMS.register(GeneratedRegistrationIds.Items.SNOW_HOE,
    ...
    // -------------------------------------------------------------------------
    public static final RegistryObject<Item> RQUARTZ_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.RQUARTZ_SWORD,
            () -> new SwordItem(ModToolTiers.RQUARTZ, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.RQUARTZ, 3, -2.4f))));
    public static final RegistryObject<Item> RQUARTZ_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.RQUARTZ_PICKAXE,
    ...
    public static final RegistryObject<Item> RQUARTZ_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.RQUARTZ_SHOVEL,
    ...
    public static final RegistryObject<Item> RQUARTZ_AXE = ITEMS.register(GeneratedRegistrationIds.Items.RQUARTZ_AXE,
            () -> new AxeItem(ModToolTiers.RQUARTZ, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.RQUARTZ, 6, -3.2f))));
    public static final RegistryObject<Item> RQUARTZ_HOE = ITEMS.register(GeneratedRegistrationIds.Items.RQUARTZ_HOE,
    ...
    // -------------------------------------------------------------------------
    public static final RegistryObject<Item> RPRISM_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.RPRISM_SWORD,
            () -> new SwordItem(ModToolTiers.RPRISM, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.RPRISM, 3, -2.4f))));
    public static final RegistryObject<Item> RPRISM_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.RPRISM_PICKAXE,
    ...
    public static final RegistryObject<Item> RPRISM_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.RPRISM_SHOVEL,
            () -> new ShovelItem(ModToolTiers.RPRISM, new Item.Properties()
                    .attributes(ShovelItem.createAttributes(ModToolTiers.RPRISM, 1.5f, -3f))));
    public static final RegistryObject<Item> RPRISM_AXE = ITEMS.register(GeneratedRegistrationIds.Items.RPRISM_AXE,
            () -> new AxeItem(ModToolTiers.RPRISM, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.RPRISM, 6, -3.2f))));
    public static final RegistryObject<Item> RPRISM_HOE = ITEMS.register(GeneratedRegistrationIds.Items.RPRISM_HOE,
    ...
    // -------------------------------------------------------------------------
    public static final RegistryObject<Item> CAMETHYST_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.CAMETHYST_SWORD,
    ...
    public static final RegistryObject<Item> CAMETHYST_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.CAMETHYST_PICKAXE,
    ...
    public static final RegistryObject<Item> CAMETHYST_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.CAMETHYST_SHOVEL,
    ...
    public static final RegistryObject<Item> CAMETHYST_AXE = ITEMS.register(GeneratedRegistrationIds.Items.CAMETHYST_AXE,
            () -> new AxeItem(ModToolTiers.CAMETHYST, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.CAMETHYST, 6, -3.2f))));
    public static final RegistryObject<Item> CAMETHYST_HOE = ITEMS.register(GeneratedRegistrationIds.Items.CAMETHYST_HOE,
            () -> new HoeItem(ModToolTiers.CAMETHYST, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.CAMETHYST, 0, -3f))));
    public static final RegistryObject<Item> CAMETHYST_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.CAMETHYST_HELMET,
            () -> new ArmorItem(ModArmorMaterials.CAMETHYST_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(15))));
    public static final RegistryObject<Item> CAMETHYST_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.CAMETHYST_CHESTPLATE,
            () -> new ArmorItem(ModArmorMaterials.CAMETHYST_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(15))));
    public static final RegistryObject<Item> CAMETHYST_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.CAMETHYST_LEGGINGS,
            () -> new ArmorItem(ModArmorMaterials.CAMETHYST_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(15))));
    public static final RegistryObject<Item> CAMETHYST_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.CAMETHYST_BOOTS,
    ...
    // -------------------------------------------------------------------------
    public static final RegistryObject<Item> ICE_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.ICE_SWORD,
    ...
    public static final RegistryObject<Item> ICE_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.ICE_PICKAXE,
    ...
    public static final RegistryObject<Item> ICE_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.ICE_SHOVEL,
    ...
    public static final RegistryObject<Item> ICE_AXE = ITEMS.register(GeneratedRegistrationIds.Items.ICE_AXE,
            () -> new AxeItem(ModToolTiers.ICE_TOOL, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.ICE_TOOL, 6, -3.2f))));
    public static final RegistryObject<Item> ICE_HOE = ITEMS.register(GeneratedRegistrationIds.Items.ICE_HOE,
            () -> new HoeItem(ModToolTiers.ICE_TOOL, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.ICE_TOOL, 0, -3f))));
    public static final RegistryObject<Item> ICE_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.ICE_HELMET,
    ...
    public static final RegistryObject<Item> ICE_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.ICE_CHESTPLATE,
    ...
    public static final RegistryObject<Item> ICE_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.ICE_LEGGINGS,
    ...
    public static final RegistryObject<Item> ICE_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.ICE_BOOTS,
    ...
    // -------------------------------------------------------------------------
    public static final RegistryObject<Item> PQUARTZ_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.PQUARTZ_SWORD,
            () -> new SwordItem(ModToolTiers.PQUARTZ, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.PQUARTZ, 3, -2.4f))));
    public static final RegistryObject<Item> PQUARTZ_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.PQUARTZ_PICKAXE,
    ...
    public static final RegistryObject<Item> PQUARTZ_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.PQUARTZ_SHOVEL,
    ...
    public static final RegistryObject<Item> PQUARTZ_AXE = ITEMS.register(GeneratedRegistrationIds.Items.PQUARTZ_AXE,
            () -> new AxeItem(ModToolTiers.PQUARTZ, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.PQUARTZ, 6, -3.2f))));
    public static final RegistryObject<Item> PQUARTZ_HOE = ITEMS.register(GeneratedRegistrationIds.Items.PQUARTZ_HOE,
            () -> new HoeItem(ModToolTiers.PQUARTZ, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.PQUARTZ, 0, -3f))));
    public static final RegistryObject<Item> PQUARTZ_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.PQUARTZ_HELMET,
            () -> new ArmorItem(ModArmorMaterials.PQUARTZ_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(16))));
    public static final RegistryObject<Item> PQUARTZ_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.PQUARTZ_CHESTPLATE,
            () -> new ArmorItem(ModArmorMaterials.PQUARTZ_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(16))));
    public static final RegistryObject<Item> PQUARTZ_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.PQUARTZ_LEGGINGS,
            () -> new ArmorItem(ModArmorMaterials.PQUARTZ_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(16))));
    public static final RegistryObject<Item> PQUARTZ_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.PQUARTZ_BOOTS,
    ...
    // -------------------------------------------------------------------------
    public static final RegistryObject<Item> PPRISM_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.PPRISM_SWORD,
            () -> new SwordItem(ModToolTiers.PPRISM, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.PPRISM, 3, -2.4f))));
    public static final RegistryObject<Item> PPRISM_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.PPRISM_PICKAXE,
    ...
    public static final RegistryObject<Item> PPRISM_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.PPRISM_SHOVEL,
            () -> new ShovelItem(ModToolTiers.PPRISM, new Item.Properties()
                    .attributes(ShovelItem.createAttributes(ModToolTiers.PPRISM, 1.5f, -3f))));
    public static final RegistryObject<Item> PPRISM_AXE = ITEMS.register(GeneratedRegistrationIds.Items.PPRISM_AXE,
            () -> new AxeItem(ModToolTiers.PPRISM, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.PPRISM, 6, -3.2f))));
    public static final RegistryObject<Item> PPRISM_HOE = ITEMS.register(GeneratedRegistrationIds.Items.PPRISM_HOE,
            () -> new HoeItem(ModToolTiers.PPRISM, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.PPRISM, 0, -3f))));
    public static final RegistryObject<Item> PPRISM_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.PPRISM_HELMET,
    ...
    public static final RegistryObject<Item> PPRISM_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.PPRISM_CHESTPLATE,
    ...
    public static final RegistryObject<Item> PPRISM_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.PPRISM_LEGGINGS,
    ...
    public static final RegistryObject<Item> PPRISM_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.PPRISM_BOOTS,
    ...
    // -------------------------------------------------------------------------
    public static final RegistryObject<Item> RFLINT_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.RFLINT_SWORD,
            () -> new SwordItem(ModToolTiers.RFLINT, new Item.Properties().attributes(SwordItem.createAttributes(ModToolTiers.RFLINT, 3, -2.4f))));
    public static final RegistryObject<Item> RFLINT_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.RFLINT_PICKAXE,
    ...
    public static final RegistryObject<Item> RFLINT_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.RFLINT_SHOVEL,
    ...
    public static final RegistryObject<Item> RFLINT_AXE = ITEMS.register(GeneratedRegistrationIds.Items.RFLINT_AXE,
            () -> new AxeItem(ModToolTiers.RFLINT, new Item.Properties().attributes(AxeItem.createAttributes(ModToolTiers.RFLINT, 6, -3.2f))));
    public static final RegistryObject<Item> RFLINT_HOE = ITEMS.register(GeneratedRegistrationIds.Items.RFLINT_HOE,
    ...
    // -------------------------------------------------------------------------
    public static final RegistryObject<Item> FNI_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.FNI_SWORD,
    ...
    public static final RegistryObject<Item> FNI_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.FNI_PICKAXE,
    ...
    public static final RegistryObject<Item> FNI_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.FNI_SHOVEL,
    ...
    public static final RegistryObject<Item> FNI_AXE = ITEMS.register(GeneratedRegistrationIds.Items.FNI_AXE,
            () -> new AxeItem(ModToolTiers.FNI_TOOLS, new Item.Properties().attributes(AxeItem.createAttributes(ModToolTiers.FNI_TOOLS, 6, -3.2f))));
    public static final RegistryObject<Item> FNI_HOE = ITEMS.register(GeneratedRegistrationIds.Items.FNI_HOE,
            () -> new HoeItem(ModToolTiers.FNI_TOOLS, new Item.Properties().attributes(HoeItem.createAttributes(ModToolTiers.FNI_TOOLS, 0, -3f))));

    public static final RegistryObject<Item> FNI_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.FNI_HELMET,
    ...
    public static final RegistryObject<Item> FNI_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.FNI_CHESTPLATE,
    ...
    public static final RegistryObject<Item> FNI_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.FNI_LEGGINGS,
    ...
    public static final RegistryObject<Item> FNI_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.FNI_BOOTS,
    ...
    public static final RegistryObject<Item> ANDESITE_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.ANDESITE_SWORD,
    ...
    public static final RegistryObject<Item> ANDESITE_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.ANDESITE_PICKAXE,
    ...
    public static final RegistryObject<Item> ANDESITE_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.ANDESITE_SHOVEL,
    ...
    public static final RegistryObject<Item> ANDESITE_AXE = ITEMS.register(GeneratedRegistrationIds.Items.ANDESITE_AXE,
    ...
    public static final RegistryObject<Item> ANDESITE_HOE = ITEMS.register(GeneratedRegistrationIds.Items.ANDESITE_HOE,
    ...
    public static final RegistryObject<Item> BASALT_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.BASALT_SWORD,
    ...
    public static final RegistryObject<Item> BASALT_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.BASALT_PICKAXE,
    ...
    public static final RegistryObject<Item> BASALT_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.BASALT_SHOVEL,
    ...
    public static final RegistryObject<Item> BASALT_AXE = ITEMS.register(GeneratedRegistrationIds.Items.BASALT_AXE,
    ...
    public static final RegistryObject<Item> BASALT_HOE = ITEMS.register(GeneratedRegistrationIds.Items.BASALT_HOE,
    ...
    public static final RegistryObject<Item> BLACKSTONE_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.BLACKSTONE_SWORD,
    ...
    public static final RegistryObject<Item> BLACKSTONE_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.BLACKSTONE_PICKAXE,
    ...
    public static final RegistryObject<Item> BLACKSTONE_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.BLACKSTONE_SHOVEL,
    ...
    public static final RegistryObject<Item> BLACKSTONE_AXE = ITEMS.register(GeneratedRegistrationIds.Items.BLACKSTONE_AXE,
    ...
    public static final RegistryObject<Item> BLACKSTONE_HOE = ITEMS.register(GeneratedRegistrationIds.Items.BLACKSTONE_HOE,
    ...
    public static final RegistryObject<Item> CALCITE_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.CALCITE_SWORD,
    ...
    public static final RegistryObject<Item> CALCITE_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.CALCITE_PICKAXE,
    ...
    public static final RegistryObject<Item> CALCITE_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.CALCITE_SHOVEL,
    ...
    public static final RegistryObject<Item> CALCITE_AXE = ITEMS.register(GeneratedRegistrationIds.Items.CALCITE_AXE,
    ...
    public static final RegistryObject<Item> CALCITE_HOE = ITEMS.register(GeneratedRegistrationIds.Items.CALCITE_HOE,
    ...
    public static final RegistryObject<Item> DEEPSLATE_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.DEEPSLATE_SWORD,
    ...
    public static final RegistryObject<Item> DEEPSLATE_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.DEEPSLATE_PICKAXE,
    ...
    public static final RegistryObject<Item> DEEPSLATE_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.DEEPSLATE_SHOVEL,
    ...
    public static final RegistryObject<Item> DEEPSLATE_AXE = ITEMS.register(GeneratedRegistrationIds.Items.DEEPSLATE_AXE,
    ...
    public static final RegistryObject<Item> DEEPSLATE_HOE = ITEMS.register(GeneratedRegistrationIds.Items.DEEPSLATE_HOE,
    ...
    public static final RegistryObject<Item> DIORITE_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.DIORITE_SWORD,
    ...
    public static final RegistryObject<Item> DIORITE_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.DIORITE_PICKAXE,
    ...
    public static final RegistryObject<Item> DIORITE_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.DIORITE_SHOVEL,
    ...
    public static final RegistryObject<Item> DIORITE_AXE = ITEMS.register(GeneratedRegistrationIds.Items.DIORITE_AXE,
    ...
    public static final RegistryObject<Item> DIORITE_HOE = ITEMS.register(GeneratedRegistrationIds.Items.DIORITE_HOE,
    ...
    public static final RegistryObject<Item> END_STONE_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.END_STONE_SWORD,
    ...
    public static final RegistryObject<Item> END_STONE_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.END_STONE_PICKAXE,
    ...
    public static final RegistryObject<Item> END_STONE_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.END_STONE_SHOVEL,
    ...
    public static final RegistryObject<Item> END_STONE_AXE = ITEMS.register(GeneratedRegistrationIds.Items.END_STONE_AXE,
    ...
    public static final RegistryObject<Item> END_STONE_HOE = ITEMS.register(GeneratedRegistrationIds.Items.END_STONE_HOE,
    ...
    public static final RegistryObject<Item> GRANITE_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.GRANITE_SWORD,
    ...
    public static final RegistryObject<Item> GRANITE_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.GRANITE_PICKAXE,
    ...
    public static final RegistryObject<Item> GRANITE_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.GRANITE_SHOVEL,
    ...
    public static final RegistryObject<Item> GRANITE_AXE = ITEMS.register(GeneratedRegistrationIds.Items.GRANITE_AXE,
    ...
    public static final RegistryObject<Item> GRANITE_HOE = ITEMS.register(GeneratedRegistrationIds.Items.GRANITE_HOE,
    ...
    public static final RegistryObject<Item> NETHERRACK_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.NETHERRACK_SWORD,
    ...
    public static final RegistryObject<Item> NETHERRACK_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.NETHERRACK_PICKAXE,
    ...
    public static final RegistryObject<Item> NETHERRACK_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.NETHERRACK_SHOVEL,
    ...
    public static final RegistryObject<Item> NETHERRACK_AXE = ITEMS.register(GeneratedRegistrationIds.Items.NETHERRACK_AXE,
    ...
    public static final RegistryObject<Item> NETHERRACK_HOE = ITEMS.register(GeneratedRegistrationIds.Items.NETHERRACK_HOE,
    ...
    public static final RegistryObject<Item> SANDSTONE_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.SANDSTONE_SWORD,
    ...
    public static final RegistryObject<Item> SANDSTONE_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.SANDSTONE_PICKAXE,
    ...
    public static final RegistryObject<Item> SANDSTONE_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.SANDSTONE_SHOVEL,
    ...
    public static final RegistryObject<Item> SANDSTONE_AXE = ITEMS.register(GeneratedRegistrationIds.Items.SANDSTONE_AXE,
    ...
    public static final RegistryObject<Item> SANDSTONE_HOE = ITEMS.register(GeneratedRegistrationIds.Items.SANDSTONE_HOE,
    ...
    public static final RegistryObject<Item> SMOOTH_BASALT_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.SMOOTH_BASALT_SWORD,
    ...
    public static final RegistryObject<Item> SMOOTH_BASALT_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.SMOOTH_BASALT_PICKAXE,
    ...
    public static final RegistryObject<Item> SMOOTH_BASALT_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.SMOOTH_BASALT_SHOVEL,
    ...
    public static final RegistryObject<Item> SMOOTH_BASALT_AXE = ITEMS.register(GeneratedRegistrationIds.Items.SMOOTH_BASALT_AXE,
    ...
    public static final RegistryObject<Item> SMOOTH_BASALT_HOE = ITEMS.register(GeneratedRegistrationIds.Items.SMOOTH_BASALT_HOE,
    ...
    public static final RegistryObject<Item> TERRACOTTA_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.TERRACOTTA_SWORD,
    ...
    public static final RegistryObject<Item> TERRACOTTA_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.TERRACOTTA_PICKAXE,
    ...
    public static final RegistryObject<Item> TERRACOTTA_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.TERRACOTTA_SHOVEL,
    ...
    public static final RegistryObject<Item> TERRACOTTA_AXE = ITEMS.register(GeneratedRegistrationIds.Items.TERRACOTTA_AXE,
    ...
    public static final RegistryObject<Item> TERRACOTTA_HOE = ITEMS.register(GeneratedRegistrationIds.Items.TERRACOTTA_HOE,
    ...
    public static final RegistryObject<Item> TUFF_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.TUFF_SWORD,
    ...
    public static final RegistryObject<Item> TUFF_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.TUFF_PICKAXE,
    ...
    public static final RegistryObject<Item> TUFF_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.TUFF_SHOVEL,
    ...
    public static final RegistryObject<Item> TUFF_AXE = ITEMS.register(GeneratedRegistrationIds.Items.TUFF_AXE,
    ...
    public static final RegistryObject<Item> TUFF_HOE = ITEMS.register(GeneratedRegistrationIds.Items.TUFF_HOE,
    ...
    public static final RegistryObject<Item> OAK_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.OAK_SWORD,
    ...
    public static final RegistryObject<Item> OAK_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.OAK_PICKAXE,
    ...
    public static final RegistryObject<Item> OAK_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.OAK_SHOVEL,
    ...
    public static final RegistryObject<Item> OAK_AXE = ITEMS.register(GeneratedRegistrationIds.Items.OAK_AXE,
            () -> new AxeItem(ModToolTiers.WOOD_OAK, new Item.Properties().attributes(AxeItem.createAttributes(ModToolTiers.WOOD_OAK, 6, -3.2f))));
    public static final RegistryObject<Item> OAK_HOE = ITEMS.register(GeneratedRegistrationIds.Items.OAK_HOE,
    ...
    public static final RegistryObject<Item> SPRUCE_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.SPRUCE_SWORD,
    ...
    public static final RegistryObject<Item> SPRUCE_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.SPRUCE_PICKAXE,
    ...
    public static final RegistryObject<Item> SPRUCE_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.SPRUCE_SHOVEL,
    ...
    public static final RegistryObject<Item> SPRUCE_AXE = ITEMS.register(GeneratedRegistrationIds.Items.SPRUCE_AXE,
    ...
    public static final RegistryObject<Item> SPRUCE_HOE = ITEMS.register(GeneratedRegistrationIds.Items.SPRUCE_HOE,
    ...
    public static final RegistryObject<Item> BIRCH_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.BIRCH_SWORD,
    ...
    public static final RegistryObject<Item> BIRCH_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.BIRCH_PICKAXE,
    ...
    public static final RegistryObject<Item> BIRCH_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.BIRCH_SHOVEL,
    ...
    public static final RegistryObject<Item> BIRCH_AXE = ITEMS.register(GeneratedRegistrationIds.Items.BIRCH_AXE,
    ...
    public static final RegistryObject<Item> BIRCH_HOE = ITEMS.register(GeneratedRegistrationIds.Items.BIRCH_HOE,
    ...
    public static final RegistryObject<Item> JUNGLE_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.JUNGLE_SWORD,
    ...
    public static final RegistryObject<Item> JUNGLE_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.JUNGLE_PICKAXE,
    ...
    public static final RegistryObject<Item> JUNGLE_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.JUNGLE_SHOVEL,
    ...
    public static final RegistryObject<Item> JUNGLE_AXE = ITEMS.register(GeneratedRegistrationIds.Items.JUNGLE_AXE,
    ...
    public static final RegistryObject<Item> JUNGLE_HOE = ITEMS.register(GeneratedRegistrationIds.Items.JUNGLE_HOE,
    ...
    public static final RegistryObject<Item> ACACIA_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.ACACIA_SWORD,
    ...
    public static final RegistryObject<Item> ACACIA_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.ACACIA_PICKAXE,
    ...
    public static final RegistryObject<Item> ACACIA_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.ACACIA_SHOVEL,
    ...
    public static final RegistryObject<Item> ACACIA_AXE = ITEMS.register(GeneratedRegistrationIds.Items.ACACIA_AXE,
    ...
    public static final RegistryObject<Item> ACACIA_HOE = ITEMS.register(GeneratedRegistrationIds.Items.ACACIA_HOE,
    ...
    public static final RegistryObject<Item> DARK_OAK_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.DARK_OAK_SWORD,
    ...
    public static final RegistryObject<Item> DARK_OAK_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.DARK_OAK_PICKAXE,
    ...
    public static final RegistryObject<Item> DARK_OAK_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.DARK_OAK_SHOVEL,
    ...
    public static final RegistryObject<Item> DARK_OAK_AXE = ITEMS.register(GeneratedRegistrationIds.Items.DARK_OAK_AXE,
    ...
    public static final RegistryObject<Item> DARK_OAK_HOE = ITEMS.register(GeneratedRegistrationIds.Items.DARK_OAK_HOE,
    ...
    public static final RegistryObject<Item> MANGROVE_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.MANGROVE_SWORD,
    ...
    public static final RegistryObject<Item> MANGROVE_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.MANGROVE_PICKAXE,
    ...
    public static final RegistryObject<Item> MANGROVE_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.MANGROVE_SHOVEL,
    ...
    public static final RegistryObject<Item> MANGROVE_AXE = ITEMS.register(GeneratedRegistrationIds.Items.MANGROVE_AXE,
    ...
    public static final RegistryObject<Item> MANGROVE_HOE = ITEMS.register(GeneratedRegistrationIds.Items.MANGROVE_HOE,
    ...
    public static final RegistryObject<Item> CHERRY_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.CHERRY_SWORD,
    ...
    public static final RegistryObject<Item> CHERRY_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.CHERRY_PICKAXE,
    ...
    public static final RegistryObject<Item> CHERRY_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.CHERRY_SHOVEL,
    ...
    public static final RegistryObject<Item> CHERRY_AXE = ITEMS.register(GeneratedRegistrationIds.Items.CHERRY_AXE,
    ...
    public static final RegistryObject<Item> CHERRY_HOE = ITEMS.register(GeneratedRegistrationIds.Items.CHERRY_HOE,
    ...
    public static final RegistryObject<Item> BAMBOO_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.BAMBOO_SWORD,
    ...
    public static final RegistryObject<Item> BAMBOO_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.BAMBOO_PICKAXE,
    ...
    public static final RegistryObject<Item> BAMBOO_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.BAMBOO_SHOVEL,
    ...
    public static final RegistryObject<Item> BAMBOO_AXE = ITEMS.register(GeneratedRegistrationIds.Items.BAMBOO_AXE,
    ...
    public static final RegistryObject<Item> BAMBOO_HOE = ITEMS.register(GeneratedRegistrationIds.Items.BAMBOO_HOE,
    ...
    public static final RegistryObject<Item> CRIMSON_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.CRIMSON_SWORD,
    ...
    public static final RegistryObject<Item> CRIMSON_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.CRIMSON_PICKAXE,
    ...
    public static final RegistryObject<Item> CRIMSON_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.CRIMSON_SHOVEL,
    ...
    public static final RegistryObject<Item> CRIMSON_AXE = ITEMS.register(GeneratedRegistrationIds.Items.CRIMSON_AXE,
    ...
    public static final RegistryObject<Item> CRIMSON_HOE = ITEMS.register(GeneratedRegistrationIds.Items.CRIMSON_HOE,
    ...
    public static final RegistryObject<Item> WARPED_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.WARPED_SWORD,
    ...
    public static final RegistryObject<Item> WARPED_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.WARPED_PICKAXE,
    ...
    public static final RegistryObject<Item> WARPED_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.WARPED_SHOVEL,
    ...
    public static final RegistryObject<Item> WARPED_AXE = ITEMS.register(GeneratedRegistrationIds.Items.WARPED_AXE,
    ...
    public static final RegistryObject<Item> WARPED_HOE = ITEMS.register(GeneratedRegistrationIds.Items.WARPED_HOE,
    ...
    // -------------------------------------------------------------------------
    public static final RegistryObject<Item> LEATHER_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.LEATHER_SWORD,
            () -> new SwordItem(ModToolTiers.LEATHER, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.LEATHER, 3, -2.4f))));
    public static final RegistryObject<Item> LEATHER_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.LEATHER_PICKAXE,
    ...
    public static final RegistryObject<Item> LEATHER_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.LEATHER_SHOVEL,
    ...
    public static final RegistryObject<Item> LEATHER_AXE = ITEMS.register(GeneratedRegistrationIds.Items.LEATHER_AXE,
            () -> new AxeItem(ModToolTiers.LEATHER, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.LEATHER, 6, -3.2f))));
    public static final RegistryObject<Item> LEATHER_HOE = ITEMS.register(GeneratedRegistrationIds.Items.LEATHER_HOE,
    ...
    public static final RegistryObject<Item> PAPER_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.PAPER_SWORD,
            () -> new SwordItem(ModToolTiers.PAPER, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.PAPER, 3, -2.4f))));
    public static final RegistryObject<Item> PAPER_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.PAPER_PICKAXE,
            () -> new PickaxeItem(ModToolTiers.PAPER, new Item.Properties()
                    .attributes(PickaxeItem.createAttributes(ModToolTiers.PAPER, 1, -2.8f))));
    public static final RegistryObject<Item> PAPER_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.PAPER_SHOVEL,
            () -> new ShovelItem(ModToolTiers.PAPER, new Item.Properties()
                    .attributes(ShovelItem.createAttributes(ModToolTiers.PAPER, 1.5f, -3f))));
    public static final RegistryObject<Item> PAPER_AXE = ITEMS.register(GeneratedRegistrationIds.Items.PAPER_AXE,
            () -> new AxeItem(ModToolTiers.PAPER, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.PAPER, 6, -3.2f))));
    public static final RegistryObject<Item> PAPER_HOE = ITEMS.register(GeneratedRegistrationIds.Items.PAPER_HOE,
    ...
    public static final RegistryObject<Item> FEATHER_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.FEATHER_SWORD,
            () -> new SwordItem(ModToolTiers.FEATHER, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.FEATHER, 3, -2.4f))));
    public static final RegistryObject<Item> FEATHER_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.FEATHER_PICKAXE,
    ...
    public static final RegistryObject<Item> FEATHER_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.FEATHER_SHOVEL,
    ...
    public static final RegistryObject<Item> FEATHER_AXE = ITEMS.register(GeneratedRegistrationIds.Items.FEATHER_AXE,
            () -> new AxeItem(ModToolTiers.FEATHER, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.FEATHER, 6, -3.2f))));
    public static final RegistryObject<Item> FEATHER_HOE = ITEMS.register(GeneratedRegistrationIds.Items.FEATHER_HOE,
    ...
    public static final RegistryObject<Item> GLASS_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.GLASS_SWORD,
            () -> new SwordItem(ModToolTiers.GLASS, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.GLASS, 3, -2.4f))));
    public static final RegistryObject<Item> GLASS_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.GLASS_PICKAXE,
            () -> new PickaxeItem(ModToolTiers.GLASS, new Item.Properties()
                    .attributes(PickaxeItem.createAttributes(ModToolTiers.GLASS, 1, -2.8f))));
    public static final RegistryObject<Item> GLASS_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.GLASS_SHOVEL,
            () -> new ShovelItem(ModToolTiers.GLASS, new Item.Properties()
                    .attributes(ShovelItem.createAttributes(ModToolTiers.GLASS, 1.5f, -3f))));
    public static final RegistryObject<Item> GLASS_AXE = ITEMS.register(GeneratedRegistrationIds.Items.GLASS_AXE,
            () -> new AxeItem(ModToolTiers.GLASS, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.GLASS, 6, -3.2f))));
    public static final RegistryObject<Item> GLASS_HOE = ITEMS.register(GeneratedRegistrationIds.Items.GLASS_HOE,
    ...
    public static final RegistryObject<Item> RABBIT_HIDE_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.RABBIT_HIDE_HELMET,
    ...
    public static final RegistryObject<Item> RABBIT_HIDE_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.RABBIT_HIDE_CHESTPLATE,
    ...
    public static final RegistryObject<Item> RABBIT_HIDE_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.RABBIT_HIDE_LEGGINGS,
    ...
    public static final RegistryObject<Item> RABBIT_HIDE_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.RABBIT_HIDE_BOOTS,
    ...
    // ── Cactus (tools + armor) ──────────────────────────────────────────────
    public static final RegistryObject<Item> CACTUS_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.CACTUS_SWORD,
            () -> new SwordItem(ModToolTiers.CACTUS, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.CACTUS, 3, -2.4f))));
    public static final RegistryObject<Item> CACTUS_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.CACTUS_PICKAXE,
    ...
    public static final RegistryObject<Item> CACTUS_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.CACTUS_SHOVEL,
            () -> new ShovelItem(ModToolTiers.CACTUS, new Item.Properties()
                    .attributes(ShovelItem.createAttributes(ModToolTiers.CACTUS, 1.5f, -3f))));
    public static final RegistryObject<Item> CACTUS_AXE = ITEMS.register(GeneratedRegistrationIds.Items.CACTUS_AXE,
            () -> new AxeItem(ModToolTiers.CACTUS, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.CACTUS, 6, -3.2f))));
    public static final RegistryObject<Item> CACTUS_HOE = ITEMS.register(GeneratedRegistrationIds.Items.CACTUS_HOE,
            () -> new HoeItem(ModToolTiers.CACTUS, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.CACTUS, 0, -3f))));
    public static final RegistryObject<Item> CACTUS_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.CACTUS_HELMET,
    ...
    public static final RegistryObject<Item> CACTUS_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.CACTUS_CHESTPLATE,
    ...
    public static final RegistryObject<Item> CACTUS_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.CACTUS_LEGGINGS,
    ...
    public static final RegistryObject<Item> CACTUS_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.CACTUS_BOOTS,
    ...
    // ── Sponge (tools only) ─────────────────────────────────────────────────
    public static final RegistryObject<Item> SPONGE_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.SPONGE_SWORD,
            () -> new SwordItem(ModToolTiers.SPONGE, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.SPONGE, 3, -2.4f))));
    public static final RegistryObject<Item> SPONGE_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.SPONGE_PICKAXE,
    ...
    public static final RegistryObject<Item> SPONGE_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.SPONGE_SHOVEL,
            () -> new ShovelItem(ModToolTiers.SPONGE, new Item.Properties()
                    .attributes(ShovelItem.createAttributes(ModToolTiers.SPONGE, 1.5f, -3f))));
    public static final RegistryObject<Item> SPONGE_AXE = ITEMS.register(GeneratedRegistrationIds.Items.SPONGE_AXE,
            () -> new AxeItem(ModToolTiers.SPONGE, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.SPONGE, 6, -3.2f))));
    public static final RegistryObject<Item> SPONGE_HOE = ITEMS.register(GeneratedRegistrationIds.Items.SPONGE_HOE,
            () -> new HoeItem(ModToolTiers.SPONGE, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.SPONGE, 0, -3f))));

    // ── Bone (tools + armor) ────────────────────────────────────────────────
    public static final RegistryObject<Item> BONE_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.BONE_SWORD,
            () -> new SwordItem(ModToolTiers.BONE, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.BONE, 3, -2.4f))));
    public static final RegistryObject<Item> BONE_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.BONE_PICKAXE,
            () -> new PickaxeItem(ModToolTiers.BONE, new Item.Properties()
                    .attributes(PickaxeItem.createAttributes(ModToolTiers.BONE, 1, -2.8f))));
    public static final RegistryObject<Item> BONE_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.BONE_SHOVEL,
            () -> new ShovelItem(ModToolTiers.BONE, new Item.Properties()
                    .attributes(ShovelItem.createAttributes(ModToolTiers.BONE, 1.5f, -3f))));
    public static final RegistryObject<Item> BONE_AXE = ITEMS.register(GeneratedRegistrationIds.Items.BONE_AXE,
            () -> new AxeItem(ModToolTiers.BONE, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.BONE, 6, -3.2f))));
    public static final RegistryObject<Item> BONE_HOE = ITEMS.register(GeneratedRegistrationIds.Items.BONE_HOE,
            () -> new HoeItem(ModToolTiers.BONE, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.BONE, 0, -3f))));
    public static final RegistryObject<Item> BONE_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.BONE_HELMET,
            () -> new ArmorItem(ModArmorMaterials.BONE_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(8))));
    public static final RegistryObject<Item> BONE_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.BONE_CHESTPLATE,
            () -> new ArmorItem(ModArmorMaterials.BONE_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(8))));
    public static final RegistryObject<Item> BONE_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.BONE_LEGGINGS,
            () -> new ArmorItem(ModArmorMaterials.BONE_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(8))));
    public static final RegistryObject<Item> BONE_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.BONE_BOOTS,
            () -> new ArmorItem(ModArmorMaterials.BONE_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(8))));

    // ── Clay (tools + armor) ────────────────────────────────────────────────
    public static final RegistryObject<Item> CLAY_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.CLAY_SWORD,
            () -> new SwordItem(ModToolTiers.CLAY, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.CLAY, 3, -2.4f))));
    public static final RegistryObject<Item> CLAY_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.CLAY_PICKAXE,
            () -> new PickaxeItem(ModToolTiers.CLAY, new Item.Properties()
                    .attributes(PickaxeItem.createAttributes(ModToolTiers.CLAY, 1, -2.8f))));
    public static final RegistryObject<Item> CLAY_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.CLAY_SHOVEL,
            () -> new ShovelItem(ModToolTiers.CLAY, new Item.Properties()
                    .attributes(ShovelItem.createAttributes(ModToolTiers.CLAY, 1.5f, -3f))));
    public static final RegistryObject<Item> CLAY_AXE = ITEMS.register(GeneratedRegistrationIds.Items.CLAY_AXE,
            () -> new AxeItem(ModToolTiers.CLAY, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.CLAY, 6, -3.2f))));
    public static final RegistryObject<Item> CLAY_HOE = ITEMS.register(GeneratedRegistrationIds.Items.CLAY_HOE,
            () -> new HoeItem(ModToolTiers.CLAY, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.CLAY, 0, -3f))));
    public static final RegistryObject<Item> CLAY_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.CLAY_HELMET,
            () -> new ArmorItem(ModArmorMaterials.CLAY_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(6))));
    public static final RegistryObject<Item> CLAY_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.CLAY_CHESTPLATE,
            () -> new ArmorItem(ModArmorMaterials.CLAY_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(6))));
    public static final RegistryObject<Item> CLAY_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.CLAY_LEGGINGS,
            () -> new ArmorItem(ModArmorMaterials.CLAY_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(6))));
    public static final RegistryObject<Item> CLAY_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.CLAY_BOOTS,
            () -> new ArmorItem(ModArmorMaterials.CLAY_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(6))));

    // ── Nether Wart (tools only) ────────────────────────────────────────────
    public static final RegistryObject<Item> NETHER_WART_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.NETHER_WART_SWORD,
    ...
    public static final RegistryObject<Item> NETHER_WART_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.NETHER_WART_PICKAXE,
    ...
    public static final RegistryObject<Item> NETHER_WART_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.NETHER_WART_SHOVEL,
    ...
    public static final RegistryObject<Item> NETHER_WART_AXE = ITEMS.register(GeneratedRegistrationIds.Items.NETHER_WART_AXE,
    ...
    public static final RegistryObject<Item> NETHER_WART_HOE = ITEMS.register(GeneratedRegistrationIds.Items.NETHER_WART_HOE,
    ...
    // ── Brick (tools + armor) ───────────────────────────────────────────────
    public static final RegistryObject<Item> BRICK_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.BRICK_SWORD,
            () -> new SwordItem(ModToolTiers.BRICK, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.BRICK, 3, -2.4f))));
    public static final RegistryObject<Item> BRICK_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.BRICK_PICKAXE,
            () -> new PickaxeItem(ModToolTiers.BRICK, new Item.Properties()
                    .attributes(PickaxeItem.createAttributes(ModToolTiers.BRICK, 1, -2.8f))));
    public static final RegistryObject<Item> BRICK_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.BRICK_SHOVEL,
            () -> new ShovelItem(ModToolTiers.BRICK, new Item.Properties()
                    .attributes(ShovelItem.createAttributes(ModToolTiers.BRICK, 1.5f, -3f))));
    public static final RegistryObject<Item> BRICK_AXE = ITEMS.register(GeneratedRegistrationIds.Items.BRICK_AXE,
            () -> new AxeItem(ModToolTiers.BRICK, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.BRICK, 6, -3.2f))));
    public static final RegistryObject<Item> BRICK_HOE = ITEMS.register(GeneratedRegistrationIds.Items.BRICK_HOE,
            () -> new HoeItem(ModToolTiers.BRICK, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.BRICK, 0, -3f))));
    public static final RegistryObject<Item> BRICK_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.BRICK_HELMET,
    ...
    public static final RegistryObject<Item> BRICK_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.BRICK_CHESTPLATE,
    ...
    public static final RegistryObject<Item> BRICK_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.BRICK_LEGGINGS,
    ...
    public static final RegistryObject<Item> BRICK_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.BRICK_BOOTS,
    ...
    public static final RegistryObject<Item> NETHER_BRICK_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.NETHER_BRICK_SWORD,
    ...
    public static final RegistryObject<Item> NETHER_BRICK_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.NETHER_BRICK_PICKAXE,
    ...
    public static final RegistryObject<Item> NETHER_BRICK_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.NETHER_BRICK_SHOVEL,
    ...
    public static final RegistryObject<Item> NETHER_BRICK_AXE = ITEMS.register(GeneratedRegistrationIds.Items.NETHER_BRICK_AXE,
    ...
    public static final RegistryObject<Item> NETHER_BRICK_HOE = ITEMS.register(GeneratedRegistrationIds.Items.NETHER_BRICK_HOE,
    ...
    public static final RegistryObject<Item> NETHER_BRICK_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.NETHER_BRICK_HELMET,
            () -> new ArmorItem(ModArmorMaterials.NETHER_BRICK_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(12))));
    public static final RegistryObject<Item> NETHER_BRICK_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.NETHER_BRICK_CHESTPLATE,
            () -> new ArmorItem(ModArmorMaterials.NETHER_BRICK_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(12))));
    public static final RegistryObject<Item> NETHER_BRICK_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.NETHER_BRICK_LEGGINGS,
            () -> new ArmorItem(ModArmorMaterials.NETHER_BRICK_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(12))));
    public static final RegistryObject<Item> NETHER_BRICK_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.NETHER_BRICK_BOOTS,
            () -> new ArmorItem(ModArmorMaterials.NETHER_BRICK_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(12))));

    // ── Pointed Dripstone (tools only) ──────────────────────────────────────
    public static final RegistryObject<Item> POINTED_DRIPSTONE_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.POINTED_DRIPSTONE_SWORD,
    ...
    public static final RegistryObject<Item> POINTED_DRIPSTONE_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.POINTED_DRIPSTONE_PICKAXE,
    ...
    public static final RegistryObject<Item> POINTED_DRIPSTONE_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.POINTED_DRIPSTONE_SHOVEL,
    ...
    public static final RegistryObject<Item> POINTED_DRIPSTONE_AXE = ITEMS.register(GeneratedRegistrationIds.Items.POINTED_DRIPSTONE_AXE,
    ...
    public static final RegistryObject<Item> POINTED_DRIPSTONE_HOE = ITEMS.register(GeneratedRegistrationIds.Items.POINTED_DRIPSTONE_HOE,
    ...
    // ── Copper (tools + armor) ──────────────────────────────────────────────
    public static final RegistryObject<Item> COPPER_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.COPPER_SWORD,
            () -> new SwordItem(ModToolTiers.COPPER, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.COPPER, 3, -2.4f))));
    public static final RegistryObject<Item> COPPER_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.COPPER_PICKAXE,
    ...
    public static final RegistryObject<Item> COPPER_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.COPPER_SHOVEL,
            () -> new ShovelItem(ModToolTiers.COPPER, new Item.Properties()
                    .attributes(ShovelItem.createAttributes(ModToolTiers.COPPER, 1.5f, -3f))));
    public static final RegistryObject<Item> COPPER_AXE = ITEMS.register(GeneratedRegistrationIds.Items.COPPER_AXE,
            () -> new AxeItem(ModToolTiers.COPPER, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.COPPER, 6, -3.2f))));
    public static final RegistryObject<Item> COPPER_HOE = ITEMS.register(GeneratedRegistrationIds.Items.COPPER_HOE,
            () -> new HoeItem(ModToolTiers.COPPER, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.COPPER, 0, -3f))));
    public static final RegistryObject<Item> COPPER_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.COPPER_HELMET,
            () -> new ArmorItem(ModArmorMaterials.COPPER_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(12))));
    public static final RegistryObject<Item> COPPER_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.COPPER_CHESTPLATE,
            () -> new ArmorItem(ModArmorMaterials.COPPER_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(12))));
    public static final RegistryObject<Item> COPPER_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.COPPER_LEGGINGS,
            () -> new ArmorItem(ModArmorMaterials.COPPER_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(12))));
    public static final RegistryObject<Item> COPPER_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.COPPER_BOOTS,
            () -> new ArmorItem(ModArmorMaterials.COPPER_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(12))));

    // ── Phantom Membrane (tools + armor) ────────────────────────────────────
    public static final RegistryObject<Item> PHANTOM_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.PHANTOM_SWORD,
    ...
    public static final RegistryObject<Item> PHANTOM_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.PHANTOM_PICKAXE,
    ...
    public static final RegistryObject<Item> PHANTOM_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.PHANTOM_SHOVEL,
    ...
    public static final RegistryObject<Item> PHANTOM_AXE = ITEMS.register(GeneratedRegistrationIds.Items.PHANTOM_AXE,
    ...
    public static final RegistryObject<Item> PHANTOM_HOE = ITEMS.register(GeneratedRegistrationIds.Items.PHANTOM_HOE,
    ...
    public static final RegistryObject<Item> PHANTOM_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.PHANTOM_HELMET,
            () -> new ArmorItem(ModArmorMaterials.PHANTOM_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(10))));
    public static final RegistryObject<Item> PHANTOM_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.PHANTOM_CHESTPLATE,
            () -> new ArmorItem(ModArmorMaterials.PHANTOM_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(10))));
    public static final RegistryObject<Item> PHANTOM_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.PHANTOM_LEGGINGS,
            () -> new ArmorItem(ModArmorMaterials.PHANTOM_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(10))));
    public static final RegistryObject<Item> PHANTOM_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.PHANTOM_BOOTS,
            () -> new ArmorItem(ModArmorMaterials.PHANTOM_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(10))));

    // ── Magma Cream (tools + armor) ─────────────────────────────────────────
    public static final RegistryObject<Item> MAGMA_CREAM_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.MAGMA_CREAM_SWORD,
    ...
    public static final RegistryObject<Item> MAGMA_CREAM_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.MAGMA_CREAM_PICKAXE,
    ...
    public static final RegistryObject<Item> MAGMA_CREAM_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.MAGMA_CREAM_SHOVEL,
    ...
    public static final RegistryObject<Item> MAGMA_CREAM_AXE = ITEMS.register(GeneratedRegistrationIds.Items.MAGMA_CREAM_AXE,
    ...
    public static final RegistryObject<Item> MAGMA_CREAM_HOE = ITEMS.register(GeneratedRegistrationIds.Items.MAGMA_CREAM_HOE,
    ...
    public static final RegistryObject<Item> MAGMA_CREAM_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.MAGMA_CREAM_HELMET,
            () -> new ArmorItem(ModArmorMaterials.MAGMA_CREAM_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(10))));
    public static final RegistryObject<Item> MAGMA_CREAM_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.MAGMA_CREAM_CHESTPLATE,
            () -> new ArmorItem(ModArmorMaterials.MAGMA_CREAM_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(10))));
    public static final RegistryObject<Item> MAGMA_CREAM_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.MAGMA_CREAM_LEGGINGS,
            () -> new ArmorItem(ModArmorMaterials.MAGMA_CREAM_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(10))));
    public static final RegistryObject<Item> MAGMA_CREAM_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.MAGMA_CREAM_BOOTS,
            () -> new ArmorItem(ModArmorMaterials.MAGMA_CREAM_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(10))));

    // ── Slime (tools + armor) ───────────────────────────────────────────────
    public static final RegistryObject<Item> SLIME_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.SLIME_SWORD,
            () -> new SwordItem(ModToolTiers.SLIME, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.SLIME, 3, -2.4f))));
    public static final RegistryObject<Item> SLIME_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.SLIME_PICKAXE,
            () -> new PickaxeItem(ModToolTiers.SLIME, new Item.Properties()
                    .attributes(PickaxeItem.createAttributes(ModToolTiers.SLIME, 1, -2.8f))));
    public static final RegistryObject<Item> SLIME_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.SLIME_SHOVEL,
            () -> new ShovelItem(ModToolTiers.SLIME, new Item.Properties()
                    .attributes(ShovelItem.createAttributes(ModToolTiers.SLIME, 1.5f, -3f))));
    public static final RegistryObject<Item> SLIME_AXE = ITEMS.register(GeneratedRegistrationIds.Items.SLIME_AXE,
            () -> new AxeItem(ModToolTiers.SLIME, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.SLIME, 6, -3.2f))));
    public static final RegistryObject<Item> SLIME_HOE = ITEMS.register(GeneratedRegistrationIds.Items.SLIME_HOE,
            () -> new HoeItem(ModToolTiers.SLIME, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.SLIME, 0, -3f))));
    public static final RegistryObject<Item> SLIME_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.SLIME_HELMET,
            () -> new ArmorItem(ModArmorMaterials.SLIME_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(8))));
    public static final RegistryObject<Item> SLIME_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.SLIME_CHESTPLATE,
            () -> new ArmorItem(ModArmorMaterials.SLIME_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(8))));
    public static final RegistryObject<Item> SLIME_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.SLIME_LEGGINGS,
            () -> new ArmorItem(ModArmorMaterials.SLIME_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(8))));
    public static final RegistryObject<Item> SLIME_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.SLIME_BOOTS,
            () -> new ArmorItem(ModArmorMaterials.SLIME_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(8))));

    // ── Blaze Rod (tools + armor) ───────────────────────────────────────────
    public static final RegistryObject<Item> BLAZE_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.BLAZE_SWORD,
    ...
    public static final RegistryObject<Item> BLAZE_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.BLAZE_PICKAXE,
    ...
    public static final RegistryObject<Item> BLAZE_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.BLAZE_SHOVEL,
    ...
    public static final RegistryObject<Item> BLAZE_AXE = ITEMS.register(GeneratedRegistrationIds.Items.BLAZE_AXE,
            () -> new AxeItem(ModToolTiers.BLAZE_ROD, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.BLAZE_ROD, 6, -3.2f))));
    public static final RegistryObject<Item> BLAZE_HOE = ITEMS.register(GeneratedRegistrationIds.Items.BLAZE_HOE,
            () -> new HoeItem(ModToolTiers.BLAZE_ROD, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.BLAZE_ROD, 0, -3f))));
    public static final RegistryObject<Item> BLAZE_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.BLAZE_HELMET,
            () -> new ArmorItem(ModArmorMaterials.BLAZE_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(14))));
    public static final RegistryObject<Item> BLAZE_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.BLAZE_CHESTPLATE,
            () -> new ArmorItem(ModArmorMaterials.BLAZE_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(14))));
    public static final RegistryObject<Item> BLAZE_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.BLAZE_LEGGINGS,
            () -> new ArmorItem(ModArmorMaterials.BLAZE_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(14))));
    public static final RegistryObject<Item> BLAZE_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.BLAZE_BOOTS,
            () -> new ArmorItem(ModArmorMaterials.BLAZE_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(14))));

    // ── Nautilus Shell (tools + armor) ──────────────────────────────────────
    public static final RegistryObject<Item> NAUTILUS_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.NAUTILUS_SWORD,
    ...
    public static final RegistryObject<Item> NAUTILUS_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.NAUTILUS_PICKAXE,
    ...
    public static final RegistryObject<Item> NAUTILUS_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.NAUTILUS_SHOVEL,
    ...
    public static final RegistryObject<Item> NAUTILUS_AXE = ITEMS.register(GeneratedRegistrationIds.Items.NAUTILUS_AXE,
    ...
    public static final RegistryObject<Item> NAUTILUS_HOE = ITEMS.register(GeneratedRegistrationIds.Items.NAUTILUS_HOE,
    ...
    public static final RegistryObject<Item> NAUTILUS_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.NAUTILUS_HELMET,
            () -> new ArmorItem(ModArmorMaterials.NAUTILUS_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(14))));
    public static final RegistryObject<Item> NAUTILUS_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.NAUTILUS_CHESTPLATE,
            () -> new ArmorItem(ModArmorMaterials.NAUTILUS_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(14))));
    public static final RegistryObject<Item> NAUTILUS_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.NAUTILUS_LEGGINGS,
            () -> new ArmorItem(ModArmorMaterials.NAUTILUS_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(14))));
    public static final RegistryObject<Item> NAUTILUS_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.NAUTILUS_BOOTS,
            () -> new ArmorItem(ModArmorMaterials.NAUTILUS_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(14))));

    // ── Purpur (tools + armor) ──────────────────────────────────────────────
    public static final RegistryObject<Item> PURPUR_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.PURPUR_SWORD,
            () -> new SwordItem(ModToolTiers.PURPUR, new Item.Properties()
                    .attributes(SwordItem.createAttributes(ModToolTiers.PURPUR, 3, -2.4f))));
    public static final RegistryObject<Item> PURPUR_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.PURPUR_PICKAXE,
    ...
    public static final RegistryObject<Item> PURPUR_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.PURPUR_SHOVEL,
            () -> new ShovelItem(ModToolTiers.PURPUR, new Item.Properties()
                    .attributes(ShovelItem.createAttributes(ModToolTiers.PURPUR, 1.5f, -3f))));
    public static final RegistryObject<Item> PURPUR_AXE = ITEMS.register(GeneratedRegistrationIds.Items.PURPUR_AXE,
            () -> new AxeItem(ModToolTiers.PURPUR, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.PURPUR, 6, -3.2f))));
    public static final RegistryObject<Item> PURPUR_HOE = ITEMS.register(GeneratedRegistrationIds.Items.PURPUR_HOE,
            () -> new HoeItem(ModToolTiers.PURPUR, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.PURPUR, 0, -3f))));
    public static final RegistryObject<Item> PURPUR_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.PURPUR_HELMET,
            () -> new ArmorItem(ModArmorMaterials.PURPUR_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(14))));
    public static final RegistryObject<Item> PURPUR_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.PURPUR_CHESTPLATE,
            () -> new ArmorItem(ModArmorMaterials.PURPUR_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(14))));
    public static final RegistryObject<Item> PURPUR_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.PURPUR_LEGGINGS,
            () -> new ArmorItem(ModArmorMaterials.PURPUR_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(14))));
    public static final RegistryObject<Item> PURPUR_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.PURPUR_BOOTS,
            () -> new ArmorItem(ModArmorMaterials.PURPUR_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(14))));

    // ── Ghast Tear (tools + armor) ──────────────────────────────────────────
    public static final RegistryObject<Item> GHAST_TEAR_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.GHAST_TEAR_SWORD,
    ...
    public static final RegistryObject<Item> GHAST_TEAR_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.GHAST_TEAR_PICKAXE,
    ...
    public static final RegistryObject<Item> GHAST_TEAR_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.GHAST_TEAR_SHOVEL,
    ...
    public static final RegistryObject<Item> GHAST_TEAR_AXE = ITEMS.register(GeneratedRegistrationIds.Items.GHAST_TEAR_AXE,
    ...
    public static final RegistryObject<Item> GHAST_TEAR_HOE = ITEMS.register(GeneratedRegistrationIds.Items.GHAST_TEAR_HOE,
            () -> new HoeItem(ModToolTiers.GHAST_TEAR, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.GHAST_TEAR, 0, -3f))));
    public static final RegistryObject<Item> GHAST_TEAR_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.GHAST_TEAR_HELMET,
            () -> new ArmorItem(ModArmorMaterials.GHAST_TEAR_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(16))));
    public static final RegistryObject<Item> GHAST_TEAR_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.GHAST_TEAR_CHESTPLATE,
            () -> new ArmorItem(ModArmorMaterials.GHAST_TEAR_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(16))));
    public static final RegistryObject<Item> GHAST_TEAR_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.GHAST_TEAR_LEGGINGS,
            () -> new ArmorItem(ModArmorMaterials.GHAST_TEAR_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(16))));
    public static final RegistryObject<Item> GHAST_TEAR_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.GHAST_TEAR_BOOTS,
            () -> new ArmorItem(ModArmorMaterials.GHAST_TEAR_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(16))));

    // ── Eye of Ender (tools + armor) ────────────────────────────────────────
    public static final RegistryObject<Item> EYE_OF_ENDER_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.EYE_OF_ENDER_SWORD,
    ...
    public static final RegistryObject<Item> EYE_OF_ENDER_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.EYE_OF_ENDER_PICKAXE,
    ...
    public static final RegistryObject<Item> EYE_OF_ENDER_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.EYE_OF_ENDER_SHOVEL,
    ...
    public static final RegistryObject<Item> EYE_OF_ENDER_AXE = ITEMS.register(GeneratedRegistrationIds.Items.EYE_OF_ENDER_AXE,
    ...
    public static final RegistryObject<Item> EYE_OF_ENDER_HOE = ITEMS.register(GeneratedRegistrationIds.Items.EYE_OF_ENDER_HOE,
    ...
    public static final RegistryObject<Item> EYE_OF_ENDER_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.EYE_OF_ENDER_HELMET,
            () -> new ArmorItem(ModArmorMaterials.EYE_OF_ENDER_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(16))));
    public static final RegistryObject<Item> EYE_OF_ENDER_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.EYE_OF_ENDER_CHESTPLATE,
            () -> new ArmorItem(ModArmorMaterials.EYE_OF_ENDER_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(16))));
    public static final RegistryObject<Item> EYE_OF_ENDER_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.EYE_OF_ENDER_LEGGINGS,
            () -> new ArmorItem(ModArmorMaterials.EYE_OF_ENDER_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(16))));
    public static final RegistryObject<Item> EYE_OF_ENDER_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.EYE_OF_ENDER_BOOTS,
            () -> new ArmorItem(ModArmorMaterials.EYE_OF_ENDER_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(16))));

    // ── Shulker Shell (tools + armor) ───────────────────────────────────────
    public static final RegistryObject<Item> SHULKER_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.SHULKER_SWORD,
    ...
    public static final RegistryObject<Item> SHULKER_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.SHULKER_PICKAXE,
    ...
    public static final RegistryObject<Item> SHULKER_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.SHULKER_SHOVEL,
    ...
    public static final RegistryObject<Item> SHULKER_AXE = ITEMS.register(GeneratedRegistrationIds.Items.SHULKER_AXE,
    ...
    public static final RegistryObject<Item> SHULKER_HOE = ITEMS.register(GeneratedRegistrationIds.Items.SHULKER_HOE,
    ...
    public static final RegistryObject<Item> SHULKER_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.SHULKER_HELMET,
            () -> new ArmorItem(ModArmorMaterials.SHULKER_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(18))));
    public static final RegistryObject<Item> SHULKER_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.SHULKER_CHESTPLATE,
            () -> new ArmorItem(ModArmorMaterials.SHULKER_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(18))));
    public static final RegistryObject<Item> SHULKER_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.SHULKER_LEGGINGS,
            () -> new ArmorItem(ModArmorMaterials.SHULKER_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(18))));
    public static final RegistryObject<Item> SHULKER_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.SHULKER_BOOTS,
            () -> new ArmorItem(ModArmorMaterials.SHULKER_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(18))));

    // ── Turtle Scute (armor only) ───────────────────────────────────────────
    public static final RegistryObject<Item> TURTLE_SCUTE_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.TURTLE_SCUTE_HELMET,
            () -> new ArmorItem(ModArmorMaterials.TURTLE_SCUTE_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(20))));
    public static final RegistryObject<Item> TURTLE_SCUTE_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.TURTLE_SCUTE_CHESTPLATE,
            () -> new ArmorItem(ModArmorMaterials.TURTLE_SCUTE_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(20))));
    public static final RegistryObject<Item> TURTLE_SCUTE_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.TURTLE_SCUTE_LEGGINGS,
            () -> new ArmorItem(ModArmorMaterials.TURTLE_SCUTE_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(20))));
    public static final RegistryObject<Item> TURTLE_SCUTE_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.TURTLE_SCUTE_BOOTS,
            () -> new ArmorItem(ModArmorMaterials.TURTLE_SCUTE_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(20))));

    // ── Echo Shard (tools + armor) ──────────────────────────────────────────
    public static final RegistryObject<Item> ECHO_SHARD_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.ECHO_SHARD_SWORD,
    ...
    public static final RegistryObject<Item> ECHO_SHARD_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.ECHO_SHARD_PICKAXE,
    ...
    public static final RegistryObject<Item> ECHO_SHARD_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.ECHO_SHARD_SHOVEL,
    ...
    public static final RegistryObject<Item> ECHO_SHARD_AXE = ITEMS.register(GeneratedRegistrationIds.Items.ECHO_SHARD_AXE,
    ...
    public static final RegistryObject<Item> ECHO_SHARD_HOE = ITEMS.register(GeneratedRegistrationIds.Items.ECHO_SHARD_HOE,
            () -> new HoeItem(ModToolTiers.ECHO_SHARD, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.ECHO_SHARD, 0, -3f))));
    public static final RegistryObject<Item> ECHO_SHARD_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.ECHO_SHARD_HELMET,
    ...
    public static final RegistryObject<Item> ECHO_SHARD_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.ECHO_SHARD_CHESTPLATE,
    ...
    public static final RegistryObject<Item> ECHO_SHARD_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.ECHO_SHARD_LEGGINGS,
    ...
    public static final RegistryObject<Item> ECHO_SHARD_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.ECHO_SHARD_BOOTS,
    ...
    public static final RegistryObject<Item> DRAGON_BREATH_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.DRAGON_BREATH_SWORD,
    ...
    public static final RegistryObject<Item> DRAGON_BREATH_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.DRAGON_BREATH_PICKAXE,
    ...
    public static final RegistryObject<Item> DRAGON_BREATH_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.DRAGON_BREATH_SHOVEL,
    ...
    public static final RegistryObject<Item> DRAGON_BREATH_AXE = ITEMS.register(GeneratedRegistrationIds.Items.DRAGON_BREATH_AXE,
    ...
    public static final RegistryObject<Item> DRAGON_BREATH_HOE = ITEMS.register(GeneratedRegistrationIds.Items.DRAGON_BREATH_HOE,
    ...
    public static final RegistryObject<Item> DRAGON_BREATH_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.DRAGON_BREATH_HELMET,
    ...
    public static final RegistryObject<Item> DRAGON_BREATH_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.DRAGON_BREATH_CHESTPLATE,
    ...
    public static final RegistryObject<Item> DRAGON_BREATH_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.DRAGON_BREATH_LEGGINGS,
    ...
    public static final RegistryObject<Item> DRAGON_BREATH_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.DRAGON_BREATH_BOOTS,
    ...
    // -------------------------------------------------------------------------
    public static final RegistryObject<Item> CAKE_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.CAKE_SWORD,
    ...
    public static final RegistryObject<Item> CAKE_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.CAKE_PICKAXE,
    ...
    public static final RegistryObject<Item> CAKE_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.CAKE_SHOVEL,
    ...
    public static final RegistryObject<Item> CAKE_AXE = ITEMS.register(GeneratedRegistrationIds.Items.CAKE_AXE,
            () -> new EdibleAxeItem(ModToolTiers.CAKE, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.CAKE, 6, -3.2f))
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));

    public static final RegistryObject<Item> CAKE_HOE = ITEMS.register(GeneratedRegistrationIds.Items.CAKE_HOE,
    ...
    // -------------------------------------------------------------------------
    public static final RegistryObject<Item> CAKE_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.CAKE_HELMET,
    ...
    public static final RegistryObject<Item> CAKE_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.CAKE_CHESTPLATE,
    ...
    public static final RegistryObject<Item> CAKE_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.CAKE_LEGGINGS,
    ...
    public static final RegistryObject<Item> CAKE_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.CAKE_BOOTS,
    ...
    // =========================================================================
    public static final RegistryObject<Item> BREAD_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.BREAD_SWORD,
            () -> new EdibleSwordItem(ModToolTiers.BREAD, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> BREAD_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.BREAD_PICKAXE,
            () -> new EdiblePickaxeItem(ModToolTiers.BREAD, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> BREAD_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.BREAD_SHOVEL,
            () -> new EdibleShovelItem(ModToolTiers.BREAD, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> BREAD_AXE = ITEMS.register(GeneratedRegistrationIds.Items.BREAD_AXE,
            () -> new EdibleAxeItem(ModToolTiers.BREAD, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.BREAD, 6, -3.2f))
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> BREAD_HOE = ITEMS.register(GeneratedRegistrationIds.Items.BREAD_HOE,
            () -> new EdibleHoeItem(ModToolTiers.BREAD, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.BREAD, 0, -3f))
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> BREAD_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.BREAD_HELMET,
            () -> new EdibleArmorItem(ModArmorMaterials.BREAD_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(3))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> BREAD_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.BREAD_CHESTPLATE,
            () -> new EdibleArmorItem(ModArmorMaterials.BREAD_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(3))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> BREAD_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.BREAD_LEGGINGS,
            () -> new EdibleArmorItem(ModArmorMaterials.BREAD_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(3))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> BREAD_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.BREAD_BOOTS,
    ...
    // =========================================================================
    public static final RegistryObject<Item> DRIED_KELP_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.DRIED_KELP_SWORD,
            () -> new EdibleSwordItem(ModToolTiers.DRIED_KELP, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> DRIED_KELP_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.DRIED_KELP_PICKAXE,
            () -> new EdiblePickaxeItem(ModToolTiers.DRIED_KELP, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> DRIED_KELP_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.DRIED_KELP_SHOVEL,
            () -> new EdibleShovelItem(ModToolTiers.DRIED_KELP, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> DRIED_KELP_AXE = ITEMS.register(GeneratedRegistrationIds.Items.DRIED_KELP_AXE,
            () -> new EdibleAxeItem(ModToolTiers.DRIED_KELP, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> DRIED_KELP_HOE = ITEMS.register(GeneratedRegistrationIds.Items.DRIED_KELP_HOE,
            () -> new EdibleHoeItem(ModToolTiers.DRIED_KELP, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> DRIED_KELP_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.DRIED_KELP_HELMET,
            () -> new EdibleArmorItem(ModArmorMaterials.DRIED_KELP_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(2))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> DRIED_KELP_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.DRIED_KELP_CHESTPLATE,
            () -> new EdibleArmorItem(ModArmorMaterials.DRIED_KELP_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(2))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> DRIED_KELP_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.DRIED_KELP_LEGGINGS,
            () -> new EdibleArmorItem(ModArmorMaterials.DRIED_KELP_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(2))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> DRIED_KELP_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.DRIED_KELP_BOOTS,
    ...
    // =========================================================================
    public static final RegistryObject<Item> ROTTEN_FLESH_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.ROTTEN_FLESH_SWORD,
            () -> new EdibleSwordItem(ModToolTiers.ROTTEN_FLESH, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> ROTTEN_FLESH_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.ROTTEN_FLESH_PICKAXE,
            () -> new EdiblePickaxeItem(ModToolTiers.ROTTEN_FLESH, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> ROTTEN_FLESH_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.ROTTEN_FLESH_SHOVEL,
            () -> new EdibleShovelItem(ModToolTiers.ROTTEN_FLESH, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> ROTTEN_FLESH_AXE = ITEMS.register(GeneratedRegistrationIds.Items.ROTTEN_FLESH_AXE,
            () -> new EdibleAxeItem(ModToolTiers.ROTTEN_FLESH, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> ROTTEN_FLESH_HOE = ITEMS.register(GeneratedRegistrationIds.Items.ROTTEN_FLESH_HOE,
            () -> new EdibleHoeItem(ModToolTiers.ROTTEN_FLESH, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> ROTTEN_FLESH_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.ROTTEN_FLESH_HELMET,
            () -> new EdibleArmorItem(ModArmorMaterials.ROTTEN_FLESH_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(2))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> ROTTEN_FLESH_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.ROTTEN_FLESH_CHESTPLATE,
            () -> new EdibleArmorItem(ModArmorMaterials.ROTTEN_FLESH_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(2))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> ROTTEN_FLESH_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.ROTTEN_FLESH_LEGGINGS,
            () -> new EdibleArmorItem(ModArmorMaterials.ROTTEN_FLESH_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(2))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> ROTTEN_FLESH_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.ROTTEN_FLESH_BOOTS,
    ...
    // =========================================================================
    public static final RegistryObject<Item> MELON_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.MELON_SWORD,
            () -> new EdibleSwordItem(ModToolTiers.MELON, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> MELON_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.MELON_PICKAXE,
            () -> new EdiblePickaxeItem(ModToolTiers.MELON, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> MELON_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.MELON_SHOVEL,
            () -> new EdibleShovelItem(ModToolTiers.MELON, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> MELON_AXE = ITEMS.register(GeneratedRegistrationIds.Items.MELON_AXE,
            () -> new EdibleAxeItem(ModToolTiers.MELON, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.MELON, 6, -3.2f))
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> MELON_HOE = ITEMS.register(GeneratedRegistrationIds.Items.MELON_HOE,
            () -> new EdibleHoeItem(ModToolTiers.MELON, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.MELON, 0, -3f))
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> MELON_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.MELON_HELMET,
            () -> new EdibleArmorItem(ModArmorMaterials.MELON_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(5))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> MELON_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.MELON_CHESTPLATE,
            () -> new EdibleArmorItem(ModArmorMaterials.MELON_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(5))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> MELON_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.MELON_LEGGINGS,
            () -> new EdibleArmorItem(ModArmorMaterials.MELON_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(5))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> MELON_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.MELON_BOOTS,
    ...
    // =========================================================================
    public static final RegistryObject<Item> SWEET_BERRY_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.SWEET_BERRY_SWORD,
            () -> new EdibleSwordItem(ModToolTiers.SWEET_BERRIES, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> SWEET_BERRY_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.SWEET_BERRY_PICKAXE,
            () -> new EdiblePickaxeItem(ModToolTiers.SWEET_BERRIES, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> SWEET_BERRY_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.SWEET_BERRY_SHOVEL,
            () -> new EdibleShovelItem(ModToolTiers.SWEET_BERRIES, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> SWEET_BERRY_AXE = ITEMS.register(GeneratedRegistrationIds.Items.SWEET_BERRY_AXE,
            () -> new EdibleAxeItem(ModToolTiers.SWEET_BERRIES, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> SWEET_BERRY_HOE = ITEMS.register(GeneratedRegistrationIds.Items.SWEET_BERRY_HOE,
            () -> new EdibleHoeItem(ModToolTiers.SWEET_BERRIES, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> SWEET_BERRY_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.SWEET_BERRY_HELMET,
            () -> new EdibleArmorItem(ModArmorMaterials.SWEET_BERRY_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(4))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> SWEET_BERRY_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.SWEET_BERRY_CHESTPLATE,
            () -> new EdibleArmorItem(ModArmorMaterials.SWEET_BERRY_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(4))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> SWEET_BERRY_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.SWEET_BERRY_LEGGINGS,
            () -> new EdibleArmorItem(ModArmorMaterials.SWEET_BERRY_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(4))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> SWEET_BERRY_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.SWEET_BERRY_BOOTS,
    ...
    // =========================================================================
    public static final RegistryObject<Item> PUMPKIN_PIE_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.PUMPKIN_PIE_SWORD,
            () -> new EdibleSwordItem(ModToolTiers.PUMPKIN_PIE, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> PUMPKIN_PIE_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.PUMPKIN_PIE_PICKAXE,
            () -> new EdiblePickaxeItem(ModToolTiers.PUMPKIN_PIE, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> PUMPKIN_PIE_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.PUMPKIN_PIE_SHOVEL,
            () -> new EdibleShovelItem(ModToolTiers.PUMPKIN_PIE, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> PUMPKIN_PIE_AXE = ITEMS.register(GeneratedRegistrationIds.Items.PUMPKIN_PIE_AXE,
            () -> new EdibleAxeItem(ModToolTiers.PUMPKIN_PIE, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> PUMPKIN_PIE_HOE = ITEMS.register(GeneratedRegistrationIds.Items.PUMPKIN_PIE_HOE,
            () -> new EdibleHoeItem(ModToolTiers.PUMPKIN_PIE, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> PUMPKIN_PIE_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.PUMPKIN_PIE_HELMET,
            () -> new EdibleArmorItem(ModArmorMaterials.PUMPKIN_PIE_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(4))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> PUMPKIN_PIE_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.PUMPKIN_PIE_CHESTPLATE,
            () -> new EdibleArmorItem(ModArmorMaterials.PUMPKIN_PIE_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(4))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> PUMPKIN_PIE_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.PUMPKIN_PIE_LEGGINGS,
            () -> new EdibleArmorItem(ModArmorMaterials.PUMPKIN_PIE_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(4))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> PUMPKIN_PIE_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.PUMPKIN_PIE_BOOTS,
    ...
    // =========================================================================
    public static final RegistryObject<Item> MUSHROOM_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.MUSHROOM_SWORD,
            () -> new EdibleSwordItem(ModToolTiers.MUSHROOM, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> MUSHROOM_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.MUSHROOM_PICKAXE,
            () -> new EdiblePickaxeItem(ModToolTiers.MUSHROOM, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> MUSHROOM_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.MUSHROOM_SHOVEL,
            () -> new EdibleShovelItem(ModToolTiers.MUSHROOM, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> MUSHROOM_AXE = ITEMS.register(GeneratedRegistrationIds.Items.MUSHROOM_AXE,
            () -> new EdibleAxeItem(ModToolTiers.MUSHROOM, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> MUSHROOM_HOE = ITEMS.register(GeneratedRegistrationIds.Items.MUSHROOM_HOE,
            () -> new EdibleHoeItem(ModToolTiers.MUSHROOM, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> MUSHROOM_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.MUSHROOM_HELMET,
            () -> new EdibleArmorItem(ModArmorMaterials.MUSHROOM_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(8))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> MUSHROOM_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.MUSHROOM_CHESTPLATE,
            () -> new EdibleArmorItem(ModArmorMaterials.MUSHROOM_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(8))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> MUSHROOM_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.MUSHROOM_LEGGINGS,
            () -> new EdibleArmorItem(ModArmorMaterials.MUSHROOM_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(8))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> MUSHROOM_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.MUSHROOM_BOOTS,
    ...
    // =========================================================================
    public static final RegistryObject<Item> PUFFERFISH_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.PUFFERFISH_SWORD,
            () -> new EdibleSwordItem(ModToolTiers.PUFFERFISH, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> PUFFERFISH_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.PUFFERFISH_PICKAXE,
            () -> new EdiblePickaxeItem(ModToolTiers.PUFFERFISH, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> PUFFERFISH_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.PUFFERFISH_SHOVEL,
            () -> new EdibleShovelItem(ModToolTiers.PUFFERFISH, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> PUFFERFISH_AXE = ITEMS.register(GeneratedRegistrationIds.Items.PUFFERFISH_AXE,
            () -> new EdibleAxeItem(ModToolTiers.PUFFERFISH, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> PUFFERFISH_HOE = ITEMS.register(GeneratedRegistrationIds.Items.PUFFERFISH_HOE,
            () -> new EdibleHoeItem(ModToolTiers.PUFFERFISH, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> PUFFERFISH_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.PUFFERFISH_HELMET,
            () -> new EdibleArmorItem(ModArmorMaterials.PUFFERFISH_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(6))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> PUFFERFISH_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.PUFFERFISH_CHESTPLATE,
            () -> new EdibleArmorItem(ModArmorMaterials.PUFFERFISH_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(6))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> PUFFERFISH_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.PUFFERFISH_LEGGINGS,
            () -> new EdibleArmorItem(ModArmorMaterials.PUFFERFISH_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(6))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> PUFFERFISH_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.PUFFERFISH_BOOTS,
    ...
    // =========================================================================
    public static final RegistryObject<Item> HONEY_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.HONEY_SWORD,
            () -> new EdibleSwordItem(ModToolTiers.HONEY, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> HONEY_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.HONEY_PICKAXE,
            () -> new EdiblePickaxeItem(ModToolTiers.HONEY, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> HONEY_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.HONEY_SHOVEL,
            () -> new EdibleShovelItem(ModToolTiers.HONEY, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> HONEY_AXE = ITEMS.register(GeneratedRegistrationIds.Items.HONEY_AXE,
            () -> new EdibleAxeItem(ModToolTiers.HONEY, new Item.Properties()
                    .attributes(AxeItem.createAttributes(ModToolTiers.HONEY, 6, -3.2f))
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> HONEY_HOE = ITEMS.register(GeneratedRegistrationIds.Items.HONEY_HOE,
            () -> new EdibleHoeItem(ModToolTiers.HONEY, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.HONEY, 0, -3f))
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> HONEY_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.HONEY_HELMET,
            () -> new EdibleArmorItem(ModArmorMaterials.HONEY_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(10))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> HONEY_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.HONEY_CHESTPLATE,
            () -> new EdibleArmorItem(ModArmorMaterials.HONEY_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(10))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> HONEY_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.HONEY_LEGGINGS,
            () -> new EdibleArmorItem(ModArmorMaterials.HONEY_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(10))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> HONEY_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.HONEY_BOOTS,
    ...
    // =========================================================================
    public static final RegistryObject<Item> CHORUS_FRUIT_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.CHORUS_FRUIT_SWORD,
            () -> new EdibleSwordItem(ModToolTiers.CHORUS_FRUIT, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> CHORUS_FRUIT_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.CHORUS_FRUIT_PICKAXE,
            () -> new EdiblePickaxeItem(ModToolTiers.CHORUS_FRUIT, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> CHORUS_FRUIT_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.CHORUS_FRUIT_SHOVEL,
            () -> new EdibleShovelItem(ModToolTiers.CHORUS_FRUIT, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> CHORUS_FRUIT_AXE = ITEMS.register(GeneratedRegistrationIds.Items.CHORUS_FRUIT_AXE,
            () -> new EdibleAxeItem(ModToolTiers.CHORUS_FRUIT, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> CHORUS_FRUIT_HOE = ITEMS.register(GeneratedRegistrationIds.Items.CHORUS_FRUIT_HOE,
            () -> new EdibleHoeItem(ModToolTiers.CHORUS_FRUIT, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> CHORUS_FRUIT_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.CHORUS_FRUIT_HELMET,
            () -> new EdibleArmorItem(ModArmorMaterials.CHORUS_FRUIT_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(15))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> CHORUS_FRUIT_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.CHORUS_FRUIT_CHESTPLATE,
            () -> new EdibleArmorItem(ModArmorMaterials.CHORUS_FRUIT_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(15))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> CHORUS_FRUIT_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.CHORUS_FRUIT_LEGGINGS,
            () -> new EdibleArmorItem(ModArmorMaterials.CHORUS_FRUIT_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(15))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> CHORUS_FRUIT_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.CHORUS_FRUIT_BOOTS,
    ...
    // =========================================================================
    public static final RegistryObject<Item> GOLDEN_APPLE_SWORD = ITEMS.register(GeneratedRegistrationIds.Items.GOLDEN_APPLE_SWORD,
            () -> new EdibleSwordItem(ModToolTiers.GOLDEN_APPLE, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> GOLDEN_APPLE_PICKAXE = ITEMS.register(GeneratedRegistrationIds.Items.GOLDEN_APPLE_PICKAXE,
            () -> new EdiblePickaxeItem(ModToolTiers.GOLDEN_APPLE, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> GOLDEN_APPLE_SHOVEL = ITEMS.register(GeneratedRegistrationIds.Items.GOLDEN_APPLE_SHOVEL,
            () -> new EdibleShovelItem(ModToolTiers.GOLDEN_APPLE, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> GOLDEN_APPLE_AXE = ITEMS.register(GeneratedRegistrationIds.Items.GOLDEN_APPLE_AXE,
            () -> new EdibleAxeItem(ModToolTiers.GOLDEN_APPLE, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> GOLDEN_APPLE_HOE = ITEMS.register(GeneratedRegistrationIds.Items.GOLDEN_APPLE_HOE,
            () -> new EdibleHoeItem(ModToolTiers.GOLDEN_APPLE, new Item.Properties()
                    ...
                    .food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> GOLDEN_APPLE_HELMET = ITEMS.register(GeneratedRegistrationIds.Items.GOLDEN_APPLE_HELMET,
            () -> new EdibleArmorItem(ModArmorMaterials.GOLDEN_APPLE_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(18))
                            .food(new FoodProperties.Builder().nutrition(10).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> GOLDEN_APPLE_CHESTPLATE = ITEMS.register(GeneratedRegistrationIds.Items.GOLDEN_APPLE_CHESTPLATE,
            () -> new EdibleArmorItem(ModArmorMaterials.GOLDEN_APPLE_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(18))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> GOLDEN_APPLE_LEGGINGS = ITEMS.register(GeneratedRegistrationIds.Items.GOLDEN_APPLE_LEGGINGS,
            () -> new EdibleArmorItem(ModArmorMaterials.GOLDEN_APPLE_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(18))
                            .food(new FoodProperties.Builder().nutrition(14).saturationModifier(0.1f).build())));
    public static final RegistryObject<Item> GOLDEN_APPLE_BOOTS = ITEMS.register(GeneratedRegistrationIds.Items.GOLDEN_APPLE_BOOTS,
