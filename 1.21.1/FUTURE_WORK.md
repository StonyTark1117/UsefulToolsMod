...
- [x] Verify optional integrations absent and present. All 15 absent profiles and 25 supported present profiles pass independently (40/40 total), including JEI, WTHIT, Jade, REI, JER, and a joint 1.21.1 NeoForge startup with Magnetization 1.4.1. WTHIT 19/20's broken self-declared JEI entrypoint is not treated as a valid combined upstream profile.
