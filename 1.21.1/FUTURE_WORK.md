...
- [x] Verify optional integrations absent and present. All 15 absent profiles and 27 supported present profiles pass independently (42/42 total), including JEI, WTHIT, Jade, REI, JER, Create: Ore Excavation on 1.20.1 Fabric and 1.21.1 NeoForge, and a joint 1.21.1 NeoForge startup with Magnetization 1.4.3. 1.20.1 Forge is explicitly excluded because available Create/Ore Excavation pairings apply incompatible upstream mixins to Forge 47.x. WTHIT 19/20's broken self-declared JEI entrypoint is not treated as a valid combined upstream profile.
