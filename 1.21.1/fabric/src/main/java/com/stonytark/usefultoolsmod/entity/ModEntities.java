...
public class ModEntities {
    ...
    public static void register() {
        GRENADE = Registry.register(Registries.ENTITY_TYPE,
                Identifier.of(UsefultoolsMod.MOD_ID, GeneratedRegistrationIds.Entities.GRENADE),
        ...
        GHOST = Registry.register(Registries.ENTITY_TYPE,
                Identifier.of(UsefultoolsMod.MOD_ID, GeneratedRegistrationIds.Entities.GHOST),
