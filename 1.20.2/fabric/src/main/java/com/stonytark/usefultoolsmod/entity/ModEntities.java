...
public class ModEntities {
    ...
    public static void register() {
        GRENADE = Registry.register(Registries.ENTITY_TYPE,
                new Identifier(UsefultoolsMod.MOD_ID, GeneratedRegistrationIds.Entities.GRENADE),
        ...
        GHOST = Registry.register(Registries.ENTITY_TYPE,
                new Identifier(UsefultoolsMod.MOD_ID, GeneratedRegistrationIds.Entities.GHOST),
                EntityType.Builder.<GhostEntity>create(GhostEntity::new, SpawnGroup.MONSTER)
                        .setDimensions(1.5f, 1.5f)
                        .maxTrackingRange(8)
                        .trackingTickInterval(3)
                        .build("usefultoolsmod"));
        WRAITH = Registry.register(Registries.ENTITY_TYPE, new Identifier(UsefultoolsMod.MOD_ID, GeneratedRegistrationIds.Entities.WRAITH),
                EntityType.Builder.<WraithEntity>create(WraithEntity::new, SpawnGroup.MONSTER)
                        .setDimensions(1.2F, 2.25F).maxTrackingRange(8).trackingTickInterval(3).build("usefultoolsmod"));
        STICKY_DYNAMITE = Registry.register(Registries.ENTITY_TYPE,
                new Identifier(UsefultoolsMod.MOD_ID, GeneratedRegistrationIds.Entities.STICKY_DYNAMITE),
                EntityType.Builder.<StickyDynamiteEntity>create(StickyDynamiteEntity::new, SpawnGroup.MISC)
                        .setDimensions(0.25F, 0.25F).maxTrackingRange(4).trackingTickInterval(10).build("usefultoolsmod"));
    }
}
