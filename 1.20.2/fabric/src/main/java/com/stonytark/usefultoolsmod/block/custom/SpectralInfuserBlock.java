...
/** The 1.20.2 Yarn interaction/replacement callbacks are deprecated in-place but remain the required overrides. */
...
public class SpectralInfuserBlock extends BlockWithEntity {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        ...
        return validateTicker(type, ModBlockEntityTypes.SPECTRAL_INFUSER,
