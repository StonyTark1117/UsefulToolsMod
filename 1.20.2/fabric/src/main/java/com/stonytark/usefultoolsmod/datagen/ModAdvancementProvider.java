...
/**
 * Fabric 1.20.1 AdvancementEntry Data Generator
...
public class ModAdvancementProvider extends FabricAdvancementProvider {
    ...
    public void generateAdvancement(Consumer<AdvancementEntry> consumer) {
        ...
        // ==================================================================
        AdvancementEntry rgold = Advancement.Builder.create()
                .parent(root)
        ...
        // ==================================================================
        AdvancementEntry oreFound = Advancement.Builder.create()
                .parent(root)
        ...
        // ==================================================================
        AdvancementEntry rgoldSword = Advancement.Builder.create()
                .parent(rgold)
        ...
        // ==================================================================
        AdvancementEntry obshard = Advancement.Builder.create()
                .parent(root)
        ...
        AdvancementEntry obingot = Advancement.Builder.create()
                .parent(obshard)
        ...
        // ==================================================================
        AdvancementEntry sem = Advancement.Builder.create()
                .parent(root)
        ...
        // ==================================================================
        AdvancementEntry hred = Advancement.Builder.create()
                .parent(root)
        ...
        // ==================================================================
        AdvancementEntry hglow = Advancement.Builder.create()
                .parent(root)
        ...
        // ==================================================================
        AdvancementEntry rlapis = Advancement.Builder.create()
                .parent(root)
        ...
        // ==================================================================
        AdvancementEntry coalDust = Advancement.Builder.create()
                .parent(root)
        ...
        AdvancementEntry hardenedCoal = Advancement.Builder.create()
                .parent(coalDust)
        ...
        AdvancementEntry coalTools = Advancement.Builder.create()
                .parent(hardenedCoal)
        ...
        Advancement.Builder.create()
                ...
                .criterion("coal_tool_ignited",
                        ModTriggers.COAL_TOOL_IGNITED.create(new CoalToolIgnitedTrigger.Conditions(Optional.empty())))
                .build(consumer, id("coal_trial_by_fire"));

        AdvancementEntry coalArmor = Advancement.Builder.create()
                .parent(hardenedCoal)
        ...
        // ==================================================================
        AdvancementEntry grenade = Advancement.Builder.create()
                .parent(root)
        ...
        // ==================================================================
        AdvancementEntry ghostEncounter = Advancement.Builder.create()
                .parent(root)
                .display(ModItems.GHOST_SPAWN_EGG, title("ghost_encounter"), desc("ghost_encounter"),
                        null, AdvancementFrame.TASK, true, true, false)
                .criterion("ghost_nearby",
                        ModTriggers.GHOST_NEARBY.create(new GhostNearbyTrigger.Conditions(Optional.empty())))
                .build(consumer, id("ghost_encounter"));

        AdvancementEntry ghostCompanion = Advancement.Builder.create()
        ...
        //                                             -> Spectral Infuser
        // ------------------------------------------------------------------
        AdvancementEntry ectoplasmAdv = Advancement.Builder.create()
        ...
        AdvancementEntry refinedEctoplasm = Advancement.Builder.create()
                .parent(ectoplasmAdv)
        ...
        AdvancementEntry ectoTools = Advancement.Builder.create()
        ...
        AdvancementEntry rrawGold = Advancement.Builder.create()
                .parent(root)
        ...
        AdvancementEntry rrawCopper = Advancement.Builder.create()
                .parent(root)
        ...
        AdvancementEntry rrawIron = Advancement.Builder.create()
                .parent(root)
        ...
        AdvancementEntry rrawRgold = Advancement.Builder.create()
                .parent(root)
        ...
        AdvancementEntry rscrap = Advancement.Builder.create()
                .parent(root)
        ...
        // Rough Amethyst
        AdvancementEntry ramethyst = Advancement.Builder.create()
                .parent(root)
        ...
        // Snow tools
        AdvancementEntry snowTools = Advancement.Builder.create()
                .parent(root)
        ...
        // Rough Quartz
        AdvancementEntry rquartz = Advancement.Builder.create()
                .parent(root)
        ...
        // Rough Prismarine
        AdvancementEntry rprism = Advancement.Builder.create()
                .parent(root)
        ...
        AdvancementEntry calciteAmethyst = Advancement.Builder.create()
                .parent(root)
        ...
        AdvancementEntry camethystTools = Advancement.Builder.create()
        ...
        AdvancementEntry glacialShard = Advancement.Builder.create()
                .parent(root)
        ...
        AdvancementEntry iceTools = Advancement.Builder.create()
                .parent(glacialShard)
        ...
        AdvancementEntry polishedQuartz = Advancement.Builder.create()
                .parent(root)
        ...
        AdvancementEntry pquartzTools = Advancement.Builder.create()
        ...
        AdvancementEntry polishedPrismarine = Advancement.Builder.create()
                .parent(root)
        ...
        AdvancementEntry pprismTools = Advancement.Builder.create()
        ...
        // ==================================================================
        AdvancementEntry overpowerSword = Advancement.Builder.create()
                .parent(root)
        ...
        // ==================================================================
        AdvancementEntry rflintSword = Advancement.Builder.create()
                .parent(root)
        ...
        AdvancementEntry fniSword = Advancement.Builder.create()
                .parent(rflintSword)
        ...
        AdvancementEntry rabbitHideCraft = Advancement.Builder.create()
                .parent(root)
        ...
        AdvancementEntry turtleScuteCraft = Advancement.Builder.create()
                .parent(root)
        ...
        // ---------------------------------------------------------------
        AdvancementEntry leatherCraft = Advancement.Builder.create()
                .parent(root)
        ...
        // ---------------------------------------------------------------
        AdvancementEntry cakeAdv = Advancement.Builder.create()
                .parent(root)
    ...
    private static void buildFoodAdv(Consumer<AdvancementEntry> consumer, AdvancementEntry parent,
        ...
        AdvancementEntry craftAdv = craft.criteriaMerger(CriterionMerger.OR)
        ...
        AdvancementEntry eatAdv = eat.criteriaMerger(CriterionMerger.OR)
    ...
    private static void buildVanillaToolAdv(Consumer<AdvancementEntry> consumer, AdvancementEntry parent,
    ...
    private static void buildVanillaSetAdv(Consumer<AdvancementEntry> consumer, AdvancementEntry parent,
                                           String craftKey, String setKey,
                                           Item displayItem,
                                           Item sword, Item pickaxe,
                                           Item axe, Item shovel,
