...
/** Forge 48 has no Forge-specific replacement for the vanilla provider it marks deprecated. */
        ...
        public void generate(HolderLookup.Provider registries,
            ...
            Advancement.Builder.advancement()
                    ...
                    .addCriterion("coal_tool_ignited",
                            ModTriggers.COAL_TOOL_IGNITED.createCriterion(new CoalToolIgnitedTrigger.TriggerInstance(Optional.empty())))
            ...
            AdvancementHolder ghostEncounter = Advancement.Builder.advancement()
                    ...
                    .addCriterion("ghost_nearby",
                            ModTriggers.GHOST_NEARBY.createCriterion(new GhostNearbyTrigger.TriggerInstance(Optional.empty())))
